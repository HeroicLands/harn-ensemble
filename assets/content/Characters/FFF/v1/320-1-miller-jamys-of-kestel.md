...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-ridg, system: { masteryLevelBase: 96 } }
    ...
    - { model: sohl-sohl-skill-swim, system: { masteryLevelBase: 51 } }
    ...
    - { model: sohl-sohl-skill-fish, system: { masteryLevelBase: 64 } }
    ...
    - { model: sohl-sohl-miscgear-gldcrwn, system: { quantity: 12 } }
