...
hm3:
  ...
  items:
    ...
    - { shortcode: oratory, type: skill, system: { masteryLevel: 31, skillBase: { value: 12 } } }
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 36, skillBase: { value: 11 } } }
    - { shortcode: singing, type: skill, system: { masteryLevel: 56, skillBase: { value: 17 } } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: dagger, type: skill, system: { masteryLevel: 58, skillBase: { value: 12 } } }
    - { shortcode: cookery, type: skill, system: { masteryLevel: 36, skillBase: { value: 9 } } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 26, skillBase: { value: 10 } } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 20, skillBase: { value: 10 } } }
    - shortcode: animalcraft
      ...
      system:
        ...
        skillBase:
          value: 13
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 26, skillBase: { value: 13 } } }
    - shortcode: textilecraft
      ...
      system:
        ...
        skillBase:
          value: 12
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 36, skillBase: { value: 12 } } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook, system: { masteryLevelBase: 36 } }
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    ...
    - { model: skill-musc, name: Drum (Musician), system: { masteryLevelBase: 69 } }
    - { model: skill-lang, name: "Language: Harnic", system: { masteryLevelBase: 61 } }
    - { model: skill-herb, system: { masteryLevelBase: 26 } }
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 42 } }
...
**Armour**: None
**Companions**: None
**Other obvious features**: Broken nose and scars

# Dossier {#dossier}

**Title**: FFF 417-1 Servant
**Birthday**: 22 Navek 690
**Appearance**: Age 29, height 5' 9", heavy frame, weight 173 lb, attractive appearance, fair complexion, blond hair, hazel eyes
**Medical/Psyche**: Left handed
**Size**: 7
**Armor**: Average cloth tunic and leggings; Leather shoes; Club and dagger
...
When he turned sixteen, his grandfather found him a job as a servant where he has worked for the last eleven years. A big lad, five foot nine inches with a heavy frame he weighs 173lbs. His fair complexion, blond hair, hazel eyes and good looks are marred only by a broken nose and scars on his forehead he earned in a bar brawl. He is left-handed and has rough calloused hands from regular heavy labour. He is kind and flirtatious with women, which has earned him a reputation as a ladies man and a girlfriend with an illegitimate baby daughter. He is careless, often not paying attention to his duties and is forgetful of the time. Since he was very young, Gathric has had the odd quirk of sneezing when he walks out into sunlight.

## Adventure Hooks

Protective Escort: When a PC jostles an obviously wealthy woman in the market, they receive a shove and a growled warning to "back off" from Gathric.

Source of Information: Gathric is hard up for money to feed his girlfriend and little girl. He is quite will ing to sell information about wealthy families houses he has been in.

Out of Work Labourer: His employers have had enough of his lateness and flirtatious behaviour and let Gathric go. He is desperate for work. He has a strong back and a ready club for hire.

Patron's Servant: The PCs new patron does not completely trust them. He sends his trusted servant Gathric along to watch them.
