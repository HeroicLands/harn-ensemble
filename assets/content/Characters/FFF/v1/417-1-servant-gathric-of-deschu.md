...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-sing, system: { masteryLevelBase: 56 } }
    ...
    - { model: sohl-sohl-skill-musc, name: Drum (Musician), system: { masteryLevelBase: 69 } }
    ...
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 20 } }
