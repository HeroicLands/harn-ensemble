...
sohl:
  ...
  items:
    ...
    - { shortcode: awar, type: skill, system: { masteryLevelBase: 81 } }
    - { shortcode: chrm, type: skill }
    - { shortcode: clmb, type: skill, system: { masteryLevelBase: 73 } }
    - { shortcode: cmd, type: skill }
    - { shortcode: cook, type: skill, system: { masteryLevelBase: 61 } }
    ...
    - { shortcode: intr, type: skill, system: { masteryLevelBase: 62 } }
    - { shortcode: jump, type: skill, system: { masteryLevelBase: 82 } }
    ...
    - { shortcode: thro, type: skill, system: { masteryLevelBase: 86 } }
