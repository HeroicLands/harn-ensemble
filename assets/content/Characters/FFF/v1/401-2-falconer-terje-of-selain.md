...
sohl:
  ...
  items:
    ...
    - { shortcode: clmb, type: skill, system: { masteryLevelBase: 79 } }
    ...
    - { shortcode: ridg, type: skill, system: { masteryLevelBase: 63 } }
    ...
    - shortcode: anmcft
      ...
      system:
        masteryLevelBase: 85
    - { shortcode: fltch, type: skill, system: { masteryLevelBase: 55 } }
