...
sohl:
  ...
  items:
    ...
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 27 } }
    - { model: skill-folklr, system: { masteryLevelBase: 50 } }
    - { model: skill-guil }
    ...
    - { model: skill-pysn, system: { masteryLevelBase: 31 } }
    - { model: skill-ridg }
    - { model: skill-sing, system: { masteryLevelBase: 41 } }
    - { model: skill-stlth, system: { masteryLevelBase: 68 } }
    - { model: skill-srvl }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: skill-acro, system: { masteryLevelBase: 37 } }
    - { model: skill-lgdm, system: { masteryLevelBase: 30 } }
    - { model: skill-lang, name: "Language: Besha", system: { masteryLevelBase: 84 } }
    - { model: skill-script, name: "Script: Neramic", system: { masteryLevelBase: 84 } }
    - { model: mysticalability-alch, system: { masteryLevelBase: 38 } }
    - { model: skill-brew, system: { masteryLevelBase: 47 } }
    ...
    - { model: skill-lock, system: { masteryLevelBase: 49 } }
    - { model: skill-math, system: { masteryLevelBase: 36 } }
    - { model: skill-txtl, system: { masteryLevelBase: 38 } }
