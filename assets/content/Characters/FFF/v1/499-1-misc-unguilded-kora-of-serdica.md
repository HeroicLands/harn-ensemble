...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-clmb, system: { masteryLevelBase: 38 } }
    - { model: sohl-sohl-skill-cmd }
    - { model: sohl-sohl-skill-cook }
    - { model: sohl-sohl-skill-dnce }
    - { model: sohl-sohl-skill-dscr }
    - { model: sohl-sohl-skill-draw }
    - { model: sohl-sohl-skill-folklr, system: { masteryLevelBase: 115 } }
    ...
    - { model: sohl-sohl-skill-pysn, system: { masteryLevelBase: 86 } }
    ...
    - { model: sohl-sohl-skill-srvl, system: { masteryLevelBase: 88 } }
