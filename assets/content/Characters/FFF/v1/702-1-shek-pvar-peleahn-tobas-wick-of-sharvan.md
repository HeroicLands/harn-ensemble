...
sohl:
  ...
  items:
    ...
    - { model: skill-archery }
    - { model: skill-awar, system: { masteryLevelBase: 74 } }
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 55 } }
    - { model: skill-cmd }
    - { model: skill-cook, system: { masteryLevelBase: 63 } }
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw }
    ...
    - { model: skill-acro, system: { masteryLevelBase: 35 } }
    - { model: skill-lgdm, system: { masteryLevelBase: 51 } }
    - { model: skill-lang, name: "Language: Harnic", system: { masteryLevelBase: 93 } }
    - { model: skill-script, name: "Script: Lakise", system: { masteryLevelBase: 98 } }
    - { model: mysticalability-alch, system: { masteryLevelBase: 56 } }
    - { model: skill-law, system: { masteryLevelBase: 50 } }
    - { model: skill-lock, system: { masteryLevelBase: 45 } }
    - { model: skill-math, system: { masteryLevelBase: 35 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 15 } }
    ...
    - { model: miscgear-pence, system: { quantity: 196 } }
...
**Eye Colour**: Hazel
**Voice**: Average
**Obvious Medical Traits**: Burn scars on his hands and left side of his face
**Apparent Occupation**: Litigant
**Apparent Wealth**: Wealthy
**Weapons**: Shortsword and dagger
**Armour**: None
**Companions**: None
...
**Title**: FFF 702-1 Shek Pvar Peleahn
**Birthday**: 22 Azura 672
**Appearance**: Age 47, height 5' 10", medium frame, weight 160 lb, ugly appearance, medium complexion, black hair, hazel eyes
...
Born in Golotha to a prostitute, Tobas of Sharvan spent his early years as a guttersnipe, cut purse and look out for the Lia-Kavair. If he had not tried to cut the purse of a travelling Viran from Shostim, Tobas might never have met his full potential. Detecting the great potential within the boy, the Viran offered Tobas a choice, to either apprentice at Shostim, or die. He chose the former. Tobas was a brilliant student and has become one of the most accomplished mages of his generation. In 702, Tobas was handpicked to become a member of the White Hand.

During his apprenticeship, Tobas was given the nickname "Wick", a moniker he still uses today among his closest friends and acquaintances. Tobas bears the burn scars on his hands, arms and left side from an early, catastrophic, psionic episode. Since 710, Tobas has travelled through Harn on the trail of a notorious Melderyni renegade. He is credited with single-handedly bringing no less than seven renegades to justice but has yet to find the trail of his primary quarry. Tobas rarely travels alone, usually accompanying caravans or other large groups.
...
A Gentle Reminder: A PC Shek P'var that has come close to or crossed the line might get a memorable, and terrifying visit from Tobas. He will give a warning for a first offence.

A Litigant Needed: The PCs need a litigant quickly, Tobas will take their case, but the cost may be high.

Investigated: Tobas investigates the PCs, believing they may have information useful to his search. The social class of the PCs will effect how Tobas approaches them. He will conceal his true nature.

Adventurers Needed: Tobas has learned something useful and needs the information verified. He may actually be using the PCs as a decoy or stalking-horse.
