...
sohl:
  ...
  items:
    ...
    - { shortcode: melee, type: skill, system: { masteryLevelBase: 38 } }
    ...
    - shortcode: anmcft
      ...
      system:
        masteryLevelBase: 42
    - { shortcode: herb, type: skill, system: { masteryLevelBase: 78 } }
    ...
    - { shortcode: beltpouchl3, type: containergear }
    - { shortcode: tndrbx, type: miscgear }
    - { shortcode: vialglassm, type: containergear, system: { quantity: 5 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 38 } }
