...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-archery, name: Shortbow (Bow), system: { masteryLevelBase: 90 } }
    ...
    - { model: sohl-sohl-skill-lang, name: "Language: Ivinian", system: { masteryLevelBase: 61 } }
    - { model: sohl-sohl-skill-fish, system: { masteryLevelBase: 46 } }
    - model: sohl-sohl-skill-fltch
      name: "Fletching: Shortbow"
      system:
        masteryLevelBase: 62
    - { model: sohl-sohl-skill-hrld, system: { masteryLevelBase: 28 } }
    - { model: sohl-sohl-skill-pilt, system: { masteryLevelBase: 35 } }
