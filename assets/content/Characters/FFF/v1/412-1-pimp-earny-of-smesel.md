...
sohl:
  ...
  items:
    ...
    - { shortcode: clmb, type: skill, system: { masteryLevelBase: 74 } }
    ...
    - { shortcode: dge, type: skill, system: { masteryLevelBase: 43 } }
    ...
    - { shortcode: pilt, type: skill, system: { masteryLevelBase: 29 } }
