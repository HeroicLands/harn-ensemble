...
hm3:
  ...
  items:
    ...
    - { shortcode: survival, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1744 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-srvl, system: { masteryLevelBase: 105 } }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: miscgear-pence, system: { quantity: 1744 } }
