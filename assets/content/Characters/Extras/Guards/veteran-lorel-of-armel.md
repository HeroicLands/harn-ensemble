...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 105 } }
    ...
    - name: "Debt to Money Lender: Gyandy of Thoff for 612d"
      type: miscgear
      data:
