...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1844 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1844 } }
...
Modifier to HairColor of +25 (from 23) {Complexion=Fair, Species=Human}
