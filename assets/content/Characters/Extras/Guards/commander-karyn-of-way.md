...
hm3:
  ...
  items:
    ...
    - { shortcode: survival, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2492 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-srvl, system: { masteryLevelBase: 96 } }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: miscgear-pence, system: { quantity: 2492 } }
...
Modifier to EyeColor of +15 (from 62) {Complexion=Swarthy, Species=Human}
