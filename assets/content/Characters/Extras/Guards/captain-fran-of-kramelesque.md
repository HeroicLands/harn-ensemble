...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 102 } }
    ...
    - { shortcode: shield, type: skill, system: { masteryLevel: 114 } }
    - { shortcode: spear, type: skill, system: { masteryLevel: 126 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 102 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce }
    - { model: skill-dscr }
    ...
    - { model: skill-melee, system: { masteryLevelBase: 115 } }
    - { model: skill-dge }
