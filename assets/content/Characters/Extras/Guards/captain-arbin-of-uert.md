...
hm3:
  ...
  items:
    ...
    - { shortcode: foraging, type: skill, system: { masteryLevel: 112 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1964 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1964 } }
...
Modifier to StartingEquipment of +200 (from 81) {SocialClass=Unguilded}
