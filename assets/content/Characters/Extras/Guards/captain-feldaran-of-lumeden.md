...
hm3:
  ...
  items:
    ...
    - { shortcode: shield, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: spear, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: sword, type: skill, name: Falchion (Sword), system: { masteryLevel: 112 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2054 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 68 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce }
    - { model: skill-dscr }
    ...
    - { model: skill-melee, system: { masteryLevelBase: 108 } }
    - { model: skill-dge }
    ...
    - { model: skill-srvl, system: { masteryLevelBase: 102 } }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: miscgear-pence, system: { quantity: 2054 } }
...
Modifier to AttributesAGL of -2 (from 18) {Frame=Massive}

Modifier to HairColor of +25 (from 6) {Complexion=Fair, Species=Human}
