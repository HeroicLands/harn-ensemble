...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 102 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 386 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 386 } }
...
Modifier to EyeColor of +15 (from 74) {Complexion=Swarthy, Species=Human}
