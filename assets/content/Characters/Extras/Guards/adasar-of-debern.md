...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 90 } }
    ...
    - name: "Debt to Money Lender: Karik of Symdal for 316d"
      type: miscgear
      data:
