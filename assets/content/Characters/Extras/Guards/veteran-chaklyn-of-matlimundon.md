...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 42 } }
    ...
    - name: "Debt to Money Lender: Nor of Raleh for 352d"
      type: miscgear
      data:
