...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 119 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1876 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1876 } }
...
Modifier to AttributesAGL of -2 (from 14) {Frame=Massive}
