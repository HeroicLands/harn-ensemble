...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 98 } }
    ...
    - { model: sohl-sohl-skill-thro, system: { masteryLevelBase: 98 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2784 } }
