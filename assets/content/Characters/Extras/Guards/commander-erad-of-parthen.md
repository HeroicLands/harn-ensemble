...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Falchion (Sword), system: { masteryLevel: 108 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2784 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2784 } }
...
Modifier to EyeColor of -25 (from 26) {Complexion=Pale, Species=Human}
