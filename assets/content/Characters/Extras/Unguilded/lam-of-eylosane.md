...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 88 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: tracking, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 442 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 88 } }
    - { model: skill-trak, system: { masteryLevelBase: 52 } }
    - { model: miscgear-pence, system: { quantity: 442 } }
