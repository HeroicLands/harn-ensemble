...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 365 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 365 } }
...
Modifier to SiblingRank of -20 (from 32) {Species=Khuzdul}
