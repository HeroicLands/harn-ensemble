...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Shortbow (Bow), system: { masteryLevel: 55 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 597 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Shortbow (Bow), system: { masteryLevelBase: 55 } }
    ...
    - { model: miscgear-pence, system: { quantity: 597 } }
