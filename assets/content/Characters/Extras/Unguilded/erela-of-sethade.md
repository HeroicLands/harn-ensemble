...
hm3:
  ...
  items:
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: whip, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 75 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 75 } }
...
Modifier to HairColor of -25 (from 100) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 51) {Complexion=Dark, Species=Human}
