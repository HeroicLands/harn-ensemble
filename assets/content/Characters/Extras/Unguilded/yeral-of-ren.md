...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 14 } }
    ...
    - { model: sohl-sohl-skill-embl, system: { masteryLevelBase: 40 } }
    - { model: sohl-sohl-skill-herb, system: { masteryLevelBase: 50 } }
    - { model: sohl-sohl-skill-trak, system: { masteryLevelBase: 20 } }
