...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 99 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1236 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1236 } }
