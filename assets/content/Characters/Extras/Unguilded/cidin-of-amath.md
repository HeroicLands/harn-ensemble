...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 96 } }
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 83 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 809 } }
