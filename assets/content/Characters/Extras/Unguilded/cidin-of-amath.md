...
hm3:
  ...
  items:
    ...
    - { shortcode: awareness, type: skill, system: { masteryLevel: 85 } }
    ...
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 77 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 809 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 83 } }
    - { model: skill-dge }
    ...
    - { model: miscgear-pence, system: { quantity: 809 } }
