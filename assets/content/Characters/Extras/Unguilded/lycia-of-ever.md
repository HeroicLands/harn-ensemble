...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-fish, system: { masteryLevelBase: 60 } }
    - { model: sohl-sohl-skill-pilt, system: { masteryLevelBase: 20 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 66 } }
    - { model: sohl-sohl-skill-shpw, system: { masteryLevelBase: 18 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 462 } }
