...
hm3:
  ...
  items:
    ...
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 18 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 462 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-shpw, system: { masteryLevelBase: 18 } }
    - { model: miscgear-pence, system: { quantity: 462 } }
...
Modifier to EyeColor of +15 (from 72) {Complexion=Swarthy, Species=Human}
