...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 44 } }
    ...
    - name: "Debt to Money Lender: Lern of Loyril for 381d"
      type: miscgear
      data:
