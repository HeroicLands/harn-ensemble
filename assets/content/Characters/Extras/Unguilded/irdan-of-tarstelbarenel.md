...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Longbow (Bow), system: { masteryLevel: 104 } }
    ...
    - { shortcode: sword, type: skill, name: Falchion (Sword), system: { masteryLevel: 104 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1086 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Longbow (Bow), system: { masteryLevelBase: 104 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1086 } }
...
Modifier to HairColor of -25 (from 45) {Complexion=Dark, Species=Human}
