...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 203 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 203 } }
...
Modifier to AttributesEYE of +1 (from 16) {Species=Khuzdul}
...
0lbs weight resulted in -4 strength mod.

Heavy frame resulted in -1 agility mod.

Modifier to StartingEquipment of +300 (from 62) {SocialClass=Guilded}
