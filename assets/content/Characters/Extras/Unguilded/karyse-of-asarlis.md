...
hm3:
  ...
  items:
    ...
    - { shortcode: net, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: animalcraft, type: skill, name: Dog (Animalcraft), system: { masteryLevel: 98 } }
    - { shortcode: animalcraft, type: skill, name: Rat (Animalcraft), system: { masteryLevel: 84 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 585 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, name: Rat (Animalcraft), system: { masteryLevelBase: 84 } }
    - { model: skill-herb, system: { masteryLevelBase: 60 } }
    - { model: miscgear-pence, system: { quantity: 585 } }
