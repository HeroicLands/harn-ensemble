...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Jarinese), system: { masteryLevel: 33 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 876 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 876 } }
