...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 88 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 20 } }
...
Modifier to EyeColor of -10 (from 82) {Complexion=Fair, Species=Human}
