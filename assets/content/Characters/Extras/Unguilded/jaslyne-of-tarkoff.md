...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1953 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1953 } }
...
Modifier to HairColor of +25 (from 93) {Complexion=Fair, Species=Human}
