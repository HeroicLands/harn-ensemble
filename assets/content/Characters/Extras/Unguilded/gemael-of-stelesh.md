...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1564 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Shortbow (Bow), system: { masteryLevelBase: 112 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1564 } }
