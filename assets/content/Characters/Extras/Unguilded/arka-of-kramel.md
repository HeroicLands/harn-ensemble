...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 26 } }
    ...
    - name: "Debt to Money Lender: Inran of Khonan for 258d"
      type: miscgear
      data:
...
Modifier to EyeColor of +15 (from 23) {Complexion=Swarthy, Species=Human}
