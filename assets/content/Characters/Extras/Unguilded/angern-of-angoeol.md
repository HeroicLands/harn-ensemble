...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 104 } }
    ...
    - { model: sohl-sohl-skill-ridg, system: { masteryLevelBase: 108 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 3936 } }
