...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 33 } }
    ...
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 66 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 3936 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 104 } }
    - { model: skill-awar, system: { masteryLevelBase: 84 } }
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 77 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 33 } }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 44 } }
    - { model: miscgear-pence, system: { quantity: 3936 } }
...
Modifier to Frame of -2 (from 15) {Species=Sindarin}
...
Modifier to AttributesAUR of +4 (from 18) {Species=Sindarin}

Modifier to AttributesMOR of +3 (from 4) {Species=Sindarin}

Modifier to SiblingRank of -20 (from 57) {Species=Sindarin}

143lbs weight resulted in -1 strength mod.
