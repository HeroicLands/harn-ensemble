...
sohl:
  ...
  items:
    ...
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 14 } }
    - { model: skill-ridg }
    ...
    - { model: miscgear-pence, system: { quantity: 1633 } }
