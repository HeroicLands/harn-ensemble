...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 77 } }
    ...
    - { model: sohl-sohl-skill-dnce, system: { masteryLevelBase: 54 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2015 } }
