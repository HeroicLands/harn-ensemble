...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Heartbow (Bow), system: { masteryLevel: 77 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2015 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 77 } }
    ...
    - { model: miscgear-pence, system: { quantity: 2015 } }
...
Modifier to StartingEquipment of +200 (from 84) {SocialClass=Unguilded}
