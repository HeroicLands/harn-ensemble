...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 538 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 538 } }
...
Modifier to HairColor of +25 (from 16) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 99) {Complexion=Fair, Species=Human}
