...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 44 } }
    ...
    - { shortcode: tracking, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 164 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-trak, system: { masteryLevelBase: 45 } }
    - { model: miscgear-pence, system: { quantity: 164 } }
