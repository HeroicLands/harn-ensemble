...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: sword, type: skill, name: Falchion (Sword), system: { masteryLevel: 50 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 121 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 121 } }
