...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 213 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 98 } }
    ...
    - { model: miscgear-pence, system: { quantity: 213 } }
...
Modifier to SiblingRank of -20 (from 26) {Species=Sindarin}
