...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Longbow (Bow), system: { masteryLevel: 72 } }
    ...
    - { shortcode: sword, type: skill, name: Falchion (Sword), system: { masteryLevel: 72 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 733 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Longbow (Bow), system: { masteryLevelBase: 72 } }
    ...
    - { model: miscgear-pence, system: { quantity: 733 } }
