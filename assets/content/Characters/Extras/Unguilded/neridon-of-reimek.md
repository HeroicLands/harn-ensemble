...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 16 } }
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 50 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jump, system: { masteryLevelBase: 16 } }
...
Modifier to AttributesCOM of +4 (from 15) {Species=Khuzdul}

Modifier to AttributesAUR of -1 (from 7) {Species=Khuzdul}

Modifier to AttributesWIL of +3 (from 14) {Species=Khuzdul}

Modifier to SiblingRank of -20 (from 14) {Species=Khuzdul}
