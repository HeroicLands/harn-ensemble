...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 25 } }
    ...
    - { shortcode: singing, type: skill, system: { masteryLevel: 18 } }
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 77 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 63 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: spear, type: skill, system: { masteryLevel: 88 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1171 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1171 } }
...
Modifier to AttributesHGR of +2 (from 6) {Species=Khuzdul}

Modifier to AttributesSML of +2 (from 9) {Species=Khuzdul}

Modifier to AttributesCOM of +4 (from 18) {Species=Khuzdul}

Modifier to AttributesAUR of -1 (from 6) {Species=Khuzdul}

Modifier to AttributesWIL of +3 (from 17) {Species=Khuzdul}

Modifier to SiblingRank of -20 (from 45) {Species=Khuzdul}

Eldest gets +5 on estrangement roll.

One Leg Missing/Deformed reduces Agilty by half: -3

113lbs weight resulted in -2 strength mod.

Heavy frame resulted in -1 agility mod.

Modifier to StartingEquipment of +100 (from 2) {SocialClass=Serf}
