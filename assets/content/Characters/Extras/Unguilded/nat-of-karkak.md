...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-attribute-agl, system: { scoreBase: 3 } }
    ...
    - { model: sohl-sohl-skill-clmb, system: { masteryLevelBase: 35 } }
    ...
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 25 } }
    ...
    - { model: sohl-sohl-skill-sing, system: { masteryLevelBase: 18 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1171 } }
