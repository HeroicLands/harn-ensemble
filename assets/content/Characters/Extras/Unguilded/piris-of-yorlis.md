...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Falchion (Sword), system: { masteryLevel: 65 } }
...
Modifier to StartingEquipment of +300 (from 83) {SocialClass=Guilded}
