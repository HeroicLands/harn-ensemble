...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 50 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 432 } }
