...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Longbow (Bow), system: { masteryLevel: 55 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1285 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Longbow (Bow), system: { masteryLevelBase: 55 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1285 } }
