...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 77 } }
    ...
    - name: "Debt to Money Lender: Kolyd of Tar for 32d"
      type: miscgear
      data:
...
Modifier to HairColor of +25 (from 84) {Complexion=Fair, Species=Human}
