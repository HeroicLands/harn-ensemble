...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 28 } }
    ...
    - name: "Debt to Money Lender: Haber of Merkenos for 74d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 28 } }
