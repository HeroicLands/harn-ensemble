...
hm3:
  ...
  items:
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 39 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1320 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1320 } }
...
Modifier to HairColor of +25 (from 19) {Complexion=Fair, Species=Human}
