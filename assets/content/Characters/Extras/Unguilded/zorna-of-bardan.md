...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Falchion (Sword), system: { masteryLevel: 99 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1674 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1674 } }
