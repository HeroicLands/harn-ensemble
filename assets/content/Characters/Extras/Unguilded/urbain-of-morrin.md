...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 84 } }
    ...
    - name: "Debt to Money Lender: Uris of Tixenal for 677d"
      type: miscgear
      data:
...
Modifier to AttributesSML of +2 (from 15) {Species=Khuzdul}
...
Modifier to SiblingRank of -20 (from 15) {Species=Khuzdul}
