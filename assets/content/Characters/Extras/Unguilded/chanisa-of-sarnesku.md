...
hm3:
  ...
  items:
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 44 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 74 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 74 } }
