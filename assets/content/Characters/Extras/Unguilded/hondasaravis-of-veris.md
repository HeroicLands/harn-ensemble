...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 21 } }
    ...
    - name: Axe, wood handle
      ...
      system:
        value: 12
        weight: 3
    - name: "Debt to Money Lender: Hollo of Kare for 17d"
      type: miscgear
      data:
        icon: sohl-none-icon-miscgear
      system:
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 21 } }
