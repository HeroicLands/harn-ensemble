...
hm3:
  ...
  items:
    ...
    - { shortcode: singing, type: skill, system: { masteryLevel: 63 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1085 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pysn }
    - { model: skill-ridg }
    - { model: skill-sing, system: { masteryLevelBase: 63 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1085 } }
