...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 102 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1219 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1219 } }
...
Modifier to AttributesDEX of +2 (from 17) {Species=Sindarin}
