...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 56 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 81 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: sling, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 18 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2762 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2762 } }
