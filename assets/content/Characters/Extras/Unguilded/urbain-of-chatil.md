...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 45 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 466 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 466 } }
...
Modifier to HairColor of +25 (from 99) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 59) {Complexion=Fair, Species=Human}
