...
hm3:
  ...
  items:
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2144 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 108 } }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: miscgear-pence, system: { quantity: 2144 } }
