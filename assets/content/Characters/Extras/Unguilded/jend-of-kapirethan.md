...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 40 } }
    ...
    - name: "Debt to Money Lender: Sorol of Ibin for 5d"
      type: miscgear
      data:
