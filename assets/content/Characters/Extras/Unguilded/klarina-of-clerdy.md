...
hm3:
  ...
  items:
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1373 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 61
    - { model: skill-anmcft, system: { masteryLevelBase: 104 } }
    - { model: skill-hide, system: { masteryLevelBase: 45 } }
    - { model: miscgear-pence, system: { quantity: 1373 } }
...
Modifier to StartingEquipment of +200 (from 8) {SocialClass=Unguilded}
