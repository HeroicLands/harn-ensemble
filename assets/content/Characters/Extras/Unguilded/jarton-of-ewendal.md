...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: club, type: skill, system: { masteryLevel: 54 } }
    ...
    - { shortcode: fletching, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: tracking, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1031 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, system: { masteryLevelBase: 72 } }
    - { model: skill-awar, system: { masteryLevelBase: 91 } }
    - { model: skill-chrm }
    ...
    - { model: skill-fltch, system: { masteryLevelBase: 28 } }
    - { model: skill-hide, system: { masteryLevelBase: 36 } }
    - { model: skill-trak, system: { masteryLevelBase: 96 } }
    - { model: miscgear-pence, system: { quantity: 1031 } }
...
Modifier to HairColor of -25 (from 64) {Complexion=Dark, Species=Human}
