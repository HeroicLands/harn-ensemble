...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 784 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 784 } }
...
Modifier to SiblingRank of -20 (from 51) {Species=Khuzdul}
