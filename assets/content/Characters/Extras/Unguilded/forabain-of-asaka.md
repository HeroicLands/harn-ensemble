...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 20 } }
    ...
    - { shortcode: tracking, type: skill, system: { masteryLevel: 30 } }
    ...
    - name: "Debt to Money Lender: Yebin of Ren for 272d"
      type: miscgear
      data:
        icon: sohl-none-icon-miscgear
      system:
