...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 52 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 72 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 72 } }
...
**Age**: 24
**Birthday**: 23 Nuzyael 696
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: Eldest of 11
**Siblings**: MmmFMMfMmfM
**Parentage**: Bastard
