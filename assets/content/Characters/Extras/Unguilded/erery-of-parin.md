...
hm3:
  ...
  items:
    ...
    - shortcode: language
      ...
      system:
        masteryLevel: 90
    - { shortcode: oratory, type: skill, system: { masteryLevel: 54 } }
    ...
    - { shortcode: script, type: skill, name: Script(Script(Runic)), system: { masteryLevel: 112 } }
    - shortcode: script
      type: skill
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-penquill }
    - { model: miscgear-waxsealing }
...
Modifier to EyeColor of +15 (from 91) {Complexion=Swarthy, Species=Human}
