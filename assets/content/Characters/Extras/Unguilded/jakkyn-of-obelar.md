...
sohl:
  ...
  items:
    ...
    - model: sohl-sohl-skill-lang
      ...
      system:
        masteryLevelBase: 89
    - { model: sohl-sohl-skill-fish, system: { masteryLevelBase: 104 } }
    - { model: sohl-sohl-skill-pilt, system: { masteryLevelBase: 42 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 91 } }
    - { model: sohl-sohl-skill-shpw, system: { masteryLevelBase: 30 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1259 } }
