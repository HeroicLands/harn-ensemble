...
hm3:
  ...
  items:
    ...
    - { shortcode: fishing, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: piloting, type: skill, system: { masteryLevel: 42 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1259 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 89
    - { model: skill-fish, system: { masteryLevelBase: 104 } }
    - { model: skill-pilt, system: { masteryLevelBase: 42 } }
    - { model: skill-smsh, system: { masteryLevelBase: 91 } }
    - { model: skill-shpw, system: { masteryLevelBase: 30 } }
    - { model: miscgear-pence, system: { quantity: 1259 } }
