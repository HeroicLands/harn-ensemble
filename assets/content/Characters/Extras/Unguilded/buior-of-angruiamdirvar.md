...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Heartbow (Bow), system: { masteryLevel: 66 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1135 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 66 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1135 } }
...
Modifier to Frame of -2 (from 14) {Species=Sindarin}
...
Modifier to AttributesVOI of +2 (from 18) {Species=Sindarin}
...
Modifier to SiblingRank of -20 (from 97) {Species=Sindarin}
