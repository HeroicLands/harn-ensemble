...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 99 } }
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 18 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 91 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1245 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 99 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce }
    - { model: skill-dscr }
    ...
    - { model: skill-eng, system: { masteryLevelBase: 18 } }
    - { model: miscgear-pence, system: { quantity: 1245 } }
