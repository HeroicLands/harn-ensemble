...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: tracking, type: skill, system: { masteryLevel: 33 } }
    ...
    - name: "Debt to Money Lender: Lern of Sprythselphus for 20d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 48 } }
...
Modifier to EyeColor of +15 (from 21) {Complexion=Swarthy, Species=Human}
