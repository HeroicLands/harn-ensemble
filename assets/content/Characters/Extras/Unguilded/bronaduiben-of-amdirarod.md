...
hm3:
  ...
  items:
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 4673 } }
    ...
    - name: Container of Demon Essence
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 4673 } }
...
Modifier to SiblingRank of -20 (from 45) {Species=Sindarin}
