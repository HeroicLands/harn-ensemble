...
sohl:
  ...
  items:
    ...
    - { shortcode: elo, type: attribute, system: { scoreBase: 3 } }
    ...
    - { shortcode: lang, type: skill, name: "Language, Serf", system: { masteryLevelBase: 57 } }
    - { shortcode: agri, type: skill, system: { masteryLevelBase: 63 } }
