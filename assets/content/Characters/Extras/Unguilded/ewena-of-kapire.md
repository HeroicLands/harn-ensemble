...
sohl:
  ...
  items:
    ...
    - { model: attribute-elo, system: { scoreBase: 3 } }
    ...
    - { model: skill-agri, system: { masteryLevelBase: 63 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 56 } }
    - { model: miscgear-pence, system: { quantity: 369 } }
