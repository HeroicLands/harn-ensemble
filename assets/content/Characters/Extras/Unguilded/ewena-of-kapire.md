...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-attribute-elo, system: { scoreBase: 3 } }
    ...
    - { model: sohl-sohl-skill-lang, name: "Language, Serf", system: { masteryLevelBase: 57 } }
    - { model: sohl-sohl-skill-agri, system: { masteryLevelBase: 63 } }
    - { model: sohl-sohl-skill-anmcft, system: { masteryLevelBase: 56 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 369 } }
