...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Heartbow (Bow), system: { masteryLevel: 88 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1857 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 88 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1857 } }
...
Modifier to Frame of -2 (from 5) {Species=Sindarin}
...
Modifier to SiblingRank of -20 (from 80) {Species=Sindarin}
