...
hm3:
  ...
  items:
    ...
    - { shortcode: whip, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 27 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1497 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 112 } }
    - { model: miscgear-pence, system: { quantity: 1497 } }
