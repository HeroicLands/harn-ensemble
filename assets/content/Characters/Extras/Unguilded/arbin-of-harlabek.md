...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 55 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 388 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 388 } }
