...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2347 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2347 } }
...
Modifier to SiblingRank of -20 (from 68) {Species=Khuzdul}
