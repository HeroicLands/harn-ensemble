...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 72 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1809 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1809 } }
...
Modifier to HairColor of +25 (from 91) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 34) {Complexion=Fair, Species=Human}
