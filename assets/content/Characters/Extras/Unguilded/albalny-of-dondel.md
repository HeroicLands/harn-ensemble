...
hm3:
  ...
  items:
    ...
    - { shortcode: fishing, type: skill, system: { masteryLevel: 99 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1247 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-fish, system: { masteryLevelBase: 99 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1247 } }
...
Modifier to HairColor of -25 (from 92) {Complexion=Dark, Species=Human}
