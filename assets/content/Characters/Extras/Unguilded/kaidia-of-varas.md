...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 112 } }
...
Modifier to EyeColor of +15 (from 77) {Complexion=Swarthy, Species=Human}
