...
hm3:
  ...
  items:
    ...
    - { shortcode: fishing, type: skill, system: { masteryLevel: 77 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 412 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 412 } }
...
Modifier to EyeColor of -25 (from 12) {Complexion=Pale, Species=Human}
...
Modifier to StartingEquipment of +300 (from 94) {SocialClass=Guilded}
