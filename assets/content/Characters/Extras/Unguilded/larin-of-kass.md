...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Shortbow (Bow), system: { masteryLevel: 84 } }
    ...
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 80 } }
