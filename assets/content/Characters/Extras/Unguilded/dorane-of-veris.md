...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-archery, name: Longbow (Bow), system: { masteryLevelBase: 60 } }
    ...
    - { model: sohl-sohl-skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 69 } }
    - { model: sohl-sohl-skill-hrld, system: { masteryLevelBase: 24 } }
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 22 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1002 } }
