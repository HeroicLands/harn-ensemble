...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Longbow (Bow), system: { masteryLevel: 60 } }
    ...
    - { shortcode: sword, type: skill, name: Falchion (Sword), system: { masteryLevel: 96 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1002 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Longbow (Bow), system: { masteryLevelBase: 60 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1002 } }
