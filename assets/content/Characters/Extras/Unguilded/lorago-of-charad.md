...
hm3:
  ...
  items:
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 26 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 966 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dge }
    - { model: skill-pysn }
    - { model: skill-ridg, system: { masteryLevelBase: 26 } }
    ...
    - { model: miscgear-pence, system: { quantity: 966 } }
