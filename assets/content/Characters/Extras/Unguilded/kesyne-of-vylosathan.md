...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 66 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: sling, type: skill, system: { masteryLevel: 22 } }
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: tracking, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 654 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, system: { masteryLevelBase: 66 } }
    ...
    - { model: skill-slng, system: { masteryLevelBase: 22 } }
    - { model: skill-fltch, system: { masteryLevelBase: 33 } }
    - { model: skill-hide, system: { masteryLevelBase: 40 } }
    - { model: skill-trak, system: { masteryLevelBase: 77 } }
    - { model: miscgear-pence, system: { quantity: 654 } }
