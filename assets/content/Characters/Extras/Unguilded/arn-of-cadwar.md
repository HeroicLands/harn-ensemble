...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 100 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 5692 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 5692 } }
...
Modifier to AttributesEYE of +2 (from 5) {Species=Sindarin}
