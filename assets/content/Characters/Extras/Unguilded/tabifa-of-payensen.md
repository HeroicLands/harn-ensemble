...
hm3:
  ...
  items:
    ...
    - { shortcode: fishing, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: piloting, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 563 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-fish, system: { masteryLevelBase: 98 } }
    - { model: skill-pilt, system: { masteryLevelBase: 26 } }
    - { model: skill-smsh, system: { masteryLevelBase: 77 } }
    - { model: skill-shpw, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 563 } }
