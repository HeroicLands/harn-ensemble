...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-fish, system: { masteryLevelBase: 98 } }
    - { model: sohl-sohl-skill-pilt, system: { masteryLevelBase: 26 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 77 } }
    - { model: sohl-sohl-skill-shpw, system: { masteryLevelBase: 24 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 563 } }
