...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Heartbow (Bow), system: { masteryLevel: 99 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2207 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 99 } }
    ...
    - { model: miscgear-pence, system: { quantity: 2207 } }
