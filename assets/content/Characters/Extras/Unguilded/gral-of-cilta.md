...
hm3:
  ...
  items:
    ...
    - { shortcode: flail, type: skill, name: Grailflail (Flail), system: { masteryLevel: 26 } }
    ...
    - { shortcode: tracking, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 474 } }
    ...
    - { shortcode: hidedeer, type: miscgear }
...
sohl:
  ...
  items:
    ...
    - { model: skill-trak, system: { masteryLevelBase: 84 } }
    - { model: miscgear-pence, system: { quantity: 474 } }
