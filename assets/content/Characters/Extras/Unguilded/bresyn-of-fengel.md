...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Shortbow (Bow), system: { masteryLevel: 96 } }
    ...
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 84 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1537 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Shortbow (Bow), system: { masteryLevelBase: 96 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1537 } }
...
185lbs weight resulted in +2 strength mod.
