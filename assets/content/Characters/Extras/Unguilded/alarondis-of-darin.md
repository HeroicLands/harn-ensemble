...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, name: Dog (Animalcraft), system: { masteryLevel: 44 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, name: Rat (Animalcraft), system: { masteryLevelBase: 99 } }
