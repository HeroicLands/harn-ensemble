...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 16 } }
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 56 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-hide, system: { masteryLevelBase: 16 } }
