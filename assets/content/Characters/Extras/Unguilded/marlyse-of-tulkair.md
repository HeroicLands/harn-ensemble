...
hm3:
  ...
  items:
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 620 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dge }
    - { model: skill-pysn }
    - { model: skill-ridg, system: { masteryLevelBase: 20 } }
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 80 } }
    - { model: skill-hide, system: { masteryLevelBase: 22 } }
    - { model: miscgear-pence, system: { quantity: 620 } }
