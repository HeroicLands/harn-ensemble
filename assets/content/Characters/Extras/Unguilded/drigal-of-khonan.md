...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, name: Dog (Animalcraft), system: { masteryLevel: 84 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 492 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 492 } }
...
Modifier to EyeColor of +15 (from 47) {Complexion=Swarthy, Species=Human}
