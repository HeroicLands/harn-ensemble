...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, system: { masteryLevel: 48 } }
    ...
    - { shortcode: fletching, type: skill, system: { masteryLevel: 18 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 334 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, system: { masteryLevelBase: 48 } }
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 61
    - { model: skill-fltch, system: { masteryLevelBase: 18 } }
    - { model: skill-hide, system: { masteryLevelBase: 30 } }
    - { model: skill-trak, system: { masteryLevelBase: 70 } }
    - { model: miscgear-pence, system: { quantity: 334 } }
...
Modifier to EyeColor of -10 (from 87) {Complexion=Fair, Species=Human}
