...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2433 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Longbow (Bow), system: { masteryLevelBase: 105 } }
    ...
    - { model: miscgear-pence, system: { quantity: 2433 } }
...
Modifier to HairColor of -25 (from 73) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 65) {Complexion=Dark, Species=Human}

Left-Handed mod to Dexterity: +2

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +100 (from 83) {SocialClass=Serf}
