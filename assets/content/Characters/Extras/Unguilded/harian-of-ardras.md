...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 50 } }
    - { shortcode: flail, type: skill, name: Grailflail (Flail), system: { masteryLevel: 50 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 480 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 480 } }
