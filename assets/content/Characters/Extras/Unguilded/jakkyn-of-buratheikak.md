...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 104 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 88 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: spear, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1641 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 92 } }
    - { model: skill-dge }
    ...
    - { model: miscgear-pence, system: { quantity: 1641 } }
...
Modifier to AttributesCOM of +4 (from 12) {Species=Khuzdul}

Modifier to AttributesAUR of -1 (from 9) {Species=Khuzdul}

Modifier to AttributesWIL of +3 (from 14) {Species=Khuzdul}

Modifier to SiblingRank of -20 (from 80) {Species=Khuzdul}

One Leg Missing/Deformed reduces Agilty by half: -2
