...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-init, system: { masteryLevelBase: 77 } }
    - { model: sohl-sohl-skill-shok }
    - { model: sohl-sohl-skill-intr, system: { masteryLevelBase: 33 } }
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 20 } }
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 92 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1641 } }
