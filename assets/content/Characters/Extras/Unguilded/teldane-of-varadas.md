...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Longbow (Bow), system: { masteryLevel: 48 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: spear, type: skill, name: Javelin (Spear), system: { masteryLevel: 55 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Longbow (Bow), system: { masteryLevelBase: 48 } }
...
Modifier to EyeColor of +15 (from 48) {Complexion=Swarthy, Species=Human}
