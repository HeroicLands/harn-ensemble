...
hm3:
  ...
  items:
    ...
    - { shortcode: tracking, type: skill, system: { masteryLevel: 21 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1091 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-trak, system: { masteryLevelBase: 21 } }
    - { model: miscgear-pence, system: { quantity: 1091 } }
...
Modifier to EyeColor of +15 (from 10) {Complexion=Swarthy, Species=Human}

One Eye Missing/Blind mod to Eyssight: -3

165lbs weight resulted in +1 strength mod.

Modifier to StartingEquipment of +400 (from 93) {SocialClass=Noble}
