...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-lang, name: "Language, Noble", system: { masteryLevelBase: 103 } }
    - { model: sohl-sohl-skill-anmcft, system: { masteryLevelBase: 44 } }
    - { model: sohl-sohl-skill-trak, system: { masteryLevelBase: 21 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1091 } }
