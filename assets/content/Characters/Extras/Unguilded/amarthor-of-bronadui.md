...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 91 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 85 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1706 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1706 } }
...
Modifier to AttributesAUR of +4 (from 8) {Species=Sindarin}
