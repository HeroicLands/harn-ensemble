...
hm3:
  ...
  items:
    ...
    - { shortcode: throwing, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: shield, type: skill, system: { masteryLevel: 119 } }
    - { shortcode: spear, type: skill, system: { masteryLevel: 120 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 6653 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 116 } }
    - { model: skill-dge }
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 98 } }
    ...
    - { model: miscgear-pence, system: { quantity: 6653 } }
...
Modifier to AttributesSTA of +1 (from 6) {Species=Sindarin}
...
Modifier to AttributesVOI of +2 (from 14) {Species=Sindarin}
...
Modifier to SiblingRank of -20 (from 12) {Species=Sindarin}
