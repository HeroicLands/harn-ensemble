...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 215 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 215 } }
...
Modifier to SiblingRank of -20 (from 34) {Species=Sindarin}
