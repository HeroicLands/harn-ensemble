...
hm3:
  ...
  items:
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: whip, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1092 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 98 } }
    - { model: miscgear-pence, system: { quantity: 1092 } }
