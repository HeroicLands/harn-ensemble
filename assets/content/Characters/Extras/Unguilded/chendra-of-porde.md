...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 908 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 908 } }
...
Modifier to EyeColor of -10 (from 31) {Complexion=Fair, Species=Human}
