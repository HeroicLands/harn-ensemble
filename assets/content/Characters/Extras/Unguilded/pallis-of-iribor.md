...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-anmcft, system: { masteryLevelBase: 77 } }
    - { model: sohl-sohl-skill-trak, system: { masteryLevelBase: 48 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 44 } }
