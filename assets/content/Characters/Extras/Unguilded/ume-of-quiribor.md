...
hm3:
  ...
  items:
    ...
    - { shortcode: fishing, type: skill, system: { masteryLevel: 60 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-fish, system: { masteryLevelBase: 60 } }
...
Modifier to StartingEquipment of +300 (from 14) {SocialClass=Guilded}
