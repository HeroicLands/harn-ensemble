...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Khuzdul), system: { masteryLevel: 65 } }
    ...
    - { shortcode: folklore, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1267 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr, system: { masteryLevelBase: 105 } }
    - { model: skill-guil }
    ...
    - { model: miscgear-pence, system: { quantity: 1267 } }
