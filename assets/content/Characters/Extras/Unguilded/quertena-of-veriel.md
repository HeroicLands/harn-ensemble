...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 110 } }
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 275 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 110 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce }
    - { model: skill-dscr }
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 76
    - { model: skill-eng, system: { masteryLevelBase: 30 } }
    - { model: miscgear-pence, system: { quantity: 275 } }
