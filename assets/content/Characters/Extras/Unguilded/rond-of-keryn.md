...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 99 } }
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 44 } }
