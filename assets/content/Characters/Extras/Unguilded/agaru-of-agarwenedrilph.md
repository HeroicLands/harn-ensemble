...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2303 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2303 } }
...
Modifier to AttributesSTA of +1 (from 9) {Species=Sindarin}
...
Modifier to SiblingRank of -20 (from 82) {Species=Sindarin}
