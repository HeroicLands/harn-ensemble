...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 63 } }
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 81 } }
...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 761 } }
...
Modifier to AttributesDEX of +1 (from 5) {Species=Khuzdul}
