...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Heartbow (Bow), system: { masteryLevel: 96 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2111 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 96 } }
    ...
    - { model: miscgear-pence, system: { quantity: 2111 } }
...
Modifier to SiblingRank of -20 (from 22) {Species=Sindarin}
