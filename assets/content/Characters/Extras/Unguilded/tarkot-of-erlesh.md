...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Script(Runic)), system: { masteryLevel: 103 } }
    - shortcode: script
      type: skill
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1077 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1077 } }
...
Modifier to EyeColor of -25 (from 98) {Complexion=Pale, Species=Human}
