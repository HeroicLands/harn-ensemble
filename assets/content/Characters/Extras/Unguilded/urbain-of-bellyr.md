...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Noble", system: { masteryLevel: 106 } }
    ...
    - { shortcode: axe, type: skill, name: Warhammer (Axe), system: { masteryLevel: 96 } }
    - { shortcode: club, type: skill, name: Morningstar (Club), system: { masteryLevel: 96 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3266 } }
    - { shortcode: pursebuckram, type: containergear }
    - { shortcode: KBack, type: armorgear }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 106 } }
    - { model: miscgear-pence, system: { quantity: 3266 } }
...
Modifier to EyeColor of -25 (from 84) {Complexion=Pale, Species=Human}

Modifier to StartingEquipment of +400 (from 72) {SocialClass=Noble}
