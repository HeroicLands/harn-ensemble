...
hm3:
  ...
  items:
    ...
    - { shortcode: fishing, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: piloting, type: skill, system: { masteryLevel: 27 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 27 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 88 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-fish, system: { masteryLevelBase: 66 } }
    - { model: skill-pilt, system: { masteryLevelBase: 27 } }
    - { model: skill-smsh, system: { masteryLevelBase: 54 } }
...
Modifier to HairColor of +25 (from 52) {Complexion=Fair, Species=Human}
