...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-fish, system: { masteryLevelBase: 66 } }
    - { model: sohl-sohl-skill-pilt, system: { masteryLevelBase: 27 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 54 } }
    - { model: sohl-sohl-skill-shpw, system: { masteryLevelBase: 27 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 987 } }
