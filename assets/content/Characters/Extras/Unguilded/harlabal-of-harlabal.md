...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 99 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2270 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 88 } }
    - { model: skill-dge }
    ...
    - { model: miscgear-pence, system: { quantity: 2270 } }
...
Modifier to AttributesSTR of +4 (from 7) {Species=Khuzdul}
...
Modifier to AttributesEYE of +1 (from 15) {Species=Khuzdul}
...
Modifier to SiblingRank of -20 (from 70) {Species=Khuzdul}

Epilepsy mod to Intelligence: +1

156lbs weight resulted in +1 strength mod.
