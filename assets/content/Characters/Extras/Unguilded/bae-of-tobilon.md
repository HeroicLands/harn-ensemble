...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 66 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 225 } }
...
sohl:
  ...
  items:
    ...
    - shortcode: lang
      ...
      system:
        masteryLevelBase: 61
    - { shortcode: anmcft, type: skill, system: { masteryLevelBase: 66 } }
