...
hm3:
  ...
  items:
    ...
    - { shortcode: throwing, type: skill, system: { masteryLevel: 85 } }
    ...
    - { shortcode: shield, type: skill, system: { masteryLevel: 126 } }
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 108 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1062 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 119 } }
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 85 } }
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 48 } }
    - { model: miscgear-pence, system: { quantity: 1062 } }
...
Modifier to AttributesAGL of +2 (from 6) {Species=Sindarin}
