...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Shortbow (Bow), system: { masteryLevel: 77 } }
    ...
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 108 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Shortbow (Bow), system: { masteryLevelBase: 77 } }
