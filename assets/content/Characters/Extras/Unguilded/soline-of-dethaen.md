...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-anmcft, name: Rat (Animalcraft), system: { masteryLevelBase: 60 } }
    - { model: sohl-sohl-skill-herb, system: { masteryLevelBase: 22 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 785 } }
    ...
    - { model: sohl-sohl-miscgear-cageironsm }
