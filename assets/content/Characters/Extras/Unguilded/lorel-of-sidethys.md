...
hm3:
  ...
  items:
    ...
    - { shortcode: net, type: skill, system: { masteryLevel: 44 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, name: Rat (Animalcraft), system: { masteryLevelBase: 104 } }
    - { model: skill-herb, system: { masteryLevelBase: 40 } }
    - { model: miscgear-pence, system: { quantity: 1153 } }
...
Modifier to EyeColor of -25 (from 66) {Complexion=Pale, Species=Human}
