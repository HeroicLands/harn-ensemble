...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 433 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 433 } }
...
Modifier to StartingEquipment of +300 (from 75) {SocialClass=Guilded}
