...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, system: { masteryLevel: 66 } }
    ...
    - shortcode: animalcraft
      ...
      system:
        masteryLevel: 112
    - { shortcode: animalcraft, type: skill, name: Rat (Animalcraft), system: { masteryLevel: 98 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, name: Rat (Animalcraft), system: { masteryLevelBase: 98 } }
