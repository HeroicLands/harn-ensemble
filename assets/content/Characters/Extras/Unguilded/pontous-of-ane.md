...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: fletching, type: skill, system: { masteryLevel: 32 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, system: { masteryLevelBase: 78 } }
