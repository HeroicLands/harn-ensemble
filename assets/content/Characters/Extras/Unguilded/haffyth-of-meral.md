...
hm3:
  ...
  items:
    ...
    - { shortcode: shield, type: skill, system: { masteryLevel: 35 } }
    - { shortcode: spear, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 35 } }
    ...
    - name: "Debt to Money Lender: Clavro of Chuzyn for 32d"
      type: miscgear
      data:
