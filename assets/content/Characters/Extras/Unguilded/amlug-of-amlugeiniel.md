...
hm3:
  ...
  items:
    ...
    - { shortcode: awareness, type: skill, system: { masteryLevel: 68 } }
    ...
    - { shortcode: bow, type: skill, name: Heartbow (Bow), system: { masteryLevel: 105 } }
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2431 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 105 } }
    ...
    - { model: skill-melee, system: { masteryLevelBase: 89 } }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 26 } }
    - { model: skill-ridg, system: { masteryLevelBase: 104 } }
    ...
    - { model: miscgear-pence, system: { quantity: 2431 } }
...
Modifier to AttributesEYE of +2 (from 16) {Species=Sindarin}
