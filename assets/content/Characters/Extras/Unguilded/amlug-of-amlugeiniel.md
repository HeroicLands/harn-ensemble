...
sohl:
  ...
  items:
    ...
    - { shortcode: archery, type: skill, name: Heartbow (Bow), system: { masteryLevelBase: 105 } }
    - { shortcode: awar, type: skill, system: { masteryLevelBase: 68 } }
    - { shortcode: chrm, type: skill }
    - { shortcode: clmb, type: skill, system: { masteryLevelBase: 65 } }
    - { shortcode: cmd, type: skill }
    - { shortcode: cook, type: skill }
    - { shortcode: dnce, type: skill, system: { masteryLevelBase: 64 } }
    ...
    - { shortcode: melee, type: skill, system: { masteryLevelBase: 89 } }
    - { shortcode: dge, type: skill }
    - { shortcode: pysn, type: skill, system: { masteryLevelBase: 26 } }
    - { shortcode: ridg, type: skill, system: { masteryLevelBase: 104 } }
