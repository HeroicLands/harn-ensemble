...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 52 } }
    - { shortcode: bow, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: sling, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: fletching, type: skill, system: { masteryLevel: 44 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 207 } }
    ...
    - { shortcode: hidebeaver, type: miscgear }
...
sohl:
  ...
  items:
    ...
    - { model: skill-slng, system: { masteryLevelBase: 33 } }
    - { model: skill-fltch, system: { masteryLevelBase: 44 } }
    - { model: skill-hide, system: { masteryLevelBase: 22 } }
    - { model: skill-trak, system: { masteryLevelBase: 78 } }
    - { model: miscgear-pence, system: { quantity: 207 } }
