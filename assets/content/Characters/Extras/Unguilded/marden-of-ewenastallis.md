...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-slng, system: { masteryLevelBase: 33 } }
    - { model: sohl-sohl-skill-fltch, system: { masteryLevelBase: 44 } }
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 22 } }
    - { model: sohl-sohl-skill-trak, system: { masteryLevelBase: 78 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 207 } }
    ...
    - { model: sohl-sohl-miscgear-hidebeaver }
