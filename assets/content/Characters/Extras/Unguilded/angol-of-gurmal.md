...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 70 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 375 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 375 } }
...
Modifier to AttributesDEX of +1 (from 14) {Species=Khuzdul}
...
Modifier to SiblingRank of -20 (from 58) {Species=Khuzdul}
...
Modifier to StartingEquipment of +300 (from 95) {SocialClass=Guilded}
