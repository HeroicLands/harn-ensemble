...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Falchion (Sword), system: { masteryLevel: 80 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2764 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2764 } }
