...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Falchion (Sword), system: { masteryLevel: 75 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 529 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 529 } }
