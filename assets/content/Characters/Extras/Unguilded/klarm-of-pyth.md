...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Shortbow (Bow), system: { masteryLevel: 104 } }
    ...
    - { shortcode: sword, type: skill, name: Falchion (Sword), system: { masteryLevel: 66 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 34 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1068 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Shortbow (Bow), system: { masteryLevelBase: 104 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1068 } }
