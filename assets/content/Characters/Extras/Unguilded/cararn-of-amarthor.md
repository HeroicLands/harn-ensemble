...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Heartbow (Bow), system: { masteryLevel: 63 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1765 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 63 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1765 } }
...
Modifier to AttributesSTR of +1 (from 10) {Species=Sindarin}

Modifier to AttributesSTA of +1 (from 14) {Species=Sindarin}

Modifier to AttributesDEX of +2 (from 9) {Species=Sindarin}

Modifier to AttributesAGL of +2 (from 16) {Species=Sindarin}
