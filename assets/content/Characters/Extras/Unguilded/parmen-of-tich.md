...
sohl:
  ...
  items:
    ...
    - { model: skill-agri, system: { masteryLevelBase: 104 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 55 } }
    - { model: miscgear-pence, system: { quantity: 391 } }
...
Modifier to EyeColor of -25 (from 29) {Complexion=Pale, Species=Human}
