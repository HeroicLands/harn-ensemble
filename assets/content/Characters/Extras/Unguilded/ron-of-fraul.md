...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 50 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-agri, system: { masteryLevelBase: 78 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 50 } }
