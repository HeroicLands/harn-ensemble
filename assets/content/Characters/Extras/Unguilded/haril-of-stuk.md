...
hm3:
  ...
  items:
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 78 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dge }
    - { model: skill-pysn }
    - { model: skill-ridg, system: { masteryLevelBase: 32 } }
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 78 } }
    - { model: skill-hide, system: { masteryLevelBase: 45 } }
    - { model: miscgear-pence, system: { quantity: 604 } }
...
**Age**: 20
**Birthday**: 19 Nolus 700
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 5th child of 11
**Siblings**: MFmMMmMffFF
**Parentage**: Offspring
