...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 65 } }
    ...
    - name: "Debt to Money Lender: Obrasel of Neris for 290d"
      type: miscgear
      data:
...
Modifier to SiblingRank of -20 (from 98) {Species=Khuzdul}
