...
hm3:
  ...
  items:
    ...
    - name: "Debt to Money Lender: Darit of Paseralgurth for 379d"
      type: miscgear
      data:
...
Modifier to AttributesSTA of +2 (from 18) {Species=Khuzdul}
...
Modifier to SiblingRank of -20 (from 64) {Species=Khuzdul}

120lbs weight resulted in -2 strength mod.
