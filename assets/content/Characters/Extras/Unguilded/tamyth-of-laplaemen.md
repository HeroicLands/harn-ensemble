...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Noble", system: { masteryLevel: 78 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1409 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 78 } }
    - { model: skill-hrld, system: { masteryLevelBase: 26 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 1409 } }
...
Modifier to EyeColor of +25 (from 93) {Complexion=Dark, Species=Human}

Modifier to StartingEquipment of +400 (from 65) {SocialClass=Noble}
