...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 91 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 54 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 92
    - { model: skill-agri, system: { masteryLevelBase: 112 } }
