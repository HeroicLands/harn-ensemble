...
hm3:
  ...
  items:
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 557 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 24 } }
    ...
    - { model: skill-hide, system: { masteryLevelBase: 22 } }
    - { model: skill-lock, system: { masteryLevelBase: 44 } }
    - { model: miscgear-pence, system: { quantity: 557 } }
...
Modifier to HairColor of -25 (from 10) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 9) {Complexion=Dark, Species=Human}
