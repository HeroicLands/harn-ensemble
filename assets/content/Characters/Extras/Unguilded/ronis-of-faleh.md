...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-clmb, system: { masteryLevelBase: 96 } }
    ...
    - { model: sohl-sohl-skill-intr, system: { masteryLevelBase: 24 } }
    ...
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 22 } }
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 44 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 557 } }
