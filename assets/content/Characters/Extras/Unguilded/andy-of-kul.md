...
hm3:
  ...
  items:
    ...
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 63 } }
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 78 } }
    ...
    - name: "Debt to Money Lender: Drusax of Barnil for 800d"
      type: miscgear
      data:
...
Modifier to SiblingRank of -20 (from 18) {Species=Khuzdul}
