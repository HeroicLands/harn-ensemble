...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Noble", system: { masteryLevel: 103 } }
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 51 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1917 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 103 } }
    - { model: skill-eng, system: { masteryLevelBase: 51 } }
    - { model: miscgear-pence, system: { quantity: 1917 } }
...
Modifier to StartingEquipment of +400 (from 43) {SocialClass=Noble}
