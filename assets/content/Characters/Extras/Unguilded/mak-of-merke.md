...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 825 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr, system: { masteryLevelBase: 77 } }
    - { model: skill-guil }
    ...
    - { model: miscgear-pence, system: { quantity: 825 } }
...
Modifier to AttributesAGL of +2 (from 18) {Frame=Scant}
