...
hm3:
  ...
  items:
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1881 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-script
      ...
      system:
        masteryLevelBase: 92
    - { model: skill-math, system: { masteryLevelBase: 78 } }
    - { model: miscgear-pence, system: { quantity: 1881 } }
