...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook, system: { masteryLevelBase: 91 } }
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    ...
    - { model: miscgear-pence, system: { quantity: 686 } }
...
Modifier to EyeColor of +15 (from 81) {Complexion=Swarthy, Species=Human}
