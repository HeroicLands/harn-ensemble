...
hm3:
  ...
  items:
    ...
    - { shortcode: throwing, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1478 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 96 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1478 } }
...
Modifier to SiblingRank of -20 (from 21) {Species=Sindarin}
