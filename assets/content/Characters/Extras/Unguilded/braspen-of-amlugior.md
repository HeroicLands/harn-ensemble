...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3620 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 3620 } }
...
Modifier to SiblingRank of -20 (from 24) {Species=Sindarin}
