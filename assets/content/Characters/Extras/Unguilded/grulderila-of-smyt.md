...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 294 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 96 } }
    - { model: skill-trak, system: { masteryLevelBase: 33 } }
    - { model: miscgear-pence, system: { quantity: 294 } }
