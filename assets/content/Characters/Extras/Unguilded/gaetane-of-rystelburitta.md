...
hm3:
  ...
  items:
    ...
    - { shortcode: awareness, type: skill, system: { masteryLevel: 112 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2361 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery }
    - { model: skill-awar, system: { masteryLevelBase: 112 } }
    - { model: skill-chrm }
    ...
    - { model: miscgear-pence, system: { quantity: 2361 } }
    ...
    - { model: miscgear-vellumperp, system: { quantity: 10 } }
  system:
    body:
      structure:
        zones:
