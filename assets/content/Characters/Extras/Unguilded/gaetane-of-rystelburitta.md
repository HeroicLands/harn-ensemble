...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-awar, system: { masteryLevelBase: 112 } }
    ...
    - { model: sohl-sohl-skill-draw, system: { masteryLevelBase: 105 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2361 } }
    ...
    - { model: sohl-sohl-miscgear-vellumperp, system: { quantity: 10 } }
  system:
    body:
      structure:
        zones:
