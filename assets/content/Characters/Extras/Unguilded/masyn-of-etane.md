...
hm3:
  ...
  items:
    ...
    - { shortcode: awareness, type: skill, system: { masteryLevel: 25 } }
    ...
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 96 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1206 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery }
    - { model: skill-awar, system: { masteryLevelBase: 25 } }
    - { model: skill-chrm }
    ...
    - { model: miscgear-pence, system: { quantity: 1206 } }
