...
hm3:
  ...
  items:
    ...
    - { shortcode: stealth, type: skill, system: { masteryLevel: 18 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 338 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-stlth, system: { masteryLevelBase: 18 } }
    - { model: skill-srvl }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: miscgear-pence, system: { quantity: 338 } }
