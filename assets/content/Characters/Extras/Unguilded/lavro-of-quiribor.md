...
hm3:
  ...
  items:
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2405 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 105 } }
    - { model: skill-hide, system: { masteryLevelBase: 45 } }
    - { model: miscgear-pence, system: { quantity: 2405 } }
