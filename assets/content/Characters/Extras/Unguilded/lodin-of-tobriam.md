...
hm3:
  ...
  items:
    ...
    - { shortcode: whip, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 91 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2580 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 91 } }
    - { model: miscgear-pence, system: { quantity: 2580 } }
