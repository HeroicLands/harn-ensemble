...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Heartbow (Bow), system: { masteryLevel: 90 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 90 } }
...
Modifier to AttributesDEX of +2 (from 16) {Species=Sindarin}
...
Modifier to SiblingRank of -20 (from 36) {Species=Sindarin}
