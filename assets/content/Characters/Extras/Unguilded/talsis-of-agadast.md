...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2711 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2711 } }
...
Modifier to Frame of +3 (from 3) {Species=Khuzdul}
...
Modifier to AttributesHGR of +2 (from 17) {Species=Khuzdul}
...
Modifier to SiblingRank of -20 (from 59) {Species=Khuzdul}

81lbs weight resulted in -4 strength mod.
