...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Keltan (Dagger), system: { masteryLevel: 77 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 704 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 704 } }
...
Modifier to HairColor of +25 (from 4) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 3) {Complexion=Fair, Species=Human}
