...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 9 } }
    - shortcode: language
      type: skill
      name: Language, Serf
      system:
    ...
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 90 } }
    ...
    - name: "Debt to Money Lender: Lorago of Kramel for 1446d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 59 } }
...
Modifier to EyeColor of -10 (from 11) {Complexion=Fair, Species=Human}
