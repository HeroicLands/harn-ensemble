...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 40 } }
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 45 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 27 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1418 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-folklr }
    - { model: skill-guil }
    - { model: skill-init, system: { masteryLevelBase: 77 } }
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 110 } }
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 70 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1418 } }
...
Modifier to StartingEquipment of +300 (from 84) {SocialClass=Guilded}
