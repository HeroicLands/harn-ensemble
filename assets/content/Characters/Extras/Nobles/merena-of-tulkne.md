...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-intr, system: { masteryLevelBase: 110 } }
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 55 } }
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 53 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1418 } }
