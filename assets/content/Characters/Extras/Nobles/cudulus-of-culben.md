...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-dnce, system: { masteryLevelBase: 51 } }
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 96 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 13844 } }
    ...
    - { model: sohl-sohl-miscgear-circletcopper }
