...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 51 } }
    - { shortcode: jumping, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: stealth, type: skill, system: { masteryLevel: 68 } }
    ...
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 100 } }
    - { shortcode: riding, type: skill, system: { masteryLevel: 120 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 99 } }
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 88 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 13844 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 51 } }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: skill-melee, system: { masteryLevelBase: 96 } }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 39 } }
    - { model: skill-ridg, system: { masteryLevelBase: 120 } }
    ...
    - { model: miscgear-pence, system: { quantity: 13844 } }
...
Modifier to AttributesAGL of +2 (from 14) {Species=Sindarin}
...
Modifier to SiblingRank of -20 (from 44) {Species=Sindarin}
