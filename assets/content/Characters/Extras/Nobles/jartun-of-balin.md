...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 88 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 9764 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 9764 } }
...
Modifier to StartingEquipment of +200 (from 23) {SocialClass=Unguilded}
