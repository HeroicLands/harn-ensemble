...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 108 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 5153 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 5153 } }
...
Modifier to HairColor of -25 (from 57) {Complexion=Dark, Species=Human}
