...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 39 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 125 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 125 } }
...
Modifier to EyeColor of -10 (from 61) {Complexion=Fair, Species=Human}
