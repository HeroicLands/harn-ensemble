...
hm3:
  ...
  items:
    ...
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 51 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 4586 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 4586 } }
...
Modifier to HairColor of -25 (from 44) {Complexion=Dark, Species=Human}
