...
hm3:
  ...
  items:
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 63 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3727 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-sing, system: { masteryLevelBase: 80 } }
    ...
    - { model: miscgear-pence, system: { quantity: 3727 } }
