...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 45 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: polearm, type: skill, name: Poleaxe (Polearm), system: { masteryLevel: 54 } }
    ...
    - name: "Debt to Money Lender: Parga of Aweil for 1253d"
      type: miscgear
      data:
