...
hm3:
  ...
  items:
    ...
    - { shortcode: condition, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: dancing, type: skill, system: { masteryLevel: 66 } }
    ...
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 82 } }
    - { shortcode: oratory, type: skill, system: { masteryLevel: 21 } }
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: singing, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 105 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 98 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 7927 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 66 } }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    - { model: skill-guil }
    - { model: skill-init, system: { masteryLevelBase: 108 } }
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 36 } }
    - { model: skill-jump, system: { masteryLevelBase: 72 } }
    - { model: skill-melee, system: { masteryLevelBase: 102 } }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 52 } }
    - { model: skill-ridg, system: { masteryLevelBase: 108 } }
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 84 } }
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 82 } }
    - { model: skill-hrld, system: { masteryLevelBase: 28 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 84 } }
    - { model: miscgear-pence, system: { quantity: 7927 } }
...
Modifier to HairColor of +25 (from 90) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 68) {Complexion=Fair, Species=Human}

Leprosy mod to Comeliness: -11

Heavy frame resulted in -1 agility mod.

Modifier to StartingEquipment of +300 (from 13) {SocialClass=Guilded}
