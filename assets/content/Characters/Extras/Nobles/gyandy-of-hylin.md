...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 56 } }
    - { shortcode: dagger, type: skill, name: Keltan (Dagger), system: { masteryLevel: 56 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 35 } }
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 16 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pilt, system: { masteryLevelBase: 16 } }
