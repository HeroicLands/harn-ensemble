...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 8022 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-srvl, system: { masteryLevelBase: 91 } }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: miscgear-pence, system: { quantity: 8022 } }
...
Modifier to AttributesVOI of +2 (from 5) {Species=Sindarin}
...
Modifier to SiblingRank of -20 (from 35) {Species=Sindarin}
