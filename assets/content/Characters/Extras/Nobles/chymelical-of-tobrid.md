...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 60 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 5212 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 5212 } }
...
Modifier to HairColor of +25 (from 74) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 93) {Complexion=Fair, Species=Human}
