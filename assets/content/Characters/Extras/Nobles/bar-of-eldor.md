...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 112 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 7041 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jump, system: { masteryLevelBase: 91 } }
    - { model: skill-melee, system: { masteryLevelBase: 105 } }
    - { model: skill-dge }
    ...
    - { model: miscgear-pence, system: { quantity: 7041 } }
...
Modifier to EyeColor of +25 (from 61) {Complexion=Dark, Species=Human}

Epilepsy mod to Intelligence: +3

170lbs weight resulted in +1 strength mod.

Modifier to StartingEquipment of +100 (from 81) {SocialClass=Serf}
