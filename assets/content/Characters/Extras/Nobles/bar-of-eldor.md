...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 91 } }
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 105 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 7041 } }
