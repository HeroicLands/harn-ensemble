...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 96 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: polearm, type: skill, name: Poleaxe (Polearm), system: { masteryLevel: 108 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 5951 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jump, system: { masteryLevelBase: 104 } }
    ...
    - { model: miscgear-pence, system: { quantity: 5951 } }
...
Modifier to AttributesSTA of +2 (from 15) {Species=Khuzdul}
...
Modifier to SiblingRank of -20 (from 72) {Species=Khuzdul}
