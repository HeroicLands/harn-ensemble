...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 98 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2755 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 70 } }
    - { model: miscgear-pence, system: { quantity: 2755 } }
