...
hm3:
  ...
  items:
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2637 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 91 } }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: miscgear-pence, system: { quantity: 2637 } }
...
Modifier to EyeColor of +15 (from 3) {Complexion=Swarthy, Species=Human}
...
Modifier to StartingEquipment of +100 (from 41) {SocialClass=Serf}
