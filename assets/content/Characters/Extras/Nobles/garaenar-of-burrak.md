...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 72 } }
    ...
    - { shortcode: shield, type: skill, system: { masteryLevel: 88 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 4347 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 4347 } }
...
Modifier to AttributesSML of +2 (from 5) {Species=Khuzdul}
...
Modifier to SiblingRank of -20 (from 87) {Species=Khuzdul}

Ambidexterous mod to Dexterity: +1

129lbs weight resulted in -2 strength mod.
