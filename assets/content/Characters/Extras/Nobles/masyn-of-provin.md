...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 85 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 119 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 68 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 7194 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 97 } }
    - { model: skill-dge }
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 68 } }
    - { model: miscgear-pence, system: { quantity: 7194 } }
