...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 75 } }
    ...
    - name: "Debt to Money Lender: Chymelic of Kansen for 910d"
      type: miscgear
      data:
...
Modifier to EyeColor of +25 (from 6) {Complexion=Dark, Species=Human}

Leprosy mod to Comeliness: -5
