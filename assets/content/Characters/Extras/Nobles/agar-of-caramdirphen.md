...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 100 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 10740 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 10740 } }
...
Modifier to SiblingRank of -20 (from 40) {Species=Sindarin}
