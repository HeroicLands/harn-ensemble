...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 64 } }
...
Modifier to EyeColor of +15 (from 46) {Complexion=Swarthy, Species=Human}
