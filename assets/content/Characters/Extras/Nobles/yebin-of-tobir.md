...
hm3:
  ...
  items:
    ...
    - { shortcode: initiative, type: skill, system: { masteryLevel: 81 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1006 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-folklr }
    - { model: skill-guil }
    - { model: skill-init, system: { masteryLevelBase: 81 } }
    - { model: skill-shok }
    ...
    - { model: miscgear-pence, system: { quantity: 1006 } }
...
164lbs weight resulted in +1 strength mod.

Massive frame resulted in -2 agility mod.

Modifier to StartingEquipment of +200 (from 14) {SocialClass=Unguilded}
