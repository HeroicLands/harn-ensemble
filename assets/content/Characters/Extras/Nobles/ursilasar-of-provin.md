...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Keltan (Dagger), system: { masteryLevel: 80 } }
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 55 } }
