...
sohl:
  ...
  items:
    ...
    - { model: skill-slng, system: { masteryLevelBase: 26 } }
    - { model: skill-fltch, system: { masteryLevelBase: 26 } }
    - { model: skill-hide, system: { masteryLevelBase: 55 } }
    - { model: skill-trak, system: { masteryLevelBase: 78 } }
    - { model: miscgear-pence, system: { quantity: 4021 } }
...
Modifier to HairColor of +25 (from 47) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 97) {Complexion=Fair, Species=Human}
