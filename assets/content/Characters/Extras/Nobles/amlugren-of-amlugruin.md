...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 52 } }
    ...
    - { shortcode: shield, type: skill, system: { masteryLevel: 110 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 13122 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-ridg, system: { masteryLevelBase: 110 } }
...
Modifier to AttributesAUR of +4 (from 5) {Species=Sindarin}
