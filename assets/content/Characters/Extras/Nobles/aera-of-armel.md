...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 104 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 9729 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 93 } }
    - { model: skill-dge }
    ...
    - { model: miscgear-pence, system: { quantity: 9729 } }
...
Modifier to HairColor of -25 (from 77) {Complexion=Dark, Species=Human}
