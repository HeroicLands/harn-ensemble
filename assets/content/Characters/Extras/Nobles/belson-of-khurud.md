...
hm3:
  ...
  items:
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 57 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 4646 } }
...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 77 } }
    ...
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 57 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 4646 } }
