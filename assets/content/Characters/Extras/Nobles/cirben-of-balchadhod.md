...
hm3:
  ...
  items:
    ...
    - { shortcode: stealth, type: skill, system: { masteryLevel: 54 } }
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: shield, type: skill, system: { masteryLevel: 81 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 8946 } }
