...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1147 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1147 } }
...
Modifier to SiblingRank of -20 (from 12) {Species=Khuzdul}
