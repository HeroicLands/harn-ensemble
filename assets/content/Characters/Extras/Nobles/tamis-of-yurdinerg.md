...
hm3:
  ...
  items:
    ...
    - { shortcode: polearm, type: skill, name: Poleaxe (Polearm), system: { masteryLevel: 70 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2095 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2095 } }
