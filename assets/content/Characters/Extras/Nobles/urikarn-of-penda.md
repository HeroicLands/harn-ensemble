...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: tracking, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 4496 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-hide, system: { masteryLevelBase: 33 } }
    - { model: skill-trak, system: { masteryLevelBase: 65 } }
    - { model: miscgear-pence, system: { quantity: 4496 } }
...
Modifier to StartingEquipment of +200 (from 94) {SocialClass=Unguilded}
