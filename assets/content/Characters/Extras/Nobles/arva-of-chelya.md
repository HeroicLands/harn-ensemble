...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, system: { masteryLevel: 35 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, system: { masteryLevelBase: 35 } }
    ...
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 112 } }
    ...
    - { model: skill-hide, system: { masteryLevelBase: 48 } }
    - { model: skill-trak, system: { masteryLevelBase: 96 } }
    - { model: miscgear-pence, system: { quantity: 3898 } }
...
Modifier to HairColor of -25 (from 38) {Complexion=Dark, Species=Human}
