...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2708 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 72 } }
    - { model: skill-hrld, system: { masteryLevelBase: 42 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 60 } }
    - { model: miscgear-pence, system: { quantity: 2708 } }
...
Modifier to Frame of +3 (from 5) {Species=Khuzdul}
...
Modifier to AttributesWIL of +3 (from 12) {Species=Khuzdul}

Modifier to SiblingRank of -20 (from 62) {Species=Khuzdul}

98lbs weight resulted in -3 strength mod.
