...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 88 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 10414 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 91 } }
    ...
    - { model: miscgear-pence, system: { quantity: 10414 } }
...
Modifier to EyeColor of -25 (from 53) {Complexion=Pale, Species=Human}
