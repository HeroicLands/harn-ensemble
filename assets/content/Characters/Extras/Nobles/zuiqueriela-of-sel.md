...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: club, type: skill, system: { masteryLevel: 45 } }
    ...
    - { shortcode: tracking, type: skill, system: { masteryLevel: 91 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 756 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, system: { masteryLevelBase: 33 } }
    ...
    - { model: skill-fltch, system: { masteryLevelBase: 22 } }
    - { model: skill-hide, system: { masteryLevelBase: 33 } }
    - { model: skill-trak, system: { masteryLevelBase: 91 } }
    - { model: miscgear-pence, system: { quantity: 756 } }
...
Modifier to Frame of -3 (from 3) {Sex=Female, Species=Human}
...
Modifier to EyeColor of +15 (from 5) {Complexion=Swarthy, Species=Human}
