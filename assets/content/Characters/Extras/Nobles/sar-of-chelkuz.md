...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 99 } }
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 65 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 13485 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-ridg, system: { masteryLevelBase: 99 } }
    ...
    - { model: skill-agri, system: { masteryLevelBase: 64 } }
    - { model: skill-hrld, system: { masteryLevelBase: 33 } }
    - { model: skill-law, system: { masteryLevelBase: 65 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 48 } }
    - { model: miscgear-pence, system: { quantity: 13485 } }
