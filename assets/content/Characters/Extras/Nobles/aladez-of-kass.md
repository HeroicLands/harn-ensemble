...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 28 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1613 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1613 } }
