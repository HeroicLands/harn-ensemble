...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Keltan (Dagger), system: { masteryLevel: 48 } }
    ...
    - name: "Debt to Money Lender: Makan of Iarasaka for 108d"
      type: miscgear
      data:
...
Modifier to HairColor of -25 (from 46) {Complexion=Dark, Species=Human}
