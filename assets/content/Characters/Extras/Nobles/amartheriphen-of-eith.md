...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: stealth, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: throwing, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: awareness, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 34 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 11726 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery }
    - { model: skill-awar, system: { masteryLevelBase: 98 } }
    - { model: skill-chrm }
    ...
    - { model: miscgear-pence, system: { quantity: 11726 } }
...
Modifier to Frame of -2 (from 3) {Species=Sindarin}
