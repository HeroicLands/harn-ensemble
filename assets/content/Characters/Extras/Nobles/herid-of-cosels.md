...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 84 } }
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 101 } }
    ...
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 51 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2720 } }
