...
hm3:
  ...
  items:
    ...
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 102 } }
    - { shortcode: riding, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 100 } }
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 51 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2720 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 101 } }
    - { model: skill-dge }
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 51 } }
    - { model: miscgear-pence, system: { quantity: 2720 } }
