...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-attribute-cre, system: { scoreBase: 3 } }
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 99 } }
    ...
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 39 } }
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 26 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1322 } }
