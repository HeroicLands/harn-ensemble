...
hm3:
  ...
  items:
    ...
    - { shortcode: awareness, type: skill, system: { masteryLevel: 42 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1322 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1322 } }
...
Modifier to StartingEquipment of +200 (from 61) {SocialClass=Unguilded}
