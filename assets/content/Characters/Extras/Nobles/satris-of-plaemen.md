...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 57 } }
    - { shortcode: oratory, type: skill, system: { masteryLevel: 18 } }
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 21 } }
    - { shortcode: singing, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 50 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 42 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 57 } }
...
Modifier to EyeColor of +15 (from 89) {Complexion=Swarthy, Species=Human}
