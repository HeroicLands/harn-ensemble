...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 108 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 6636 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 6636 } }
