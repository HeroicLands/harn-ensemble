...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 60 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3890 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 3890 } }
...
Modifier to AttributesAGL of +2 (from 18) {Species=Sindarin}

Modifier to AttributesEYE of +2 (from 13) {Species=Sindarin}

Modifier to AttributesHGR of +2 (from 11) {Species=Sindarin}
...
Modifier to SiblingRank of -20 (from 70) {Species=Sindarin}
