...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-archery, system: { masteryLevelBase: 55 } }
    ...
    - model: sohl-sohl-skill-lang
      ...
      system:
        masteryLevelBase: 74
    - { model: sohl-sohl-skill-fltch, system: { masteryLevelBase: 36 } }
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 33 } }
    - { model: sohl-sohl-skill-trak, system: { masteryLevelBase: 60 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 4803 } }
