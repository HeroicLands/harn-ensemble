...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, name: Javelin (Spear), system: { masteryLevel: 50 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 4803 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 91 } }
    ...
    - { model: skill-trak, system: { masteryLevelBase: 60 } }
    - { model: miscgear-pence, system: { quantity: 4803 } }
...
Modifier to StartingEquipment of +200 (from 51) {SocialClass=Unguilded}
