...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 66 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: polearm, type: skill, name: Poleaxe (Polearm), system: { masteryLevel: 77 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3732 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 3732 } }
