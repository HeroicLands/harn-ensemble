...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3710 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 3710 } }
...
Modifier to AttributesAUR of +4 (from 6) {Species=Sindarin}

Modifier to AttributesMOR of +3 (from 8) {Species=Sindarin}

Modifier to SiblingRank of -20 (from 49) {Species=Sindarin}
