...
hm3:
  ...
  items:
    ...
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 70 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 7936 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-agri, system: { masteryLevelBase: 44 } }
    ...
    - { model: miscgear-pence, system: { quantity: 7936 } }
...
Modifier to HairColor of +25 (from 97) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 18) {Complexion=Fair, Species=Human}

128lbs weight resulted in -2 strength mod.

Scant frame resulted in +2 agility mod.

Modifier to StartingEquipment of +100 (from 62) {SocialClass=Serf}
