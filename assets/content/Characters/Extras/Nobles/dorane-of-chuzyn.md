...
hm3:
  ...
  items:
    ...
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 49 } }
    ...
    - name: "Debt to Money Lender: Samil of Elwaylin for 386d"
      type: miscgear
      data:
