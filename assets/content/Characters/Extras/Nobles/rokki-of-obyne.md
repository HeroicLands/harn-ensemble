...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1875 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1875 } }
...
Modifier to StartingEquipment of +200 (from 75) {SocialClass=Unguilded}
