...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 91 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1628 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1628 } }
