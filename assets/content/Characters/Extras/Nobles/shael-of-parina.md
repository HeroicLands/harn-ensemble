...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 81 } }
    ...
    - { shortcode: survival, type: skill, system: { masteryLevel: 49 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 924 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 924 } }
