...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Keltan (Dagger), system: { masteryLevel: 70 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1470 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1470 } }
...
Modifier to HairColor of -25 (from 70) {Complexion=Dark, Species=Human}
