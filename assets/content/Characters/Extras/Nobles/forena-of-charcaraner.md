...
hm3:
  ...
  items:
    ...
    - { shortcode: survival, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 5348 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 106 } }
    - { model: skill-dge }
    ...
    - { model: miscgear-pence, system: { quantity: 5348 } }
