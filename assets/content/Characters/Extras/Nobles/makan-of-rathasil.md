...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Jarinese), system: { masteryLevel: 18 } }
    ...
    - { shortcode: dagger, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 98 } }
    ...
    - name: "Debt to Money Lender: Rond of Eldin for 39d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 98 } }
    - { model: skill-folklr }
    - { model: skill-guil }
...
Modifier to EyeColor of -25 (from 52) {Complexion=Pale, Species=Human}

One Ear Missing/Deaf mod to Hearing: -2
