...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 98 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 6403 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 64 } }
    - { model: miscgear-pence, system: { quantity: 6403 } }
