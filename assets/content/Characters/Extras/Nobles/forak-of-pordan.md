...
hm3:
  ...
  items:
    ...
    - { shortcode: initiative, type: skill, system: { masteryLevel: 100 } }
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 105 } }
    - { shortcode: riding, type: skill, system: { masteryLevel: 100 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 6982 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-ridg, system: { masteryLevelBase: 100 } }
    ...
    - { model: miscgear-pence, system: { quantity: 6982 } }
...
Modifier to HairColor of -25 (from 47) {Complexion=Dark, Species=Human}
