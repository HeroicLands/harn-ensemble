...
hm3:
  ...
  items:
    ...
    - { shortcode: tracking, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1609 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-slng, system: { masteryLevelBase: 44 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1609 } }
