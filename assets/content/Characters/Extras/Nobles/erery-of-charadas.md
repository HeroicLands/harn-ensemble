...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 52 } }
    - { shortcode: flail, type: skill, name: Grailflail (Flail), system: { masteryLevel: 39 } }
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: tracking, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 3343 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, system: { masteryLevelBase: 55 } }
    ...
    - { model: skill-fltch, system: { masteryLevelBase: 24 } }
    - { model: skill-hide, system: { masteryLevelBase: 39 } }
    - { model: skill-trak, system: { masteryLevelBase: 72 } }
    - { model: miscgear-pence, system: { quantity: 3343 } }
...
Modifier to EyeColor of +25 (from 52) {Complexion=Dark, Species=Human}
