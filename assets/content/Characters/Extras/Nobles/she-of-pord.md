...
hm3:
  ...
  items:
    ...
    - { shortcode: foraging, type: skill, system: { masteryLevel: 77 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-smsh, system: { masteryLevelBase: 56 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 45 } }
    - { model: miscgear-pence, system: { quantity: 2378 } }
...
Modifier to HairColor of +25 (from 70) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 28) {Complexion=Fair, Species=Human}
