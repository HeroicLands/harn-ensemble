...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Keltan (Dagger), system: { masteryLevel: 54 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 54 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2320 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2320 } }
...
Modifier to EyeColor of +15 (from 45) {Complexion=Swarthy, Species=Human}
