...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 104 } }
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 91 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 5823 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 64 } }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: skill-jump, system: { masteryLevelBase: 96 } }
    - { model: skill-melee, system: { masteryLevelBase: 103 } }
    - { model: skill-dge }
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 65 } }
    - { model: miscgear-pence, system: { quantity: 5823 } }
