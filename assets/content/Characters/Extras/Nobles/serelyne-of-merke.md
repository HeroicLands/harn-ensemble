...
hm3:
  ...
  items:
    ...
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 54 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: Jav, type: weapongear, system: { quantity: 0 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, system: { masteryLevelBase: 60 } }
...
Modifier to EyeColor of +25 (from 35) {Complexion=Dark, Species=Human}
