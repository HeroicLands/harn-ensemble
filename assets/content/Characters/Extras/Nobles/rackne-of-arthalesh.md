...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: shield, type: skill, system: { masteryLevel: 80 } }
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 22 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 11242 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jump, system: { masteryLevelBase: 105 } }
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 64
    - { model: skill-agri, system: { masteryLevelBase: 22 } }
    ...
    - { model: miscgear-pence, system: { quantity: 11242 } }
...
Modifier to HairColor of +25 (from 64) {Complexion=Fair, Species=Human}
