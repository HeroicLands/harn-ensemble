...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 68 } }
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 91 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: polearm, type: skill, name: Poleaxe (Polearm), system: { masteryLevel: 91 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 68 } }
...
Modifier to Frame of +3 (from 13) {Species=Khuzdul}

Modifier to AttributesSTR of +4 (from 11) {Species=Khuzdul}

Modifier to AttributesSTA of +2 (from 10) {Species=Khuzdul}

Modifier to AttributesDEX of +1 (from 11) {Species=Khuzdul}

Modifier to AttributesAGL of -2 (from 10) {Frame=Massive}

Modifier to AttributesEYE of +1 (from 13) {Species=Khuzdul}

Modifier to AttributesHGR of +2 (from 11) {Species=Khuzdul}
...
Modifier to SiblingRank of -20 (from 34) {Species=Khuzdul}

Eldest gets +5 on estrangement roll.

One Eye Missing/Blind mod to Eyssight: -1

138lbs weight resulted in -1 strength mod.
