...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 112 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2552 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2552 } }
...
Modifier to AttributesHGR of +2 (from 15) {Species=Khuzdul}
...
Modifier to SiblingRank of -20 (from 2) {Species=Khuzdul}
