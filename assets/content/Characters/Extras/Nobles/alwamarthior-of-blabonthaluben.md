...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 48 } }
    ...
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 112 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 85 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 9493 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 96 } }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: skill-melee, system: { masteryLevelBase: 110 } }
    - { model: skill-dge }
...
Modifier to AttributesDEX of +2 (from 12) {Species=Sindarin}

Modifier to AttributesAGL of +2 (from 15) {Species=Sindarin}
