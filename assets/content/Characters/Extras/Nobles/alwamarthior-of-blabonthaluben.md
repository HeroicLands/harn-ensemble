...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-dnce, system: { masteryLevelBase: 96 } }
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 110 } }
