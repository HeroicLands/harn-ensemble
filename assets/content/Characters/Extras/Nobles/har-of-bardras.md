...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 28 } }
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 92 } }
    - { shortcode: oratory, type: skill, system: { masteryLevel: 77 } }
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 66 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 99 } }
    - { shortcode: riding, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 84 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 84 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2333 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 104 } }
    - { model: skill-folklr }
    - { model: skill-guil }
    - { model: skill-init, system: { masteryLevelBase: 112 } }
    - { model: skill-shok }
    ...
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 72 } }
    ...
    - { model: skill-hrld, system: { masteryLevelBase: 84 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 26 } }
    - { model: miscgear-pence, system: { quantity: 2333 } }
    ...
    - { model: miscgear-earringscopper }
    - { model: armorgear-LtCap }
    - { model: containergear-papercasel }
