...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 84 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 10601 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 98 } }
    - { model: skill-dge }
    ...
    - { model: miscgear-pence, system: { quantity: 10601 } }
...
**Age**: 53
**Birthday**: 6 Navek 667
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 4th child of 11
**Siblings**: FmfMfMmmFMm
**Parentage**: Offspring
