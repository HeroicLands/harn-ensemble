...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 84 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 13003 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-agri, system: { masteryLevelBase: 84 } }
    ...
    - { model: miscgear-pence, system: { quantity: 13003 } }
...
Modifier to EyeColor of +25 (from 38) {Complexion=Dark, Species=Human}
