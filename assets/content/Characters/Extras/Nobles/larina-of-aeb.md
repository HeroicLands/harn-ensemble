...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2266 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2266 } }
...
Modifier to HairColor of +25 (from 83) {Complexion=Fair, Species=Human}
