...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 49 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 11403 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 11403 } }
