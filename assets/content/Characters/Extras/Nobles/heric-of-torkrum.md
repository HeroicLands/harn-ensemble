...
hm3:
  ...
  items:
    ...
    - { shortcode: polearm, type: skill, name: Poleaxe (Polearm), system: { masteryLevel: 110 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3549 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 3549 } }
...
Modifier to SiblingRank of -20 (from 84) {Species=Khuzdul}
