...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 55 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 105 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 105 } }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: skill-ridg, system: { masteryLevelBase: 78 } }
...
Modifier to EyeColor of +25 (from 25) {Complexion=Dark, Species=Human}
