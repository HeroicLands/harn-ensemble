...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: stealth, type: skill, system: { masteryLevel: 91 } }
    - { shortcode: throwing, type: skill, system: { masteryLevel: 102 } }
    ...
    - { shortcode: singing, type: skill, system: { masteryLevel: 25 } }
    - { shortcode: bow, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: flail, type: skill, name: Grailflail (Flail), system: { masteryLevel: 48 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: fletching, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: tracking, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 3917 } }
    ...
    - { shortcode: GrnFl, type: weapongear }
...
sohl:
  ...
  items:
    ...
    - { model: attribute-voi, system: { scoreBase: 3 } }
    - { model: skill-archery, system: { masteryLevelBase: 112 } }
    ...
    - { model: skill-jump, system: { masteryLevelBase: 84 } }
    - { model: skill-melee, system: { masteryLevelBase: 66 } }
    - { model: skill-dge }
    - { model: skill-pysn }
    - { model: skill-ridg }
    - { model: skill-sing, system: { masteryLevelBase: 25 } }
    - { model: skill-stlth, system: { masteryLevelBase: 91 } }
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 66 } }
    - { model: skill-fltch, system: { masteryLevelBase: 64 } }
    - { model: skill-hide, system: { masteryLevelBase: 52 } }
    - { model: skill-trak, system: { masteryLevelBase: 104 } }
    - { model: miscgear-pence, system: { quantity: 3917 } }
...
Modifier to EyeColor of +15 (from 29) {Complexion=Swarthy, Species=Human}
