...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 28 } }
    ...
    - { shortcode: fletching, type: skill, system: { masteryLevel: 39 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 993 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, system: { masteryLevelBase: 50 } }
