...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 119 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 4107 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 117 } }
    - { model: skill-dge }
    ...
    - { model: miscgear-pence, system: { quantity: 4107 } }
...
Modifier to AttributesDEX of +2 (from 18) {Species=Sindarin}
