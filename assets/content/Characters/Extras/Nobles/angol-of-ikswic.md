...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 99 } }
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 108 } }
    - { shortcode: riding, type: skill, system: { masteryLevel: 88 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 7996 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 94 } }
    - { model: skill-dge }
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 80 } }
    - { model: skill-hrld, system: { masteryLevelBase: 52 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 22 } }
    - { model: miscgear-pence, system: { quantity: 7996 } }
...
Modifier to EyeColor of -10 (from 49) {Complexion=Fair, Species=Human}

Scars mod to Comeliness: -2

Modifier to StartingEquipment of +400 (from 46) {SocialClass=Noble}
