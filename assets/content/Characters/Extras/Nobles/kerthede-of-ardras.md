...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Jarinese), system: { masteryLevel: 20 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 108 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 801 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-hrld, system: { masteryLevelBase: 108 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 44 } }
    - { model: miscgear-pence, system: { quantity: 801 } }
...
Modifier to EyeColor of +25 (from 69) {Complexion=Dark, Species=Human}
