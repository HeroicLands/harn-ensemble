...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 80 } }
    ...
    - { shortcode: awareness, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 99 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 13212 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery }
    - { model: skill-awar, system: { masteryLevelBase: 104 } }
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 80 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 80 } }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: miscgear-pence, system: { quantity: 13212 } }
...
Modifier to SiblingRank of -20 (from 47) {Species=Sindarin}
