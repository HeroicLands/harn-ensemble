...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-awar, system: { masteryLevelBase: 104 } }
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 103 } }
    - { model: sohl-sohl-skill-dge }
    - { model: sohl-sohl-skill-pysn, system: { masteryLevelBase: 60 } }
    - { model: sohl-sohl-skill-ridg, system: { masteryLevelBase: 120 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 13212 } }
