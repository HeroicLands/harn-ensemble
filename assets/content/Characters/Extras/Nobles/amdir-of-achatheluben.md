...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 9655 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 40 } }
    - { model: miscgear-pence, system: { quantity: 9655 } }
...
Modifier to AttributesMOR of +3 (from 5) {Species=Sindarin}
