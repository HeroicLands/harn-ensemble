...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 90 } }
    ...
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 40 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 9655 } }
