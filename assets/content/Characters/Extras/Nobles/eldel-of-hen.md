...
hm3:
  ...
  items:
    ...
    - { shortcode: unarmed, type: skill, system: { shortcode: unarmed2, masteryLevel: 96 } }
...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-archery, system: { masteryLevelBase: 98 } }
    ...
    - { model: sohl-sohl-skill-trak, system: { masteryLevelBase: 98 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1845 } }
