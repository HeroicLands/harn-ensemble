...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3341 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-folklr }
    - { model: skill-guil }
    - { model: skill-init, system: { masteryLevelBase: 110 } }
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 55 } }
    - { model: skill-jump, system: { masteryLevelBase: 44 } }
    - { model: skill-melee, system: { masteryLevelBase: 107 } }
    - { model: skill-dge }
    ...
    - { model: miscgear-earringssilver }
    - { model: miscgear-tndrbx }
    - { model: armorgear-RCap }
    - { model: miscgear-amuletsilver }
...
Modifier to StartingEquipment of +300 (from 51) {SocialClass=Guilded}
