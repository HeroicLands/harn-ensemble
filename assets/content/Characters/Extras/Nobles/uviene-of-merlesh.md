...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3591 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-law, system: { masteryLevelBase: 40 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 48 } }
    - { model: miscgear-pence, system: { quantity: 3591 } }
