...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 28 } }
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 24 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 50 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 60 } }
    - { shortcode: riding, type: skill, system: { masteryLevel: 49 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 56 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 944 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-ridg, system: { masteryLevelBase: 49 } }
    ...
    - { model: miscgear-pence, system: { quantity: 944 } }
...
Modifier to StartingEquipment of +200 (from 33) {SocialClass=Unguilded}
