...
sohl:
  ...
  items:
    ...
    - { shortcode: srvl, type: skill, system: { masteryLevelBase: 112 } }
    ...
    - { shortcode: wpnc, type: skill, system: { masteryLevelBase: 80 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2667 } }
