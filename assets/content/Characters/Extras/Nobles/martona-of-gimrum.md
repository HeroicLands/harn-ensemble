...
hm3:
  ...
  items:
    ...
    - { shortcode: stealth, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 105 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 119 } }
    - { shortcode: polearm, type: skill, name: Poleaxe (Polearm), system: { masteryLevel: 112 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 68 } }
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2667 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-folklr }
    - { model: skill-guil }
    - { model: skill-init, system: { masteryLevelBase: 119 } }
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 70 } }
    - { model: skill-jump, system: { masteryLevelBase: 52 } }
    - { model: skill-melee, system: { masteryLevelBase: 100 } }
    - { model: skill-dge }
    ...
    - { model: skill-srvl, system: { masteryLevelBase: 112 } }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 80 } }
    - { model: miscgear-pence, system: { quantity: 2667 } }
...
Modifier to AttributesAGL of -1 (from 15) {Frame=Heavy}

Modifier to AttributesEYE of +1 (from 12) {Species=Khuzdul}

Modifier to AttributesHGR of +2 (from 14) {Species=Khuzdul}
...
Modifier to SiblingRank of -20 (from 86) {Species=Khuzdul}
