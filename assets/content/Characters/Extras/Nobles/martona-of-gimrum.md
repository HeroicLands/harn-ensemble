...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-srvl, system: { masteryLevelBase: 112 } }
    ...
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 80 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2667 } }
