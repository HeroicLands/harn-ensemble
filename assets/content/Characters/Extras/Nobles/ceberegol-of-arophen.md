...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: oratory, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: singing, type: skill, system: { masteryLevel: 57 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 10037 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 104 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    ...
    - { model: skill-ridg, system: { masteryLevelBase: 112 } }
...
Modifier to AttributesSTA of +1 (from 16) {Species=Sindarin}
...
Modifier to AttributesVOI of +2 (from 17) {Species=Sindarin}
...
Modifier to SiblingRank of -20 (from 27) {Species=Sindarin}
