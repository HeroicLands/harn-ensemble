...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-clmb, system: { masteryLevelBase: 104 } }
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 107 } }
    - { model: sohl-sohl-skill-dge }
    - { model: sohl-sohl-skill-pysn, system: { masteryLevelBase: 48 } }
    - { model: sohl-sohl-skill-ridg, system: { masteryLevelBase: 112 } }
