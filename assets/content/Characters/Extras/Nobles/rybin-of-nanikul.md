...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3155 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 3155 } }
...
Modifier to SiblingRank of -20 (from 81) {Species=Khuzdul}
