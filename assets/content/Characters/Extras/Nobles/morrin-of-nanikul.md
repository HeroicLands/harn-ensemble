...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 104 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: polearm, type: skill, name: Poleaxe (Polearm), system: { masteryLevel: 104 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 722 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 91 } }
    - { model: skill-dge }
    ...
    - { model: miscgear-pence, system: { quantity: 722 } }
...
Modifier to AttributesDEX of +1 (from 10) {Species=Khuzdul}

Modifier to AttributesAGL of -2 (from 5) {Frame=Massive}

Modifier to AttributesEYE of +1 (from 14) {Species=Khuzdul}
...
Modifier to AttributesAUR of -1 (from 11) {Species=Khuzdul}

Modifier to AttributesWIL of +3 (from 15) {Species=Khuzdul}

Modifier to SiblingRank of -20 (from 74) {Species=Khuzdul}
