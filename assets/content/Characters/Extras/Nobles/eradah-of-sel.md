...
hm3:
  ...
  items:
    ...
    - { shortcode: stealth, type: skill, system: { masteryLevel: 80 } }
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 3244 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pilt, system: { masteryLevelBase: 40 } }
    - { model: skill-smsh, system: { masteryLevelBase: 48 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 39 } }
    - { model: miscgear-pence, system: { quantity: 3244 } }
