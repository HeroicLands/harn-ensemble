...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 42 } }
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 60 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 12240 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-law, system: { masteryLevelBase: 60 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 20 } }
    - { model: miscgear-pence, system: { quantity: 12240 } }
