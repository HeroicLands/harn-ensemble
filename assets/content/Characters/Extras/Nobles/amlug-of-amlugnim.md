...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 6209 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 6209 } }
...
Modifier to AttributesSML of +3 (from 5) {Species=Sindarin}
