...
hm3:
  ...
  items:
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 6878 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-agri, system: { masteryLevelBase: 26 } }
    ...
    - { model: miscgear-pence, system: { quantity: 6878 } }
