...
hm3:
  ...
  items:
    ...
    - { shortcode: tracking, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 3899 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-trak, system: { masteryLevelBase: 112 } }
    - { model: miscgear-pence, system: { quantity: 3899 } }
