...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 84 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 119 } }
    - { shortcode: polearm, type: skill, name: Poleaxe (Polearm), system: { masteryLevel: 96 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 4985 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 4985 } }
...
Modifier to AttributesSML of +2 (from 7) {Species=Khuzdul}
...
Modifier to SiblingRank of -20 (from 67) {Species=Khuzdul}
