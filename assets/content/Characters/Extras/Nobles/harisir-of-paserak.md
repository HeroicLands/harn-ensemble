...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 18 } }
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 108 } }
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 54 } }
    ...
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 72 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 85 } }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 22 } }
    - { model: skill-ridg, system: { masteryLevelBase: 54 } }
    ...
    - { model: skill-hrld, system: { masteryLevelBase: 72 } }
...
Modifier to HairColor of +25 (from 25) {Complexion=Fair, Species=Human}
