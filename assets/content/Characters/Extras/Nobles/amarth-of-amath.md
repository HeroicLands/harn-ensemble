...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 76 } }
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 112 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 8300 } }
