...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 76 } }
    ...
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 120 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 8300 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jump, system: { masteryLevelBase: 76 } }
    - { model: skill-melee, system: { masteryLevelBase: 112 } }
    - { model: skill-dge }
    ...
    - { model: miscgear-pence, system: { quantity: 8300 } }
...
Modifier to SiblingRank of -20 (from 67) {Species=Sindarin}
