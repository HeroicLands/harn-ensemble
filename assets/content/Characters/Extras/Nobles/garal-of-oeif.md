...
hm3:
  ...
  items:
    ...
    - { shortcode: polearm, type: skill, name: Poleaxe (Polearm), system: { masteryLevel: 80 } }
    ...
    - name: "Debt to Money Lender: Ugen of Kai for 398d"
      type: miscgear
      data:
...
Modifier to SiblingRank of -20 (from 57) {Species=Khuzdul}
