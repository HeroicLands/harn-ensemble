...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 65 } }
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 70 } }
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 63 } }
    ...
    - name: "Debt to Money Lender: Bar of Intrenel for 1097d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 80 } }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: skill-ridg, system: { masteryLevelBase: 70 } }
...
Modifier to AttributesAUR of +2 (from 18) {Sex=Female, Species=Human}

Eldest gets +5 on estrangement roll.

Modifier to HairColor of -25 (from 24) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 12) {Complexion=Dark, Species=Human}

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +200 (from 64) {SocialClass=Unguilded}
