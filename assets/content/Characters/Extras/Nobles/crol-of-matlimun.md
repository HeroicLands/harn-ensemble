...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-init, system: { masteryLevelBase: 81 } }
    ...
    - { model: sohl-sohl-skill-ridg, system: { masteryLevelBase: 81 } }
    ...
    - { model: sohl-sohl-skill-law, system: { masteryLevelBase: 66 } }
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 20 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 8362 } }
