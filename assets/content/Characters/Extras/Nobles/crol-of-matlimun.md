...
sohl:
  ...
  items:
    ...
    - { shortcode: init, type: skill, system: { masteryLevelBase: 81 } }
    ...
    - { shortcode: ridg, type: skill, system: { masteryLevelBase: 81 } }
    ...
    - { shortcode: law, type: skill, system: { masteryLevelBase: 66 } }
