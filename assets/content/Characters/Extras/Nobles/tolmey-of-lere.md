...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 102 } }
    ...
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 77 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 12551 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jump, system: { masteryLevelBase: 102 } }
    ...
    - { model: miscgear-pence, system: { quantity: 12551 } }
