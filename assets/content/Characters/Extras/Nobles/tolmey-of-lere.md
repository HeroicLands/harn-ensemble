...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 102 } }
    ...
    - { model: sohl-sohl-skill-sing, system: { masteryLevelBase: 96 } }
    - { model: sohl-sohl-skill-stlth, system: { masteryLevelBase: 80 } }
    - { model: sohl-sohl-skill-srvl, system: { masteryLevelBase: 91 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 12551 } }
