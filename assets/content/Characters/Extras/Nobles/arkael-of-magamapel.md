...
hm3:
  ...
  items:
    ...
    - { shortcode: polearm, type: skill, name: Poleaxe (Polearm), system: { masteryLevel: 105 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 7549 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 7549 } }
