...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2137 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-hide, system: { masteryLevelBase: 26 } }
    - { model: skill-trak, system: { masteryLevelBase: 78 } }
    - { model: miscgear-pence, system: { quantity: 2137 } }
