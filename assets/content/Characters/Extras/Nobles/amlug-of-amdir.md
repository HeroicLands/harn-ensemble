...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 78 } }
    ...
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 110 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 11884 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 109 } }
    - { model: skill-dge }
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 78 } }
    ...
    - { model: miscgear-pence, system: { quantity: 11884 } }
