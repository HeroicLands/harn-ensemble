...
hm3:
  ...
  items:
    ...
    - shortcode: language
      ...
      system:
        masteryLevel: 86
    - { shortcode: musician, type: skill, system: { masteryLevel: 34 } }
    ...
    - { shortcode: sword, type: skill, name: Longknife (Sword), system: { masteryLevel: 78 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 4353 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery }
    - { model: skill-awar, system: { masteryLevelBase: 96 } }
    - { model: skill-chrm }
    ...
    - { model: skill-melee, system: { masteryLevelBase: 99 } }
    - { model: skill-dge }
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 86
    - { model: skill-musc, system: { masteryLevelBase: 34 } }
    - { model: skill-hrld, system: { masteryLevelBase: 32 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 39 } }
    - { model: miscgear-pence, system: { quantity: 4353 } }
...
Modifier to Frame of -2 (from 4) {Species=Sindarin}
...
Modifier to SiblingRank of -20 (from 10) {Species=Sindarin}
