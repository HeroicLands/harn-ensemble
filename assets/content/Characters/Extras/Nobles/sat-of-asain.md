...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 105 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 85 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 7570 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 85 } }
    - { model: miscgear-pence, system: { quantity: 7570 } }
...
Modifier to AttributesAGL of -2 (from 13) {Frame=Massive}

Left-Handed mod to Dexterity: +2

188lbs weight resulted in +2 strength mod.
