...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 102 } }
    - { model: sohl-sohl-skill-dge }
    - { model: sohl-sohl-skill-pysn, system: { masteryLevelBase: 55 } }
    - { model: sohl-sohl-skill-ridg, system: { masteryLevelBase: 104 } }
    ...
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 85 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 7570 } }
