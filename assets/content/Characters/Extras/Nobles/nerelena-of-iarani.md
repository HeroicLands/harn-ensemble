...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 18 } }
    ...
    - name: "Debt to Money Lender: Rosta of Orlon for 515d"
      type: miscgear
      data:
...
Modifier to EyeColor of +15 (from 64) {Complexion=Swarthy, Species=Human}
