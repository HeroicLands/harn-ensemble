...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Jarinese), system: { masteryLevel: 11 } }
    - shortcode: language
      type: skill
      name: Language, Noble
      system:
    ...
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 48 } }
    - { shortcode: riding, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 40 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 35 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1976 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 78 } }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: skill-hrld, system: { masteryLevelBase: 52 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 26 } }
    - { model: miscgear-pence, system: { quantity: 1976 } }
...
Modifier to HairColor of +25 (from 72) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 46) {Complexion=Fair, Species=Human}

93lbs weight resulted in -3 strength mod.

Heavy frame resulted in -1 agility mod.

Modifier to StartingEquipment of +400 (from 85) {SocialClass=Noble}
