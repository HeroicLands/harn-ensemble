...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 70 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 321 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 321 } }
...
Modifier to HairColor of -25 (from 62) {Complexion=Dark, Species=Human}
