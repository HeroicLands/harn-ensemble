...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 35 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 9407 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 35 } }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: miscgear-pence, system: { quantity: 9407 } }
