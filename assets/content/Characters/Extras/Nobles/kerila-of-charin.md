...
hm3:
  ...
  items:
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1212 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 50 } }
    - { model: miscgear-pence, system: { quantity: 1212 } }
