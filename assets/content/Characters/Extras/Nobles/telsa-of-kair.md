...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 69 } }
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 60 } }
    - { shortcode: dagger, type: skill, name: Keltan (Dagger), system: { masteryLevel: 63 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 863 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 69 } }
    ...
    - { model: miscgear-pence, system: { quantity: 863 } }
...
Modifier to StartingEquipment of +300 (from 90) {SocialClass=Guilded}
