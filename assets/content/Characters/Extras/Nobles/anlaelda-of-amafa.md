...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 25 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 91 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 28 } }
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 24 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 4954 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 62
    - { model: skill-agri, system: { masteryLevelBase: 24 } }
    ...
    - { model: miscgear-pence, system: { quantity: 4954 } }
