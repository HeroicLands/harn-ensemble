...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 77 } }
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 102 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 3608 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jump, system: { masteryLevelBase: 77 } }
    ...
    - { model: skill-smsh, system: { masteryLevelBase: 60 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 75 } }
    - { model: miscgear-pence, system: { quantity: 3608 } }
