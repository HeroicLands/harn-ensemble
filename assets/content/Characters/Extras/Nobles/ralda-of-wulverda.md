...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 106 } }
    ...
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 75 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 3608 } }
