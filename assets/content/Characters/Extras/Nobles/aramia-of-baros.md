...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 96 } }
    ...
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 63 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 4650 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 21 } }
    ...
    - { model: miscgear-pence, system: { quantity: 4650 } }
...
Modifier to EyeColor of +25 (from 23) {Complexion=Dark, Species=Human}

106lbs weight resulted in -3 strength mod.

Scant frame resulted in +2 agility mod.

Modifier to StartingEquipment of +400 (from 83) {SocialClass=Noble}
