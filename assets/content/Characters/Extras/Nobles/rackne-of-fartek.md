...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 90 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1203 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1203 } }
...
Modifier to AttributesAUR of -1 (from 5) {Species=Khuzdul}

Modifier to AttributesWIL of +3 (from 11) {Species=Khuzdul}

Modifier to SiblingRank of -20 (from 21) {Species=Khuzdul}
