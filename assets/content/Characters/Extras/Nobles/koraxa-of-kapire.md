...
hm3:
  ...
  items:
    ...
    - { shortcode: fletching, type: skill, system: { masteryLevel: 27 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 522 } }
