...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 40 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 8427 } }
...
Modifier to AttributesSML of +3 (from 16) {Species=Sindarin}
...
Modifier to SiblingRank of -20 (from 17) {Species=Sindarin}
