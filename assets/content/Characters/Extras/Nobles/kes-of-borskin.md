...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 15 } }
    ...
    - { shortcode: riding, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 45 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3176 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 15 } }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: miscgear-pence, system: { quantity: 3176 } }
