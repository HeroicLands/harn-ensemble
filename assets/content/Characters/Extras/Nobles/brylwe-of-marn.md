...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Jarinese), system: { masteryLevel: 28 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: dagger, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 54 } }
    - { shortcode: riding, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 72 } }
    ...
    - { shortcode: survival, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 3633 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 72 } }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: skill-ridg, system: { masteryLevelBase: 105 } }
    - { model: skill-sing, system: { masteryLevelBase: 44 } }
    - { model: skill-stlth, system: { masteryLevelBase: 52 } }
    - { model: skill-srvl, system: { masteryLevelBase: 72 } }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: miscgear-pence, system: { quantity: 3633 } }
