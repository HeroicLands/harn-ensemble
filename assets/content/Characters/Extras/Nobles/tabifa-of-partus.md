...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-fltch, system: { masteryLevelBase: 21 } }
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 24 } }
    - { model: sohl-sohl-skill-trak, system: { masteryLevelBase: 104 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 4321 } }
