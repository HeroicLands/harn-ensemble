...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 28 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: fletching, type: skill, system: { masteryLevel: 21 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 4321 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, system: { masteryLevelBase: 42 } }
    ...
    - { model: skill-srvl, system: { masteryLevelBase: 24 } }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
