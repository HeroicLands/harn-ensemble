...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3753 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 3753 } }
...
Modifier to HairColor of -25 (from 22) {Complexion=Dark, Species=Human}
