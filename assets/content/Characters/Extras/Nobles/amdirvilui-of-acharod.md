...
hm3:
  ...
  items:
    ...
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 81 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2824 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-srvl, system: { masteryLevelBase: 32 } }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: miscgear-pence, system: { quantity: 2824 } }
