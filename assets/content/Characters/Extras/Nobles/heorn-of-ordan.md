...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 88 } }
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 64 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pilt, system: { masteryLevelBase: 64 } }
