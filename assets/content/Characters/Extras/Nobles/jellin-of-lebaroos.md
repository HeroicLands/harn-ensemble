...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 63 } }
    ...
    - { shortcode: survival, type: skill, system: { masteryLevel: 63 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 4578 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-srvl, system: { masteryLevelBase: 63 } }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: miscgear-pence, system: { quantity: 4578 } }
...
Modifier to HairColor of +25 (from 89) {Complexion=Fair, Species=Human}
