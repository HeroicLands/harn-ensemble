...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Jarinese), system: { masteryLevel: 12 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1106 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-hrld, system: { masteryLevelBase: 78 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 1106 } }
...
Modifier to EyeColor of +15 (from 88) {Complexion=Swarthy, Species=Human}
