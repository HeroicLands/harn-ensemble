...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 80 } }
    - { shortcode: dagger, type: skill, name: Keltan (Dagger), system: { masteryLevel: 60 } }
    ...
    - name: "Debt to Money Lender: Ral of Tonan for 738d"
      type: miscgear
      data:
