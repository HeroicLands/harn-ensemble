...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 78 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: polearm, type: skill, name: Lance (Polearm), system: { masteryLevel: 78 } }
    ...
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 66 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 82 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-hrld, system: { masteryLevelBase: 66 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 39 } }
    - { model: miscgear-pence, system: { quantity: 82 } }
