...
hm3:
  ...
  items:
    ...
    - { shortcode: throwing, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: axe, type: skill, name: Battleaxe (Axe), system: { masteryLevel: 105 } }
    - { shortcode: dagger, type: skill, name: Keltan (Dagger), system: { masteryLevel: 108 } }
...
Modifier to HairColor of -25 (from 53) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 44) {Complexion=Dark, Species=Human}

Leprosy mod to Comeliness: -7

157lbs weight resulted in +1 strength mod.

Modifier to StartingEquipment of +200 (from 42) {SocialClass=Unguilded}
