...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-clmb, system: { masteryLevelBase: 98 } }
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 95 } }
