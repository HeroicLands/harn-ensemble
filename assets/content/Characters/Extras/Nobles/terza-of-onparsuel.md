...
hm3:
  ...
  items:
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 66 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 933 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 82 } }
    ...
    - { model: miscgear-pence, system: { quantity: 933 } }
...
Modifier to EyeColor of -25 (from 30) {Complexion=Pale, Species=Human}

137lbs weight resulted in -1 strength mod.

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +400 (from 12) {SocialClass=Noble}
