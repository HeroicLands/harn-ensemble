...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 110 } }
    ...
    - { shortcode: dagger, type: skill, system: { masteryLevel: 99 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 12250 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 110 } }
    - { model: skill-hrld, system: { masteryLevelBase: 33 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 36 } }
    - { model: miscgear-pence, system: { quantity: 12250 } }
