...
hm3:
  ...
  items:
    ...
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 108 } }
    ...
    - shortcode: language
      ...
      system:
        ...
        masteryLevel: 61
    - { shortcode: oratory, type: skill, system: { masteryLevel: 49 } }
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 36 } }
    ...
    - { shortcode: foraging, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 683 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 108 } }
    ...
    - { model: skill-srvl, system: { masteryLevelBase: 28 } }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: skill-hrld, system: { masteryLevelBase: 98 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 30 } }
    - { model: miscgear-pence, system: { quantity: 683 } }
...
Modifier to HairColor of -25 (from 7) {Complexion=Dark, Species=Human}
