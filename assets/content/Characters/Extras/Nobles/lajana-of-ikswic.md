...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 47 } }
    ...
    - { model: sohl-sohl-skill-hrld, system: { masteryLevelBase: 98 } }
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 30 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 683 } }
