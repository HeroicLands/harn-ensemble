...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Bastard Sword (Sword), system: { masteryLevel: 65 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 335 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 335 } }
