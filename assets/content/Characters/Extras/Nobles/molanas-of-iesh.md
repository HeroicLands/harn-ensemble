...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 42 } }
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 90 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 5628 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 5628 } }
