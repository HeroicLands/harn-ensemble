...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: condition, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: dancing, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: language, type: skill, name: "Language, Noble", system: { masteryLevel: 79 } }
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 77 } }
    ...
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 60 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: foraging, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: law, type: skill, system: { masteryLevel: 27 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 9970 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 98 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 91 } }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    - { model: skill-guil }
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 79 } }
    - { model: skill-agri, system: { masteryLevelBase: 66 } }
    ...
    - { model: miscgear-pence, system: { quantity: 9970 } }
...
Modifier to HairColor of +25 (from 44) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 98) {Complexion=Fair, Species=Human}

125lbs weight resulted in -2 strength mod.

Scant frame resulted in +2 agility mod.

Modifier to StartingEquipment of +400 (from 86) {SocialClass=Noble}
