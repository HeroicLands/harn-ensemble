...
sohl:
  ...
  items:
    ...
    - { shortcode: clmb, type: skill, system: { masteryLevelBase: 98 } }
    - { shortcode: cmd, type: skill }
    - { shortcode: cook, type: skill }
    - { shortcode: dnce, type: skill, system: { masteryLevelBase: 91 } }
    ...
    - { shortcode: lang, type: skill, name: "Language, Noble", system: { masteryLevelBase: 79 } }
    - { shortcode: agri, type: skill, system: { masteryLevelBase: 66 } }
    ...
    - { shortcode: HAxe, type: weapongear }
    - { shortcode: Dgr, type: weapongear }
    - { shortcode: amuletgold, type: miscgear }
