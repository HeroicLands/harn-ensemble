...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 90 } }
    ...
    - { shortcode: dagger, type: skill, name: Keltan (Dagger), system: { masteryLevel: 55 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 705 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 105 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce }
    - { model: skill-dscr }
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 90 } }
    - { model: skill-hrld, system: { masteryLevelBase: 22 } }
    - { model: skill-pilt, system: { masteryLevelBase: 18 } }
    - { model: skill-smsh, system: { masteryLevelBase: 39 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 26 } }
    - { model: miscgear-pence, system: { quantity: 705 } }
