...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-clmb, system: { masteryLevelBase: 105 } }
    ...
    - { model: sohl-sohl-skill-lang, name: "Language, Serf", system: { masteryLevelBase: 90 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 705 } }
