...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 4145 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, system: { masteryLevelBase: 84 } }
    ...
    - { model: miscgear-pence, system: { quantity: 4145 } }
...
Modifier to HairColor of +25 (from 13) {Complexion=Fair, Species=Human}
