...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivashi), system: { masteryLevel: 60 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 75 } }
    ...
    - shortcode: animalcraft
      ...
      system:
        masteryLevel: 91
    - { shortcode: drawing, type: skill, system: { masteryLevel: 33 } }
    ...
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 112 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 759 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 33 } }
    - { model: skill-folklr, system: { masteryLevelBase: 54 } }
    - { model: skill-guil }
    ...
    - { model: miscgear-pence, system: { quantity: 759 } }
...
Modifier to StartingEquipment of +300 (from 4) {SocialClass=Guilded}
