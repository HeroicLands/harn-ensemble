...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 45 } }
    ...
    - { shortcode: naveh, type: skill, system: { masteryLevel: 90 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 521 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lock, system: { masteryLevelBase: 22 } }
    - { model: miscgear-pence, system: { quantity: 521 } }
...
Modifier to EyeColor of +25 (from 42) {Complexion=Dark, Species=Human}
