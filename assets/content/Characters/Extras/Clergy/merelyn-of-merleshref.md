...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 252 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 252 } }
...
Modifier to HairColor of +25 (from 80) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 80) {Complexion=Fair, Species=Human}
