...
hm3:
  ...
  items:
    ...
    - { shortcode: physician, type: skill, system: { masteryLevel: 70 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 448 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 448 } }
...
**Age**: 37
**Birthday**: 2 Peonu 683
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 7th child of 7
**Siblings**: FMffMmF
**Parentage**: Offspring
...
Modifier to HairColor of -25 (from 40) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 18) {Complexion=Dark, Species=Human}
