...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 82 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 141 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 82 } }
    ...
    - { model: miscgear-pence, system: { quantity: 141 } }
