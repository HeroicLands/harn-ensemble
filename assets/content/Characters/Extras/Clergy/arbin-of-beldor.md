...
hm3:
  ...
  items:
    ...
    - shortcode: language
      ...
      system:
        masteryLevel: 60
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 72 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-law, system: { masteryLevelBase: 20 } }
    - { model: skill-math, system: { masteryLevelBase: 20 } }
...
Modifier to StartingEquipment of +200 (from 16) {SocialClass=Unguilded}
