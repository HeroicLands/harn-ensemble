...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevel: 103 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 263 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Runic), system: { masteryLevelBase: 103 } }
    ...
    - { model: miscgear-pence, system: { quantity: 263 } }
