...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Neramic), system: { masteryLevel: 94 } }
...
sohl:
  ...
  items:
    ...
    - { shortcode: lgdm, type: skill, system: { masteryLevelBase: 20 } }
    - { shortcode: lang, type: skill, name: "Language, Serf", system: { masteryLevelBase: 66 } }
    - { shortcode: script, type: skill, name: Script(Neramic), system: { masteryLevelBase: 94 } }
