...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 48 } }
    - shortcode: language
      type: skill
      name: Language, Serf
      system:
    ...
    - { shortcode: naveh, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 532 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Neramic), system: { masteryLevelBase: 94 } }
    ...
    - { model: miscgear-pence, system: { quantity: 532 } }
