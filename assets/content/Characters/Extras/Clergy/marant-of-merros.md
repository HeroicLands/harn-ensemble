...
hm3:
  ...
  items:
    ...
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 48 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 123 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 123 } }
...
Modifier to EyeColor of +25 (from 8) {Complexion=Dark, Species=Human}
