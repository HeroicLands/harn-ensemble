...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-lgdm, system: { masteryLevelBase: 18 } }
    - { model: sohl-sohl-skill-lang, name: "Language, Serf", system: { masteryLevelBase: 63 } }
    - { model: sohl-sohl-skill-script, name: Script(Neramic), system: { masteryLevelBase: 80 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 546 } }
