...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 91 } }
    ...
    - { shortcode: oratory, type: skill, system: { masteryLevel: 66 } }
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevel: 79 } }
    - { shortcode: axe, type: skill, system: { masteryLevel: 66 } }
    ...
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 52 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 507 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Runic), system: { masteryLevelBase: 79 } }
    ...
    - { model: miscgear-pence, system: { quantity: 507 } }
