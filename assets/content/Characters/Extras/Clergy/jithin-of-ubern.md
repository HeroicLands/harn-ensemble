...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 24 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 609 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 609 } }
...
**Age**: 33
**Birthday**: 15 Morgat 687
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 5th child of 11
**Siblings**: MmMMMMFMFFf
**Parentage**: Offspring
...
Modifier to AttributesAGL of -2 (from 7) {Frame=Massive}

Modifier to EyeColor of +15 (from 51) {Complexion=Swarthy, Species=Human}
