...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 88 } }
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevel: 82 } }
...
sohl:
  ...
  items:
    ...
    - { shortcode: lang, type: skill, name: "Language, Guilded", system: { masteryLevelBase: 88 } }
    - { shortcode: musc, type: skill, system: { masteryLevelBase: 22 } }
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevelBase: 82 } }
    - { shortcode: astr, type: mysticalability, system: { masteryLevelBase: 65 } }
    ...
    - { shortcode: law, type: skill, system: { masteryLevelBase: 84 } }
    - { shortcode: runecft, type: mysticalability, system: { masteryLevelBase: 52 } }
    ...
    - { shortcode: holysymiron, type: miscgear }
