...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevel: 84 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: astrology, type: skill, system: { masteryLevel: 60 } }
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 18 } }
    ...
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 30 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 464 } }
...
sohl:
  ...
  items:
    ...
    - { model: attribute-per, system: { scoreBase: 5 } }
    ...
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 26 } }
    - { model: skill-folklr, system: { masteryLevelBase: 84 } }
    - { model: skill-guil }
    - { model: skill-init, system: { masteryLevelBase: 42 } }
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 52 } }
    - { model: skill-jump, system: { masteryLevelBase: 35 } }
    - { model: skill-melee }
    - { model: skill-dge }
    ...
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 84 } }
    - { model: mysticalability-astr, system: { masteryLevelBase: 60 } }
    - { model: skill-embl, system: { masteryLevelBase: 30 } }
    - { model: skill-hrld, system: { masteryLevelBase: 22 } }
    - { model: skill-herb, system: { masteryLevelBase: 18 } }
    ...
    - { model: miscgear-pence, system: { quantity: 464 } }
...
Modifier to AttributesAGL of +2 (from 3) {Frame=Scant}
...
Modifier to EyeColor of -10 (from 90) {Complexion=Fair, Species=Human}
...
Modifier to StartingEquipment of +100 (from 80) {SocialClass=Serf}
