...
hm3:
  ...
  items:
    ...
    - { shortcode: stealth, type: skill, system: { masteryLevel: 66 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 555 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 52 } }
    - { model: skill-ridg }
    ...
    - { model: skill-embl, system: { masteryLevelBase: 27 } }
    ...
    - { model: miscgear-pence, system: { quantity: 555 } }
...
Modifier to HairColor of -25 (from 31) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 2) {Complexion=Dark, Species=Human}
...
Modifier to StartingEquipment of +200 (from 70) {SocialClass=Unguilded}
