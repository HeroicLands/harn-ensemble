...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Karuia), system: { masteryLevel: 33 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevel: 103 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Zerin), system: { masteryLevelBase: 103 } }
    ...
    - { model: miscgear-pence, system: { quantity: 180 } }
