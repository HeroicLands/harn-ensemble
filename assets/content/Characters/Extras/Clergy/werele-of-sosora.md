...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 56 } }
    ...
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevel: 81 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 286 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Zerin), system: { masteryLevelBase: 81 } }
    ...
    - { model: miscgear-pence, system: { quantity: 286 } }
    - { model: containergear-pouchbuckram }
    - { model: armorgear-SgLeg }
    - { model: armorgear-SlkRobe }
...
Modifier to StartingEquipment of +200 (from 92) {SocialClass=Unguilded}
