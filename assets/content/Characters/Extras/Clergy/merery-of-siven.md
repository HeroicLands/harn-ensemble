...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 243 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-runecft, system: { masteryLevelBase: 65 } }
    - { model: skill-smsh, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 243 } }
...
Modifier to HairColor of +25 (from 7) {Complexion=Fair, Species=Human}
