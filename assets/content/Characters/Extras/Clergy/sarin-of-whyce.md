...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivashi), system: { masteryLevel: 45 } }
    - shortcode: language
      type: skill
      name: Language(Old Jarinese)
      system:
        masteryLevel: 90
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 65 } }
    - { shortcode: mentalconflict, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: oratory, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: singing, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: script, type: skill, name: Script(Khruni), system: { masteryLevel: 94 } }
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 80 } }
...
Modifier to AttributesAGL of +2 (from 8) {Frame=Scant}
...
Modifier to EyeColor of -10 (from 78) {Complexion=Fair, Species=Human}
...
Modifier to StartingEquipment of +100 (from 84) {SocialClass=Serf}
