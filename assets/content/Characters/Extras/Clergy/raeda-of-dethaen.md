...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 90 } }
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 30 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 682 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 90 } }
    - { model: skill-dscr }
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 30 } }
    - { model: miscgear-pence, system: { quantity: 682 } }
...
Modifier to StartingEquipment of +100 (from 4) {SocialClass=Serf}
