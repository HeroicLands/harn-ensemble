...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevel: 80 } }
    ...
    - { shortcode: siem, type: skill, system: { masteryLevel: 84 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 456 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 80 } }
    - { model: mysticalability-astr, system: { masteryLevelBase: 52 } }
    - { model: skill-embl, system: { masteryLevelBase: 30 } }
    - { model: skill-hrld, system: { masteryLevelBase: 18 } }
    ...
    - { model: miscgear-pence, system: { quantity: 456 } }
...
Modifier to AttributesAGL of -1 (from 14) {Frame=Heavy}
