...
hm3:
  ...
  items:
    ...
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 55 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jump, system: { masteryLevelBase: 90 } }
    - { model: skill-melee }
    - { model: skill-dge }
...
**Age**: 34
**Birthday**: 6 Agrazhar 686
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 2nd child of 11
**Siblings**: FMfFfMMFMFF
**Parentage**: Fostered
...
Modifier to HairColor of +25 (from 15) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 19) {Complexion=Fair, Species=Human}
