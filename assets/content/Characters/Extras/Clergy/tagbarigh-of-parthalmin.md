...
sohl:
  ...
  items:
    ...
    - { shortcode: lang, type: skill, name: "Language, Noble", system: { masteryLevelBase: 83 } }
    - { shortcode: script, type: skill, name: Script(Nuvesarl), system: { masteryLevelBase: 81 } }
