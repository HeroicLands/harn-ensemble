...
hm3:
  ...
  items:
    ...
    - { shortcode: shield, type: skill, system: { masteryLevel: 32 } }
...
Modifier to HairColor of -25 (from 75) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 11) {Complexion=Dark, Species=Human}
