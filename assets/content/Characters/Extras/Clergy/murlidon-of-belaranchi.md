...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Karuia), system: { masteryLevel: 105 } }
    - shortcode: language
      type: skill
    ...
    - shortcode: language
      ...
      system:
        ...
        masteryLevel: 80
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: halea, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1386 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 39 } }
    - { model: miscgear-pence, system: { quantity: 1386 } }
