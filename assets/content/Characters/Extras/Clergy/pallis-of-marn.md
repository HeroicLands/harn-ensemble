...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 20 } }
    ...
    - { shortcode: language, type: skill, name: Language(Karuia), system: { masteryLevel: 48 } }
    - shortcode: language
      type: skill
    ...
    - shortcode: language
      ...
      system:
        masteryLevel: 62
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 49 } }
    ...
    - { shortcode: embalming, type: skill, system: { masteryLevel: 14 } }
    ...
    - { shortcode: halea, type: skill, system: { masteryLevel: 50 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 299 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-embl, system: { masteryLevelBase: 14 } }
    - { model: skill-hrld, system: { masteryLevelBase: 14 } }
    ...
    - { model: miscgear-pence, system: { quantity: 299 } }
...
Modifier to StartingEquipment of +200 (from 40) {SocialClass=Unguilded}
