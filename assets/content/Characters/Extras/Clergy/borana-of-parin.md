...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 45 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 208 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-agri, system: { masteryLevelBase: 52 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 45 } }
    ...
    - { model: miscgear-pence, system: { quantity: 208 } }
...
Modifier to HairColor of +25 (from 81) {Complexion=Fair, Species=Human}
