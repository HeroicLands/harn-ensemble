...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 446 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-musc, system: { masteryLevelBase: 26 } }
    ...
    - { model: miscgear-pence, system: { quantity: 446 } }
...
Modifier to StartingEquipment of +100 (from 37) {SocialClass=Serf}
