  ...
  items:
    ...
    - shortcode: script
      ...
      system:
        ...
        masteryLevel: 94
    - { shortcode: axe, type: skill, name: Sickle (Axe), system: { masteryLevel: 90 } }
    ...
    - { shortcode: agrik, type: skill, system: { masteryLevel: 80 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 231 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 231 } }
