...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, system: { masteryLevel: 44 } }
    ...
    - { shortcode: laranitruesight, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 1720 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1720 } }
