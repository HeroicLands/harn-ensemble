...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 44 } }
    ...
    - { shortcode: script, type: skill, name: Script(Neramic), system: { masteryLevel: 82 } }
    ...
    - { shortcode: naveh, type: skill, system: { masteryLevel: 84 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 867 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Neramic), system: { masteryLevelBase: 82 } }
    ...
    - { model: miscgear-pence, system: { quantity: 867 } }
