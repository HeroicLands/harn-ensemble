...
hm3:
  ...
  items:
    ...
    - { shortcode: halea, type: skill, system: { masteryLevel: 52 } }
...
Modifier to HairColor of -25 (from 59) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 73) {Complexion=Dark, Species=Human}
