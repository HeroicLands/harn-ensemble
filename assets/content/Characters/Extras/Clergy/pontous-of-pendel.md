...
sohl:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevelBase: 79 } }
    - { shortcode: astr, type: mysticalability, system: { masteryLevelBase: 48 } }
    - { shortcode: embl, type: skill, system: { masteryLevelBase: 16 } }
    - { shortcode: hrld, type: skill, system: { masteryLevelBase: 21 } }
    - { shortcode: herb, type: skill, system: { masteryLevelBase: 18 } }
