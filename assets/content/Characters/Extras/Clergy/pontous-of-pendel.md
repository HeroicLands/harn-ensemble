...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: oratory, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: singing, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: script, type: skill, name: Script(Lakaise), system: { masteryLevel: 79 } }
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevel: 79 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: astrology, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 28 } }
    ...
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 21 } }
    ...
    - { shortcode: siem, type: skill, system: { masteryLevel: 98 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 28 } }
    - { model: skill-folklr, system: { masteryLevelBase: 42 } }
    - { model: skill-guil }
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 86 } }
    - { model: skill-musc, system: { masteryLevelBase: 45 } }
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 79 } }
    - { model: mysticalability-astr, system: { masteryLevelBase: 48 } }
    - { model: skill-embl, system: { masteryLevelBase: 16 } }
    - { model: skill-hrld, system: { masteryLevelBase: 21 } }
    ...
    - { model: miscgear-pence, system: { quantity: 503 } }
...
Modifier to EyeColor of -10 (from 55) {Complexion=Fair, Species=Human}

Left-Handed mod to Dexterity: +1

133lbs weight resulted in -1 strength mod.

Modifier to StartingEquipment of +100 (from 73) {SocialClass=Serf}
