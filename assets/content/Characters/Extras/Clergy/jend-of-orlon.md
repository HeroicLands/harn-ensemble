...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 75 } }
    ...
    - shortcode: language
      ...
      system:
        masteryLevel: 63
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: halea, type: skill, system: { masteryLevel: 70 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 75 } }
    - { model: skill-dscr }
