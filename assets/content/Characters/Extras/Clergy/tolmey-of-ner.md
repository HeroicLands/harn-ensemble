...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 90 } }
    ...
    - { shortcode: physician, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: naveh, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: talonsofgekrish, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 1073 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 36 } }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 55 } }
    - { model: skill-ridg }
    ...
    - { model: skill-acro, system: { masteryLevelBase: 33 } }
    - { model: skill-lgdm, system: { masteryLevelBase: 22 } }
    ...
    - { model: skill-lock, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 1073 } }
...
Modifier to HairColor of -25 (from 79) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 74) {Complexion=Dark, Species=Human}
