...
hm3:
  ...
  items:
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 54 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lgdm, system: { masteryLevelBase: 54 } }
...
Modifier to EyeColor of -25 (from 40) {Complexion=Pale, Species=Human}
