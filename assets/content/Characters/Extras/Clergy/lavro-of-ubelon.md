...
sohl:
  ...
  items:
    ...
    - { shortcode: pysn, type: skill, system: { masteryLevelBase: 91 } }
    ...
    - { shortcode: lang, type: skill, name: "Language, Guilded", system: { masteryLevelBase: 86 } }
    ...
    - { shortcode: necklacesilver, type: miscgear }
