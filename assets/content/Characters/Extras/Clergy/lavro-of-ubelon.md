...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Emela), system: { masteryLevel: 65 } }
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 86 } }
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: peoni, type: skill, system: { masteryLevel: 80 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 430 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 91 } }
    - { model: skill-ridg }
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 86 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 83 } }
    - { model: skill-agri, system: { masteryLevelBase: 60 } }
    ...
    - { model: skill-herb, system: { masteryLevelBase: 56 } }
    - { model: skill-law, system: { masteryLevelBase: 39 } }
    - { model: skill-txtl, system: { masteryLevelBase: 30 } }
    - { model: miscgear-pence, system: { quantity: 430 } }
...
Modifier to HairColor of -25 (from 27) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 27) {Complexion=Dark, Species=Human}

157lbs weight resulted in +1 strength mod.

Modifier to StartingEquipment of +300 (from 53) {SocialClass=Guilded}
