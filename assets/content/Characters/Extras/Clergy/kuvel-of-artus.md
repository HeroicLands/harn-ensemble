...
hm3:
  ...
  items:
    ...
    - { shortcode: mentalconflict, type: skill, system: { masteryLevel: 77 } }
    ...
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevel: 106 } }
    - { shortcode: axe, type: skill, name: Sickle (Axe), system: { masteryLevel: 65 } }
    ...
    - { shortcode: agrik, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1090 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Zerin), system: { masteryLevelBase: 106 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1090 } }
