...
hm3:
  ...
  items:
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: peoni, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: peonicommand, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 202 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 22 } }
    - { model: miscgear-pence, system: { quantity: 202 } }
