...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Azeryani), system: { masteryLevel: 105 } }
    - { shortcode: language, type: skill, name: Language(Surikal), system: { masteryLevel: 75 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1538 } }
...
Modifier to HairColor of -25 (from 91) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 99) {Complexion=Dark, Species=Human}
