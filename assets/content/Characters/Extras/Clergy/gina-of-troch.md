...
hm3:
  ...
  items:
    ...
    - { shortcode: siem, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: sweldrescloak, type: invocation }
    - { shortcode: siemdivination, type: invocation }
    - { shortcode: siemcurse, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 708 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-musc, system: { masteryLevelBase: 28 } }
    ...
    - { model: miscgear-pence, system: { quantity: 708 } }
