...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevel: 81 } }
    - { shortcode: axe, type: skill, system: { masteryLevel: 80 } }
    ...
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: law, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 27 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 313 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Runic), system: { masteryLevelBase: 81 } }
    ...
    - { model: mysticalability-runecft, system: { masteryLevelBase: 27 } }
    - { model: skill-smsh, system: { masteryLevelBase: 52 } }
    - { model: miscgear-pence, system: { quantity: 313 } }
...
Modifier to HairColor of -25 (from 41) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 24) {Complexion=Dark, Species=Human}
