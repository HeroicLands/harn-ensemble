...
hm3:
  ...
  items:
    ...
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 302 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 302 } }
...
Modifier to EyeColor of -25 (from 86) {Complexion=Pale, Species=Human}
