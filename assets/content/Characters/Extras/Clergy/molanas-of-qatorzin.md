...
hm3:
  ...
  items:
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 36 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 417 } }
