...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ormauk), system: { masteryLevel: 42 } }
    ...
    - { shortcode: woodcraft, type: skill, name: Masks (Woodcraft), system: { masteryLevel: 32 } }
