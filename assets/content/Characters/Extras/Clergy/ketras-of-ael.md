...
sohl:
  ...
  items:
    ...
    - { shortcode: clmb, type: skill, system: { masteryLevelBase: 96 } }
    ...
    - { shortcode: acro, type: skill, system: { masteryLevelBase: 42 } }
    - { shortcode: lgdm, type: skill, system: { masteryLevelBase: 32 } }
