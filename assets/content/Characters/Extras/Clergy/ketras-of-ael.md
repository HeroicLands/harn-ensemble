...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: climbing, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: condition, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: jumping, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 32 } }
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 98 } }
    ...
    - { shortcode: dagger, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 30 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 737 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 96 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce }
    - { model: skill-dscr }
    ...
    - { model: skill-acro, system: { masteryLevelBase: 42 } }
    - { model: skill-lgdm, system: { masteryLevelBase: 32 } }
    ...
    - { model: skill-lock, system: { masteryLevelBase: 30 } }
    - { model: miscgear-pence, system: { quantity: 737 } }
...
Modifier to EyeColor of +25 (from 85) {Complexion=Dark, Species=Human}
