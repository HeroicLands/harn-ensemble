...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Khruni), system: { masteryLevel: 86 } }
    - { shortcode: script, type: skill, name: Script(Lakaise), system: { masteryLevel: 86 } }
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 51 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: law, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 102 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 140 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 102 } }
    - { model: skill-ridg }
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 64
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 86 } }
    - { model: skill-agri, system: { masteryLevelBase: 60 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 52 } }
    - { model: skill-embl, system: { masteryLevelBase: 45 } }
    - { model: skill-hrld, system: { masteryLevelBase: 64 } }
    ...
    - { model: miscgear-pence, system: { quantity: 140 } }
