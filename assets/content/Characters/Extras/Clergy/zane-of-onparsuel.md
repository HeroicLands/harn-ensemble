...
sohl:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevelBase: 81 } }
    - { shortcode: embl, type: skill, system: { masteryLevelBase: 48 } }
    - { shortcode: hrld, type: skill, system: { masteryLevelBase: 16 } }
    - { shortcode: law, type: skill, system: { masteryLevelBase: 22 } }
    - { shortcode: runecft, type: mysticalability, system: { masteryLevelBase: 36 } }
    - { shortcode: smsh, type: skill, system: { masteryLevelBase: 34 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 186 } }
