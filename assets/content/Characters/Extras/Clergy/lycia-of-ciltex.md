...
Modifier to HairColor of -25 (from 61) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 32) {Complexion=Dark, Species=Human}

Modifier to StartingEquipment of +200 (from 30) {SocialClass=Unguilded}
