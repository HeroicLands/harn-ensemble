...
sohl:
  ...
  items:
    ...
    - { shortcode: pysn, type: skill, system: { masteryLevelBase: 105 } }
    ...
    - { shortcode: agri, type: skill, system: { masteryLevelBase: 35 } }
    - { shortcode: anmcft, type: skill, system: { masteryLevelBase: 27 } }
