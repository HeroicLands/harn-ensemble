...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 35 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 27 } }
    ...
    - { shortcode: physician, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: peoni, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: peonisaid, type: invocation }
    - { shortcode: peonismercy, type: invocation }
    - { shortcode: peonicurse, type: invocation }
    - { shortcode: peonirevelation, type: invocation }
    - { shortcode: sustenanceofmaermal, type: invocation }
    - { shortcode: peonisummoning, type: invocation }
    - { shortcode: tirralasrenewal, type: invocation }
    - { shortcode: descentfromvalon, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 240 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 105 } }
    - { model: skill-ridg }
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 85 } }
    - { model: skill-agri, system: { masteryLevelBase: 35 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 27 } }
    - { model: skill-embl, system: { masteryLevelBase: 42 } }
    ...
    - { model: miscgear-pence, system: { quantity: 240 } }
...
Modifier to HairColor of +25 (from 35) {Complexion=Fair, Species=Human}
