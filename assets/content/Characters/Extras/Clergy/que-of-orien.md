...
hm3:
  ...
  items:
    ...
    - { shortcode: woodcraft, type: skill, name: Masks (Woodcraft), system: { masteryLevel: 24 } }
...
Modifier to StartingEquipment of +300 (from 19) {SocialClass=Guilded}
