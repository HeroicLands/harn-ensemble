...
hm3:
  ...
  items:
    ...
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 33 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 160 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-runecft, system: { masteryLevelBase: 33 } }
    - { model: skill-smsh, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 160 } }
