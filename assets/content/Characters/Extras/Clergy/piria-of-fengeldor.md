...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevel: 100 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 435 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Runic), system: { masteryLevelBase: 100 } }
    ...
    - { model: mysticalability-runecft, system: { masteryLevelBase: 36 } }
    - { model: skill-smsh, system: { masteryLevelBase: 30 } }
    - { model: miscgear-pence, system: { quantity: 435 } }
...
Modifier to HairColor of -25 (from 99) {Complexion=Dark, Species=Human}
