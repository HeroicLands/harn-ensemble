...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-attribute-dex, system: { scoreBase: 3 } }
    ...
    - { model: sohl-sohl-skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 84 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 833 } }
