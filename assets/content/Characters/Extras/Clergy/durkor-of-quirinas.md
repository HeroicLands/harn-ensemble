...
hm3:
  ...
  items:
    ...
    - shortcode: language
      ...
      system:
        masteryLevel: 84
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 84 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 833 } }
...
sohl:
  ...
  items:
    ...
    - { model: attribute-dex, system: { scoreBase: 3 } }
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 84 } }
    ...
    - { model: miscgear-pence, system: { quantity: 833 } }
...
Modifier to HairColor of -25 (from 15) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 3) {Complexion=Dark, Species=Human}

133lbs weight resulted in -1 strength mod.

Modifier to StartingEquipment of +300 (from 36) {SocialClass=Guilded}
