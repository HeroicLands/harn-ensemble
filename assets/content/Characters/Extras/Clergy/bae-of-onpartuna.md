...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 78 } }
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevel: 83 } }
    - { shortcode: axe, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: sarajincommand, type: invocation }
    - { shortcode: fakangsedge, type: invocation }
    - { shortcode: sarajinconsecration, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 657 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-runecft, system: { masteryLevelBase: 78 } }
    - { model: skill-smsh, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 657 } }
...
Modifier to EyeColor of +25 (from 17) {Complexion=Dark, Species=Human}
