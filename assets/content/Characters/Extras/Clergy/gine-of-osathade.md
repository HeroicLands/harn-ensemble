...
hm3:
  ...
  items:
    ...
    - { shortcode: throwing, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 119 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 119 } }
...
Modifier to EyeColor of +15 (from 18) {Complexion=Swarthy, Species=Human}

246lbs weight resulted in +5 strength mod.
