...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-script, name: Script(Zerin), system: { masteryLevelBase: 92 } }
    ...
    - { model: sohl-sohl-skill-pfmy, system: { masteryLevelBase: 24 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 887 } }
