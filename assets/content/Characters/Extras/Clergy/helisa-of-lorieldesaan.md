...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 32 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 98 } }
    - { model: skill-ridg }
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 39 } }
...
Modifier to HairColor of +25 (from 31) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 89) {Complexion=Fair, Species=Human}
