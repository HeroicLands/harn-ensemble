...
hm3:
  ...
  items:
    ...
    - { shortcode: siem, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 110 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 110 } }
...
Modifier to EyeColor of +15 (from 8) {Complexion=Swarthy, Species=Human}

126lbs weight resulted in -2 strength mod.

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +100 (from 68) {SocialClass=Serf}
