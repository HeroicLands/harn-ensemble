...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 463 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 463 } }
...
Modifier to EyeColor of +15 (from 97) {Complexion=Swarthy, Species=Human}

157lbs weight resulted in +1 strength mod.

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +100 (from 24) {SocialClass=Serf}
