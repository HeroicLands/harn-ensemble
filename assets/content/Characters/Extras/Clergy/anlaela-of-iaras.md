...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 42 } }
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevel: 96 } }
    ...
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 541 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 64
    - { model: skill-musc, system: { masteryLevelBase: 42 } }
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 96 } }
    ...
    - { model: mysticalability-runecft, system: { masteryLevelBase: 75 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 541 } }
...
Modifier to EyeColor of +15 (from 65) {Complexion=Swarthy, Species=Human}
