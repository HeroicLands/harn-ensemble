...
hm3:
  ...
  items:
    ...
    - { shortcode: oratory, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: ilvirconsecration, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 561 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-tarot, system: { masteryLevelBase: 56 } }
    - { model: miscgear-pence, system: { quantity: 561 } }
