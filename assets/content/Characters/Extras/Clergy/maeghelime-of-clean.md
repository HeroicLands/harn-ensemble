...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Khuzdul), system: { masteryLevel: 60 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 484 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 484 } }
