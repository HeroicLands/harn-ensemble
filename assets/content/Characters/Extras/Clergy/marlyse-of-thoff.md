...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 80 } }
    - shortcode: language
      type: skill
      name: Language, Serf
      system:
    ...
    - shortcode: script
      ...
      system:
        ...
        masteryLevel: 81
    - { shortcode: dagger, type: skill, system: { masteryLevel: 35 } }
    ...
    - { shortcode: naveh, type: skill, system: { masteryLevel: 112 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 939 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 35 } }
    - { model: skill-dge }
    ...
    - { model: skill-script, name: Script(Neramic), system: { masteryLevelBase: 81 } }
    ...
    - { model: miscgear-pence, system: { quantity: 939 } }
