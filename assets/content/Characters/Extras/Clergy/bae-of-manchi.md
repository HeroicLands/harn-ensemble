...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Azeryani), system: { masteryLevel: 33 } }
    - { shortcode: language, type: skill, name: Language(Surikal), system: { masteryLevel: 33 } }
    - shortcode: language
      type: skill
...
140lbs weight resulted in -1 strength mod.
