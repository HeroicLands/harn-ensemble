...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-script, name: Script(Runic), system: { masteryLevelBase: 90 } }
    ...
    - { model: sohl-sohl-mysticalability-runecft, system: { masteryLevelBase: 30 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 20 } }
