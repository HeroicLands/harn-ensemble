...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 90 } }
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevel: 90 } }
    - { shortcode: axe, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 24 } }
    ...
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 105 } }
...
sohl:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevelBase: 90 } }
    ...
    - { shortcode: runecft, type: mysticalability, system: { masteryLevelBase: 30 } }
    - { shortcode: smsh, type: skill, system: { masteryLevelBase: 20 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 555 } }
...
**Age**: 33
**Birthday**: 25 Azura 687
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 2nd child of 11
**Siblings**: FMmfmMmMFMf
**Parentage**: Offspring
