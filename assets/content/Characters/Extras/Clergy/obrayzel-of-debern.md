...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 27 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-acro, system: { masteryLevelBase: 27 } }
...
**Age**: 24
**Birthday**: 14 Kelen 696
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 4th child of 11
**Siblings**: MMfMFMMFMmm
**Parentage**: Offspring
...
Modifier to EyeColor of +25 (from 77) {Complexion=Dark, Species=Human}

Leprosy mod to Comeliness: -9
