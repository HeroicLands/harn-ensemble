...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivashi), system: { masteryLevel: 36 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: script, type: skill, name: Script(Khruni), system: { masteryLevel: 84 } }
    - shortcode: script
      type: skill
      name: Script(Lakaise)
      system:
        ...
        masteryLevel: 84
    - { shortcode: initiative, type: skill, system: { masteryLevel: 24 } }
    ...
    - shortcode: animalcraft
      ...
      system:
        masteryLevel: 60
    - { shortcode: drawing, type: skill, system: { masteryLevel: 64 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 64 } }
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 62
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 84 } }
    - model: skill-anmcft
      name: Ivashu (Animalcraft)
      system:
        masteryLevelBase: 60
...
Modifier to HairColor of -25 (from 88) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 36) {Complexion=Dark, Species=Human}

127lbs weight resulted in -2 strength mod.

Modifier to StartingEquipment of +200 (from 59) {SocialClass=Unguilded}
