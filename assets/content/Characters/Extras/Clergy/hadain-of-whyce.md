...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 102 } }
    ...
    - { shortcode: siem, type: skill, system: { masteryLevel: 70 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 571 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 102 } }
    - { model: skill-musc, system: { masteryLevelBase: 30 } }
    ...
    - { model: mysticalability-tarot, system: { masteryLevelBase: 32 } }
    - { model: miscgear-pence, system: { quantity: 571 } }
...
Modifier to EyeColor of +15 (from 39) {Complexion=Swarthy, Species=Human}
