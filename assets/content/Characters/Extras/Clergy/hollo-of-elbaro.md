  ...
  items:
    ...
    - shortcode: language
      ...
      system:
        ...
        masteryLevel: 64
    - { shortcode: mentalconflict, type: skill, system: { masteryLevel: 90 } }
    ...
    - { shortcode: sword, type: skill, system: { masteryLevel: 36 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 226 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 226 } }
...
Modifier to EyeColor of +15 (from 20) {Complexion=Swarthy, Species=Human}
