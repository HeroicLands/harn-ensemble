...
hm3:
  ...
  items:
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 44 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 301 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-law, system: { masteryLevelBase: 44 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 22 } }
    - { model: miscgear-pence, system: { quantity: 301 } }
...
Modifier to EyeColor of -25 (from 15) {Complexion=Pale, Species=Human}
