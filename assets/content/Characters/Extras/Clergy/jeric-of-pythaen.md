...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Neramic), system: { masteryLevel: 90 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 723 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Neramic), system: { masteryLevelBase: 90 } }
    ...
    - { model: miscgear-pence, system: { quantity: 723 } }
...
Modifier to StartingEquipment of +100 (from 22) {SocialClass=Serf}
