...
hm3:
  ...
  items:
    ...
    - { shortcode: siem, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 626 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 626 } }
...
Modifier to AttributesAGL of -2 (from 15) {Frame=Massive}

Modifier to EyeColor of +15 (from 55) {Complexion=Swarthy, Species=Human}

174lbs weight resulted in +2 strength mod.
