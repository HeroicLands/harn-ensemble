...
hm3:
  ...
  items:
    ...
    - { shortcode: peoni, type: skill, system: { masteryLevel: 112 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 114 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 114 } }
...
Modifier to HairColor of -25 (from 33) {Complexion=Dark, Species=Human}
