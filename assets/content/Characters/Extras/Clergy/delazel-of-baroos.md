...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Sindarin), system: { masteryLevel: 39 } }
    - shortcode: language
      type: skill
      name: Language, Serf
      system:
    ...
    - { shortcode: astrology, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 84 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-folklr, system: { masteryLevelBase: 64 } }
    - { model: skill-guil }
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 63 } }
    - { model: skill-musc, system: { masteryLevelBase: 22 } }
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 83 } }
    - { model: mysticalability-astr, system: { masteryLevelBase: 75 } }
    ...
    - { model: miscgear-pence, system: { quantity: 246 } }
...
Modifier to HairColor of -25 (from 21) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 4) {Complexion=Dark, Species=Human}

Scars mod to Comeliness: -2
...
Modifier to StartingEquipment of +100 (from 61) {SocialClass=Serf}
