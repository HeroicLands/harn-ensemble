...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ormauk), system: { masteryLevel: 45 } }
    ...
    - { shortcode: script, type: skill, name: Script(Nuvesarl), system: { masteryLevel: 85 } }
    ...
    - { shortcode: physician, type: skill, system: { masteryLevel: 34 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: woodcraft, type: skill, name: Masks (Woodcraft), system: { masteryLevel: 30 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Nuvesarl), system: { masteryLevelBase: 85 } }
