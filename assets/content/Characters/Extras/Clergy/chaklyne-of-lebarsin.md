...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-folklr, system: { masteryLevelBase: 96 } }
    ...
    - model: sohl-sohl-skill-lang
      ...
      system:
        masteryLevelBase: 63
    - { model: sohl-sohl-skill-musc, system: { masteryLevelBase: 33 } }
    ...
    - { model: sohl-sohl-mysticalability-runecft, system: { masteryLevelBase: 48 } }
    - { model: sohl-sohl-mysticalability-tarot, system: { masteryLevelBase: 28 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 691 } }
