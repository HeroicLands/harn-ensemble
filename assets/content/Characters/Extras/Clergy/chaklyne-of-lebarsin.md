...
hm3:
  ...
  items:
    ...
    - { shortcode: awareness, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: language, type: skill, name: Language(Sindarin), system: { masteryLevel: 78 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 33 } }
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: siem, type: skill, system: { masteryLevel: 112 } }
    ...
    - { shortcode: elmithrisshower, type: invocation }
    - { shortcode: siemrevelation, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 691 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-folklr, system: { masteryLevelBase: 96 } }
    - { model: skill-guil }
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 63
    - { model: skill-musc, system: { masteryLevelBase: 33 } }
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 109 } }
    - { model: mysticalability-astr, system: { masteryLevelBase: 52 } }
    - { model: skill-embl, system: { masteryLevelBase: 22 } }
    - { model: skill-hrld, system: { masteryLevelBase: 22 } }
    - { model: skill-herb, system: { masteryLevelBase: 24 } }
    - { model: skill-law, system: { masteryLevelBase: 52 } }
    - { model: mysticalability-runecft, system: { masteryLevelBase: 48 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 691 } }
    - { model: containergear-pouchbuckram }
    - { model: armorgear-SgLeg }
    - { model: armorgear-LtShoe }
    - { model: armorgear-SgTunic }
    - { model: weapongear-Kni }
    - { name: Unknown/broken Earthmaster item, type: miscgear, system: { value: 0, weight: 1 } }
    - { model: miscgear-holysymbrass }
...
Modifier to StartingEquipment of +200 (from 37) {SocialClass=Unguilded}
