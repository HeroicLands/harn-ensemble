...
sohl:
  ...
  items:
    ...
    - { shortcode: folklr, type: skill, system: { masteryLevelBase: 96 } }
    ...
    - shortcode: lang
      ...
      system:
        masteryLevelBase: 63
    - { shortcode: musc, type: skill, system: { masteryLevelBase: 33 } }
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevelBase: 109 } }
    ...
    - { shortcode: law, type: skill, system: { masteryLevelBase: 52 } }
    - { shortcode: runecft, type: mysticalability, system: { masteryLevelBase: 48 } }
