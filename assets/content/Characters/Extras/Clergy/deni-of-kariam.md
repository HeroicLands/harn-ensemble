...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Khruni), system: { masteryLevel: 81 } }
    ...
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 542 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 542 } }
...
Modifier to EyeColor of +15 (from 19) {Complexion=Swarthy, Species=Human}

165lbs weight resulted in +1 strength mod.

Modifier to StartingEquipment of +200 (from 66) {SocialClass=Unguilded}
