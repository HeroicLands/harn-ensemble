...
hm3:
  ...
  items:
    ...
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: language, type: skill, name: Language(Ivashi), system: { masteryLevel: 42 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 65 } }
    ...
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 105 } }
...
sohl:
  ...
  items:
    ...
    - { model: attribute-cml, system: { scoreBase: 3 } }
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 96 } }
    - model: skill-anmcft
      name: Ivashu (Animalcraft)
      system:
        masteryLevelBase: 78
    - { model: skill-embl, system: { masteryLevelBase: 26 } }
    - { model: skill-hrld, system: { masteryLevelBase: 65 } }
    - { model: skill-herb, system: { masteryLevelBase: 48 } }
    - { model: skill-law, system: { masteryLevelBase: 28 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 70 } }
...
Modifier to HairColor of +25 (from 10) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 73) {Complexion=Fair, Species=Human}

Leprosy mod to Comeliness: -10
