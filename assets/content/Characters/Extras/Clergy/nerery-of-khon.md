...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 431 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 431 } }
...
Modifier to HairColor of +25 (from 53) {Complexion=Fair, Species=Human}
