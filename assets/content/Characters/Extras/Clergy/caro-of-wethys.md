...
hm3:
  ...
  items:
    ...
    - { shortcode: naveh, type: skill, system: { masteryLevel: 60 } }
...
sohl:
  ...
  items:
    ...
    - { shortcode: lgdm, type: skill, system: { masteryLevelBase: 33 } }
...
Modifier to HairColor of +25 (from 57) {Complexion=Fair, Species=Human}
