...
hm3:
  ...
  items:
    ...
    - { shortcode: awareness, type: skill, system: { masteryLevel: 72 } }
    ...
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevel: 83 } }
    - { shortcode: axe, type: skill, name: Sickle (Axe), system: { masteryLevel: 36 } }
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 36 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 91 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 28 } }
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: agrik, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: crimsondance, type: invocation }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 780 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 780 } }
...
Modifier to HairColor of +25 (from 58) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 42) {Complexion=Fair, Species=Human}

Leprosy mod to Comeliness: -7
