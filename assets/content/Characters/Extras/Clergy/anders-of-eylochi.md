...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-script, name: Script(Selenian), system: { masteryLevelBase: 106 } }
    - { model: sohl-sohl-mysticalability-astr, system: { masteryLevelBase: 78 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 803 } }
