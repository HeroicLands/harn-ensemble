...
hm3:
  ...
  items:
    ...
    - { shortcode: astrology, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 60 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 803 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-astr, system: { masteryLevelBase: 78 } }
    ...
    - { model: mysticalability-tarot, system: { masteryLevelBase: 60 } }
    - { model: miscgear-pence, system: { quantity: 803 } }
