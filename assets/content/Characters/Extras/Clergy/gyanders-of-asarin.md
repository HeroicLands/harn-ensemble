...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 305 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 305 } }
...
Modifier to StartingEquipment of +100 (from 72) {SocialClass=Serf}
