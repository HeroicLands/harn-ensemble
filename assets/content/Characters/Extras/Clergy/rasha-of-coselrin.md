...
hm3:
  ...
  items:
    ...
    - { shortcode: physician, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 84 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 84 } }
    - { model: skill-ridg }
    ...
    - { model: miscgear-pence, system: { quantity: 84 } }
