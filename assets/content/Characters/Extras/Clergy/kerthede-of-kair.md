...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 500 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 500 } }
...
Modifier to HairColor of -25 (from 4) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 47) {Complexion=Dark, Species=Human}
