...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Emela), system: { masteryLevel: 72 } }
    - shortcode: language
      type: skill
      name: Language, Serf
      system:
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: peoni, type: skill, system: { masteryLevel: 91 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 126 } }
...
Modifier to AttributesAUR of +2 (from 5) {Sex=Female, Species=Human}
