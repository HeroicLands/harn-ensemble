...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Sindarin), system: { masteryLevel: 56 } }
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 78 } }
    - { shortcode: mentalconflict, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: musician, type: skill, system: { masteryLevel: 12 } }
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevel: 81 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: astrology, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: wayfromtaurimaina, type: invocation }
    - { shortcode: yaelscalm, type: invocation }
    - { shortcode: thetwilightscribesquestion, type: invocation }
    - { shortcode: naturesaid, type: invocation }
    - { shortcode: counselofsweldre, type: invocation }
    - { shortcode: siemawe, type: invocation }
    - { shortcode: siemendure, type: invocation }
    - { shortcode: curseofsloth, type: invocation }
    - { shortcode: ilsiridance, type: invocation }
    - { shortcode: serenielsstone, type: invocation }
    - { shortcode: siemsblessing, type: invocation }
    - { shortcode: siemtongues, type: invocation }
    - { shortcode: wateroftheazurebowl, type: invocation }
    - { shortcode: siemtruthsense, type: invocation }
    - { shortcode: siemdivination, type: invocation }
    - { shortcode: siemcurse, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 861 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 28 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce }
    - { model: skill-dscr }
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 44 } }
    - { model: skill-ridg }
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 32 } }
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 78 } }
    - { model: skill-musc, system: { masteryLevelBase: 12 } }
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 81 } }
    - { model: mysticalability-astr, system: { masteryLevelBase: 56 } }
    - { model: skill-embl, system: { masteryLevelBase: 30 } }
    - { model: skill-hrld, system: { masteryLevelBase: 30 } }
    - { model: skill-herb, system: { masteryLevelBase: 52 } }
    - { model: skill-law, system: { masteryLevelBase: 28 } }
    - { model: mysticalability-runecft, system: { masteryLevelBase: 60 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 42 } }
    - { model: miscgear-pence, system: { quantity: 861 } }
    ...
    - name: Yael's Calm
      ...
      system:
        ...
        assocAffiliationCode: siem
        levelBase: 3
    - name: The Twilight Scribe's Question
      type: mysticalability
      system:
        subType: divineincantation
        assocSkillCode: siem
...
Modifier to HairColor of -25 (from 48) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 50) {Complexion=Dark, Species=Human}

Leprosy mod to Comeliness: -8

145lbs weight resulted in -1 strength mod.

Modifier to StartingEquipment of +100 (from 56) {SocialClass=Serf}
