...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 70 } }
    - { shortcode: language, type: skill, name: Language(Karuia), system: { masteryLevel: 56 } }
    - shortcode: language
      type: skill
      name: Language, Unguilded
      system:
        masteryLevel: 64
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: script, type: skill, name: Script(Script(Runic)), system: { masteryLevel: 79 } }
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevel: 88 } }
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 18 } }
    - { shortcode: halea, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1311 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 18 } }
    - { model: skill-ridg }
    ...
    - { model: skill-script, name: Script(Zerin), system: { masteryLevelBase: 88 } }
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 44 } }
    - { model: miscgear-pence, system: { quantity: 1311 } }
...
Modifier to EyeColor of +25 (from 43) {Complexion=Dark, Species=Human}

136lbs weight resulted in -1 strength mod.
