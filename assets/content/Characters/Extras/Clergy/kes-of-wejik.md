...
hm3:
  ...
  items:
    ...
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 447 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 447 } }
...
Modifier to StartingEquipment of +200 (from 72) {SocialClass=Unguilded}
