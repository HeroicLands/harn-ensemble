...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, system: { masteryLevel: 44 } }
    ...
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 566 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-runecft, system: { masteryLevelBase: 70 } }
    - { model: skill-smsh, system: { masteryLevelBase: 36 } }
    - { model: miscgear-pence, system: { quantity: 566 } }
