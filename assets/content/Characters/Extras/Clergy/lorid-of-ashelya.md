...
hm3:
  ...
  items:
    ...
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: language, type: skill, name: Language(Ivashi), system: { masteryLevel: 52 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: script, type: skill, name: Script(Khruni), system: { masteryLevel: 79 } }
    - shortcode: script
      type: skill
      name: Script(Lakaise)
      system:
    ...
    - shortcode: animalcraft
      ...
      system:
        masteryLevel: 90
    - { shortcode: drawing, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 16 } }
    ...
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: ibeniswithering, type: invocation }
    - { shortcode: communingwiththecycle, type: invocation }
    - { shortcode: vlastatears, type: invocation }
    - { shortcode: featofalbarra, type: invocation }
    - { shortcode: laborofchuchlean, type: invocation }
    - { shortcode: bellowoftheaklash, type: invocation }
    - { shortcode: ilvirawe, type: invocation }
    - { shortcode: ivashusong, type: invocation }
    - { shortcode: ilvirendure, type: invocation }
    - { shortcode: guiseofthebrooder, type: invocation }
    - { shortcode: ilvirtongues, type: invocation }
    - { shortcode: serpentoftheclaw, type: invocation }
    - { shortcode: succorofbakyn, type: invocation }
    - { shortcode: ilvirtruthsense, type: invocation }
    - { shortcode: ilvirschild, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 526 } }
...
sohl:
  ...
  items:
    ...
    - { model: attribute-cml, system: { scoreBase: 4 } }
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 89
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 79 } }
    - model: skill-anmcft
      name: Ivashu (Animalcraft)
      system:
        masteryLevelBase: 90
    - { model: skill-embl, system: { masteryLevelBase: 32 } }
    - { model: skill-hrld, system: { masteryLevelBase: 16 } }
...
Modifier to AttributesAGL of +2 (from 14) {Frame=Scant}

Modifier to HairColor of -25 (from 82) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 55) {Complexion=Dark, Species=Human}

Hirsutism mod to Comeliness: -1

128lbs weight resulted in -2 strength mod.

Scant frame resulted in +2 agility mod.

Modifier to StartingEquipment of +200 (from 62) {SocialClass=Unguilded}
