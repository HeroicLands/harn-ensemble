...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 166 } }
...
Modifier to EyeColor of +15 (from 25) {Complexion=Swarthy, Species=Human}

Modifier to StartingEquipment of +200 (from 18) {SocialClass=Unguilded}
