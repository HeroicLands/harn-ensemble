...
sohl:
  ...
  items:
    ...
    - { shortcode: folklr, type: skill, system: { masteryLevelBase: 91 } }
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevelBase: 94 } }
    ...
    - { shortcode: runecft, type: mysticalability, system: { masteryLevelBase: 39 } }
    - { shortcode: tarot, type: mysticalability, system: { masteryLevelBase: 22 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 588 } }
