...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 30 } }
    ...
    - { shortcode: language, type: skill, name: Language(Sindarin), system: { masteryLevel: 66 } }
    - shortcode: language
      type: skill
      name: Language, Unguilded
      system:
        masteryLevel: 61
    - { shortcode: mentalconflict, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: musician, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: oratory, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 66 } }
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevel: 94 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 35 } }
    - { shortcode: astrology, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 36 } }
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: siem, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 588 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 94 } }
    ...
    - { model: mysticalability-runecft, system: { masteryLevelBase: 39 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 22 } }
    - { model: miscgear-pence, system: { quantity: 588 } }
...
Modifier to StartingEquipment of +200 (from 91) {SocialClass=Unguilded}
