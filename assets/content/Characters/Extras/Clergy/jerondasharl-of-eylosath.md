...
hm3:
  ...
  items:
    ...
    - shortcode: language
      ...
      system:
        masteryLevel: 76
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 287 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 287 } }
...
Modifier to StartingEquipment of +200 (from 54) {SocialClass=Unguilded}
