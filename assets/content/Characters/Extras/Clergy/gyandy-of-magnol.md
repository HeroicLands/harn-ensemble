...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 65 } }
    ...
    - { shortcode: language, type: skill, name: Language(Karuia), system: { masteryLevel: 42 } }
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 18 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: halea, type: skill, system: { masteryLevel: 68 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 65 } }
    - { model: skill-dscr }
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 18 } }
    - { model: miscgear-pence, system: { quantity: 508 } }
...
Modifier to HairColor of +25 (from 66) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 45) {Complexion=Fair, Species=Human}
...
Modifier to StartingEquipment of +100 (from 47) {SocialClass=Serf}
