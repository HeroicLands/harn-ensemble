...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-clmb, system: { masteryLevelBase: 66 } }
    - { model: sohl-sohl-skill-cmd }
    - { model: sohl-sohl-skill-cook }
    - { model: sohl-sohl-skill-dnce, system: { masteryLevelBase: 65 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 508 } }
