...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 52 } }
    ...
    - { shortcode: language, type: skill, name: Language(Jarinese), system: { masteryLevel: 65 } }
    - { shortcode: language, type: skill, name: Language(Karuia), system: { masteryLevel: 91 } }
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 63 } }
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevel: 79 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 988 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Zerin), system: { masteryLevelBase: 79 } }
    ...
    - { model: miscgear-pence, system: { quantity: 988 } }
...
Modifier to EyeColor of +25 (from 13) {Complexion=Dark, Species=Human}
