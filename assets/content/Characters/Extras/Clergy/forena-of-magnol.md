...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Surikal), system: { masteryLevel: 45 } }
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 50 } }
    ...
    - { shortcode: agrik, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 715 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 715 } }
