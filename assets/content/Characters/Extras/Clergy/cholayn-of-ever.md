...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 27 } }
    ...
    - { shortcode: astrology, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: foraging, type: skill, system: { masteryLevel: 65 } }
    ...
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 54 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 339 } }
...
Modifier to StartingEquipment of +100 (from 6) {SocialClass=Serf}
