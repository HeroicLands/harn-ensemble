...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 33 } }
    ...
    - { shortcode: physician, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: peoni, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 204 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 78 } }
    - { model: skill-ridg }
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 26 } }
    - { model: miscgear-pence, system: { quantity: 204 } }
...
Modifier to EyeColor of -25 (from 43) {Complexion=Pale, Species=Human}
...
Modifier to StartingEquipment of +100 (from 94) {SocialClass=Serf}
