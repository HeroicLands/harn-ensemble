...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 39 } }
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 105 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 652 } }
...
sohl:
  ...
  items:
    ...
    - { shortcode: lock, type: skill, system: { masteryLevelBase: 22 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 652 } }
...
**Age**: 36
**Birthday**: 17 Savor 684
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: Eldest of 11
**Siblings**: FFfFfFmmFfF
