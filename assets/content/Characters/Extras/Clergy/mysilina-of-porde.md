...
hm3:
  ...
  items:
    ...
    - { shortcode: oratory, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 223 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 223 } }
...
Modifier to HairColor of -25 (from 12) {Complexion=Dark, Species=Human}
