...
hm3:
  ...
  items:
    ...
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 70 } }
...
Modifier to HairColor of +25 (from 28) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 62) {Complexion=Fair, Species=Human}
...
Modifier to StartingEquipment of +100 (from 79) {SocialClass=Serf}
