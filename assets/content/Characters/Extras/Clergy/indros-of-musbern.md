...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-script, name: Script(Neramic), system: { masteryLevelBase: 109 } }
    - { model: sohl-sohl-skill-embl, system: { masteryLevelBase: 48 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 696 } }
