...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Neramic), system: { masteryLevel: 109 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 696 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Neramic), system: { masteryLevelBase: 109 } }
    ...
    - { model: miscgear-pence, system: { quantity: 696 } }
...
Modifier to HairColor of +25 (from 56) {Complexion=Fair, Species=Human}
