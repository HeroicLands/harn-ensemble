...
hm3:
  ...
  items:
    ...
    - { shortcode: embalming, type: skill, system: { masteryLevel: 52 } }
    ...
    - { shortcode: njehusstir, type: invocation }
...
sohl:
  ...
  items:
    ...
    - { model: skill-embl, system: { masteryLevelBase: 52 } }
...
Modifier to HairColor of +25 (from 21) {Complexion=Fair, Species=Human}
...
Modifier to StartingEquipment of +200 (from 71) {SocialClass=Unguilded}
