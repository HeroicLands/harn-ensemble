...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevel: 98 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 362 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 98 } }
    ...
    - { model: miscgear-pence, system: { quantity: 362 } }
...
Modifier to StartingEquipment of +300 (from 89) {SocialClass=Guilded}
