...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Azeryani), system: { masteryLevel: 65 } }
    ...
    - { shortcode: axe, type: skill, name: Sickle (Axe), system: { masteryLevel: 66 } }
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 55 } }
    ...
    - { shortcode: agrik, type: skill, system: { masteryLevel: 104 } }
