...
hm3:
  ...
  items:
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 26 } }
    ...
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 34 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: siem, type: skill, system: { masteryLevel: 102 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 688 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-tarot, system: { masteryLevelBase: 34 } }
    - { model: miscgear-pence, system: { quantity: 688 } }
...
Modifier to StartingEquipment of +200 (from 95) {SocialClass=Unguilded}
