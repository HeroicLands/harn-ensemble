...
hm3:
  ...
  items:
    ...
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 10 } }
    ...
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 175 } }
...
sohl:
  ...
  items:
    ...
    - { model: attribute-wil, system: { scoreBase: 4 } }
    ...
    - { model: skill-hrld, system: { masteryLevelBase: 10 } }
    ...
    - { model: miscgear-pence, system: { quantity: 175 } }
...
Modifier to HairColor of +25 (from 65) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 74) {Complexion=Fair, Species=Human}
