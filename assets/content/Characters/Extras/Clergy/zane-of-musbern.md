...
hm3:
  ...
  items:
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: stealth, type: skill, system: { masteryLevel: 70 } }
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 45 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: script, type: skill, name: Script(Neramic), system: { masteryLevel: 83 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 52 } }
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: naveh, type: skill, system: { masteryLevel: 102 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 670 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lock, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 670 } }
...
Modifier to HairColor of -25 (from 11) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 20) {Complexion=Dark, Species=Human}

Deformed/Missing Arm mod to Dexterity: -1

171lbs weight resulted in +2 strength mod.
