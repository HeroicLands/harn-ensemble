...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 80 } }
    ...
    - { shortcode: siem, type: skill, system: { masteryLevel: 60 } }
...
sohl:
  ...
  items:
    ...
    - { name: Cone of Esoteric Insight, type: miscgear, system: { value: 0, weight: 1 } }
...
Modifier to EyeColor of -25 (from 59) {Complexion=Pale, Species=Human}
