...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, system: { masteryLevel: 68 } }
    ...
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 434 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 434 } }
...
**Age**: 38
**Birthday**: 18 Larane 682
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 6th child of 7
**Siblings**: fFMMMFf
**Parentage**: Offspring
