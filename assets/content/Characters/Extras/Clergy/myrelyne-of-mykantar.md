...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Azeryani), system: { masteryLevel: 84 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 460 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 460 } }
...
Modifier to EyeColor of +25 (from 67) {Complexion=Dark, Species=Human}
