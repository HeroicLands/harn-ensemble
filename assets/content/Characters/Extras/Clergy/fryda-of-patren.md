...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Sindarin), system: { masteryLevel: 52 } }
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: law, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 42 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 914 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 76 } }
    ...
    - { model: skill-herb, system: { masteryLevelBase: 22 } }
    - { model: skill-law, system: { masteryLevelBase: 26 } }
    - { model: mysticalability-runecft, system: { masteryLevelBase: 42 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 914 } }
...
Modifier to EyeColor of -25 (from 97) {Complexion=Pale, Species=Human}

Parastites cause special penalty to Rhetoric and Lovecraft until cured.

145lbs weight resulted in -1 strength mod.

Modifier to StartingEquipment of +100 (from 54) {SocialClass=Serf}
