...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-folklr, system: { masteryLevelBase: 91 } }
    ...
    - { model: sohl-sohl-mysticalability-runecft, system: { masteryLevelBase: 42 } }
    - { model: sohl-sohl-mysticalability-tarot, system: { masteryLevelBase: 28 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 914 } }
