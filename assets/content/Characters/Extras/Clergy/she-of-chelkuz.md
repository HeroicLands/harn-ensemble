...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 78 } }
    - { model: skill-dscr }
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 48 } }
...
Modifier to EyeColor of -10 (from 29) {Complexion=Fair, Species=Human}
...
Modifier to StartingEquipment of +300 (from 64) {SocialClass=Guilded}
