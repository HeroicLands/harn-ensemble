...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, system: { masteryLevel: 72 } }
    ...
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 90 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 663 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 663 } }
