...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevel: 82 } }
    - { shortcode: axe, type: skill, system: { masteryLevel: 112 } }
    ...
    - { shortcode: heraldry, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: law, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 84 } }
    ...
    - { shortcode: sarajintruthsense, type: invocation }
    - { shortcode: sarajindivination, type: invocation }
    - { shortcode: sarajincurse, type: invocation }
    - { shortcode: sarajinrevelation, type: invocation }
    - { shortcode: idjarsmantle, type: invocation }
    - { shortcode: sarajinsummoning, type: invocation }
    - { shortcode: talagaadshonor, type: invocation }
    - { shortcode: fakangsedge, type: invocation }
    - { shortcode: sarajintruesight, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 405 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-guil }
    - { model: skill-init, system: { masteryLevelBase: 63 } }
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 50 } }
    - { model: skill-jump, system: { masteryLevelBase: 70 } }
    - { model: skill-melee, system: { masteryLevelBase: 82 } }
    - { model: skill-dge }
    ...
    - { model: mysticalability-runecft, system: { masteryLevelBase: 44 } }
    - { model: skill-smsh, system: { masteryLevelBase: 26 } }
    - { model: miscgear-pence, system: { quantity: 405 } }
...
Modifier to HairColor of -25 (from 13) {Complexion=Dark, Species=Human}
