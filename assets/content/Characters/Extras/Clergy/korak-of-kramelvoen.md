...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-melee, system: { masteryLevelBase: 82 } }
    ...
    - { model: sohl-sohl-mysticalability-runecft, system: { masteryLevelBase: 44 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 26 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 405 } }
