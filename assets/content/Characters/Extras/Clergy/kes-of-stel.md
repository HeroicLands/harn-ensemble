...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Sindarin), system: { masteryLevel: 72 } }
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevel: 92 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 35 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: astrology, type: skill, system: { masteryLevel: 44 } }
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: law, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: siem, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 425 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-musc, system: { masteryLevelBase: 20 } }
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 92 } }
    - { model: mysticalability-astr, system: { masteryLevelBase: 44 } }
    - { model: skill-embl, system: { masteryLevelBase: 20 } }
    - { model: skill-hrld, system: { masteryLevelBase: 27 } }
    - { model: skill-herb, system: { masteryLevelBase: 20 } }
    - { model: skill-law, system: { masteryLevelBase: 24 } }
    - { model: mysticalability-runecft, system: { masteryLevelBase: 45 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 425 } }
    - { model: containergear-pouchbuckram }
    - { model: armorgear-LLeg }
    - { model: armorgear-CShoe }
    - { model: armorgear-LTunic }
    - { model: weapongear-Kni }
    - { model: miscgear-broochcopper }
...
Modifier to HairColor of -25 (from 80) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 37) {Complexion=Dark, Species=Human}
