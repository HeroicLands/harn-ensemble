...
sohl:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevelBase: 92 } }
    ...
    - { shortcode: runecft, type: mysticalability, system: { masteryLevelBase: 45 } }
    - { shortcode: tarot, type: mysticalability, system: { masteryLevelBase: 24 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 425 } }
    ...
    - { shortcode: LTunic, type: armorgear }
    - { shortcode: Kni, type: weapongear }
    - { shortcode: broochcopper, type: miscgear }
