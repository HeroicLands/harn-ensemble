...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-runecft, system: { masteryLevelBase: 45 } }
    - { model: sohl-sohl-mysticalability-tarot, system: { masteryLevelBase: 24 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 425 } }
