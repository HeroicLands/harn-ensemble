...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 78 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 562 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 562 } }
