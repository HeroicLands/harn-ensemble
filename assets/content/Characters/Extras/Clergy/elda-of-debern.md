...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 35 } }
    - { shortcode: condition, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: dancing, type: skill, system: { masteryLevel: 50 } }
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 84 } }
    - { shortcode: language, type: skill, name: Language(Karuia), system: { masteryLevel: 98 } }
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 64 } }
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: script, type: skill, name: Script(Script(Runic)), system: { masteryLevel: 96 } }
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevel: 96 } }
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 24 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1354 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 35 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    ...
    - { model: skill-script, name: Script(Zerin), system: { masteryLevelBase: 96 } }
...
Modifier to EyeColor of -10 (from 47) {Complexion=Fair, Species=Human}
