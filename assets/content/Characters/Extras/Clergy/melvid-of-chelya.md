...
sohl:
  ...
  items:
    ...
    - { shortcode: pysn, type: skill, system: { masteryLevelBase: 55 } }
    ...
    - shortcode: lang
      ...
      system:
        masteryLevelBase: 86
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevelBase: 92 } }
    ...
    - { shortcode: runecft, type: mysticalability, system: { masteryLevelBase: 44 } }
