...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 72 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevel: 92 } }
    - { shortcode: axe, type: skill, system: { masteryLevel: 55 } }
    ...
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 20 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 506 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 86
    - { model: skill-script, name: Script(Runic), system: { masteryLevelBase: 92 } }
    ...
    - { model: skill-smsh, system: { masteryLevelBase: 20 } }
    - { model: miscgear-pence, system: { quantity: 506 } }
...
Modifier to HairColor of +25 (from 11) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 63) {Complexion=Fair, Species=Human}

Deformed/Missing Arm mod to Dexterity: -2

141lbs weight resulted in -1 strength mod.

Modifier to StartingEquipment of +200 (from 63) {SocialClass=Unguilded}
