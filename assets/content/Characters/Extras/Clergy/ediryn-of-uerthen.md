...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Khruni), system: { masteryLevel: 98 } }
    - shortcode: script
      type: skill
      name: Script(Lakaise)
      system:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 590 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 112 } }
    - model: skill-anmcft
      name: Ivashu (Animalcraft)
      system:
        masteryLevelBase: 96
    ...
    - { model: miscgear-pence, system: { quantity: 590 } }
...
Modifier to EyeColor of -25 (from 48) {Complexion=Pale, Species=Human}
...
Modifier to StartingEquipment of +100 (from 92) {SocialClass=Serf}
