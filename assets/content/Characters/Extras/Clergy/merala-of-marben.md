...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, name: Mace (Club), system: { masteryLevel: 48 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: shield, type: skill, system: { masteryLevel: 55 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 547 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 547 } }
...
Modifier to EyeColor of +15 (from 14) {Complexion=Swarthy, Species=Human}
