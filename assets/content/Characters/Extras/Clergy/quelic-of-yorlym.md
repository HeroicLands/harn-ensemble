...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevel: 85 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 64
    - { model: skill-script, name: Script(Zerin), system: { masteryLevelBase: 85 } }
...
Modifier to StartingEquipment of +200 (from 27) {SocialClass=Unguilded}
