...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Surikal), system: { masteryLevel: 60 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 523 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 523 } }
