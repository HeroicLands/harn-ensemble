...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevel: 90 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 399 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 90 } }
    ...
    - { model: miscgear-pence, system: { quantity: 399 } }
...
Modifier to StartingEquipment of +100 (from 90) {SocialClass=Serf}
