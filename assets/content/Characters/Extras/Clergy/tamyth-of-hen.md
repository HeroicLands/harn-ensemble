...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-script, name: Script(Selenian), system: { masteryLevelBase: 90 } }
    ...
    - { model: sohl-sohl-mysticalability-runecft, system: { masteryLevelBase: 52 } }
    - { model: sohl-sohl-mysticalability-tarot, system: { masteryLevelBase: 26 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 399 } }
