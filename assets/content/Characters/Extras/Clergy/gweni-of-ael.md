...
hm3:
  ...
  items:
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 20 } }
    ...
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 63 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lgdm, system: { masteryLevelBase: 20 } }
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 73 } }
...
Modifier to StartingEquipment of +300 (from 49) {SocialClass=Guilded}
