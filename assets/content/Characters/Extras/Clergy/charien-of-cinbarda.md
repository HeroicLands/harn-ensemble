...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Sickle (Axe), system: { masteryLevel: 48 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 291 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 291 } }
...
Modifier to EyeColor of +15 (from 94) {Complexion=Swarthy, Species=Human}
