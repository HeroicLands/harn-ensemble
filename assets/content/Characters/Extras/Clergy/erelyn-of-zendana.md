...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Sindarin), system: { masteryLevel: 48 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: oratory, type: skill, system: { masteryLevel: 70 } }
    ...
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: siem, type: skill, system: { masteryLevel: 52 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 387 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 72 } }
    ...
    - { model: mysticalability-tarot, system: { masteryLevelBase: 36 } }
    - { model: miscgear-pence, system: { quantity: 387 } }
...
Modifier to EyeColor of -25 (from 74) {Complexion=Pale, Species=Human}
...
Modifier to StartingEquipment of +300 (from 34) {SocialClass=Guilded}
