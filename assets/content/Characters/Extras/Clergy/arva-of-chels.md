...
sohl:
  ...
  items:
    ...
    - { shortcode: stlth, type: skill, system: { masteryLevelBase: 96 } }
    ...
    - { shortcode: script, type: skill, name: Script(Neramic), system: { masteryLevelBase: 92 } }
    ...
    - { shortcode: lock, type: skill, system: { masteryLevelBase: 33 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 668 } }
