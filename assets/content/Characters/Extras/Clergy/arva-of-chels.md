...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 51 } }
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: stealth, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 60 } }
    ...
    - { shortcode: script, type: skill, name: Script(Neramic), system: { masteryLevel: 92 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 102 } }
    ...
    - { shortcode: krasulaspillow, type: invocation }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 668 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-stlth, system: { masteryLevelBase: 96 } }
    - { model: skill-srvl }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: skill-acro, system: { masteryLevelBase: 51 } }
    - { model: skill-lgdm, system: { masteryLevelBase: 26 } }
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 65 } }
    - { model: skill-script, name: Script(Neramic), system: { masteryLevelBase: 92 } }
    ...
    - { model: skill-lock, system: { masteryLevelBase: 33 } }
    - { model: miscgear-pence, system: { quantity: 668 } }
...
Modifier to EyeColor of -25 (from 88) {Complexion=Pale, Species=Human}
