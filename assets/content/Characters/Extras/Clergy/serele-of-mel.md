...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 40 } }
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 60 } }
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 75 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: naveh, type: skill, system: { masteryLevel: 80 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-acro, system: { masteryLevelBase: 40 } }
