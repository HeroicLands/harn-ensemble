...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Emela), system: { masteryLevel: 105 } }
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 95 } }
    ...
    - { shortcode: larani, type: skill, system: { masteryLevel: 102 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1264 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 95 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1264 } }
...
Modifier to EyeColor of -10 (from 12) {Complexion=Fair, Species=Human}
