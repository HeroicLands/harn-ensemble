...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 128 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 128 } }
...
Modifier to HairColor of +25 (from 98) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 60) {Complexion=Fair, Species=Human}
