...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 50 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 151 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-agri, system: { masteryLevelBase: 50 } }
    ...
    - { model: miscgear-pence, system: { quantity: 151 } }
