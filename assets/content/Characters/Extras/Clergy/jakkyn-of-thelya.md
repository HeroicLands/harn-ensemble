...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-pysn, system: { masteryLevelBase: 84 } }
    ...
    - { model: sohl-sohl-skill-agri, system: { masteryLevelBase: 50 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 151 } }
