...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Khruni), system: { masteryLevel: 100 } }
    - { shortcode: script, type: skill, name: Script(Lakaise), system: { masteryLevel: 115 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 429 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 115 } }
    - model: skill-anmcft
      name: Ivashu (Animalcraft)
      system:
        masteryLevelBase: 66
    ...
    - { model: miscgear-pence, system: { quantity: 429 } }
...
198lbs weight resulted in +3 strength mod.
