...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevel: 115 } }
...
sohl:
  ...
  items:
    ...
    - { shortcode: init, type: skill, system: { masteryLevelBase: 63 } }
    ...
    - { shortcode: script, type: skill, name: Script(Runic), system: { masteryLevelBase: 115 } }
