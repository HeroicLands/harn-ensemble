...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 36 } }
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 45 } }
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 84 } }
    ...
    - { shortcode: script, type: skill, name: Script(Neramic), system: { masteryLevel: 84 } }
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: naveh, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: gekrishsguidinghand, type: invocation }
    ...
    - { shortcode: navehcurse, type: invocation }
...
sohl:
  ...
  items:
    ...
    - { model: skill-acro, system: { masteryLevelBase: 36 } }
    - { model: skill-lgdm, system: { masteryLevelBase: 45 } }
    ...
    - { model: skill-lock, system: { masteryLevelBase: 26 } }
...
**Age**: 38
**Birthday**: 9 Savor 682
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 2nd child of 11
**Siblings**: FFmFFmMmFmF
**Parentage**: Offspring
...
Modifier to HairColor of -25 (from 6) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 57) {Complexion=Dark, Species=Human}

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +100 (from 85) {SocialClass=Serf}
