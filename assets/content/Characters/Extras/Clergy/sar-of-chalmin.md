...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Azeri), system: { masteryLevel: 33 } }
    - { shortcode: language, type: skill, name: Language(Ormauk), system: { masteryLevel: 33 } }
