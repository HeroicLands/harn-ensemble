...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 24 } }
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 34 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 395 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-acro, system: { masteryLevelBase: 24 } }
    - { model: skill-lgdm, system: { masteryLevelBase: 34 } }
    ...
    - { model: miscgear-pence, system: { quantity: 395 } }
