...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Emela), system: { masteryLevel: 42 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 163 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 163 } }
...
Modifier to StartingEquipment of +200 (from 90) {SocialClass=Unguilded}
