...
hm3:
  ...
  items:
    ...
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: language, type: skill, name: Language(Sindarin), system: { masteryLevel: 90 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 14 } }
    ...
    - { shortcode: siem, type: skill, system: { masteryLevel: 80 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 594 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 75 } }
    - { model: skill-musc, system: { masteryLevelBase: 14 } }
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 106 } }
    ...
    - { model: mysticalability-tarot, system: { masteryLevelBase: 30 } }
    - { model: miscgear-pence, system: { quantity: 594 } }
...
Modifier to HairColor of -25 (from 85) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 29) {Complexion=Dark, Species=Human}
...
Modifier to StartingEquipment of +300 (from 11) {SocialClass=Guilded}
