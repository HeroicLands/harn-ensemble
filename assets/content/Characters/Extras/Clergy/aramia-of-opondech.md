...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 75 } }
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevel: 106 } }
...
sohl:
  ...
  items:
    ...
    - { shortcode: lang, type: skill, name: "Language, Guilded", system: { masteryLevelBase: 75 } }
    - { shortcode: musc, type: skill, system: { masteryLevelBase: 14 } }
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevelBase: 106 } }
    - { shortcode: astr, type: mysticalability, system: { masteryLevelBase: 60 } }
