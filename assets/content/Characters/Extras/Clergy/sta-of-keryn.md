...
hm3:
  ...
  items:
    ...
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 579 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 579 } }
...
Modifier to EyeColor of +15 (from 27) {Complexion=Swarthy, Species=Human}
