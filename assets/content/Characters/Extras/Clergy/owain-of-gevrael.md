...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Karuia), system: { masteryLevel: 36 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 165 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 165 } }
...
Modifier to EyeColor of +15 (from 75) {Complexion=Swarthy, Species=Human}
