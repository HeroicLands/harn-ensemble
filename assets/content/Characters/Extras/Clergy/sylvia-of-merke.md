...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 70 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 878 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 70 } }
    - { model: skill-dscr }
    ...
    - { model: miscgear-pence, system: { quantity: 878 } }
...
Modifier to EyeColor of -25 (from 19) {Complexion=Pale, Species=Human}

99lbs weight resulted in -3 strength mod.

Scant frame resulted in +2 agility mod.

Modifier to StartingEquipment of +100 (from 42) {SocialClass=Serf}
