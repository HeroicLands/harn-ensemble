...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivashi), system: { masteryLevel: 33 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 567 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 567 } }
...
Modifier to HairColor of -25 (from 76) {Complexion=Dark, Species=Human}
