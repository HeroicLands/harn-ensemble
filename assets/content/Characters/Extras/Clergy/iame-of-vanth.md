...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-pysn, system: { masteryLevelBase: 55 } }
    ...
    - { model: sohl-sohl-skill-agri, system: { masteryLevelBase: 55 } }
