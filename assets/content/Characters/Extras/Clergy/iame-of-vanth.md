...
hm3:
  ...
  items:
    ...
    - { shortcode: condition, type: skill, system: { masteryLevel: 77 } }
    ...
    - { shortcode: oratory, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 55 } }
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 33 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 136 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-agri, system: { masteryLevelBase: 55 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 36 } }
    - { model: skill-embl, system: { masteryLevelBase: 36 } }
    - { model: skill-hrld, system: { masteryLevelBase: 20 } }
    - { model: skill-herb, system: { masteryLevelBase: 27 } }
    - { model: skill-law, system: { masteryLevelBase: 26 } }
    - { model: skill-txtl, system: { masteryLevelBase: 33 } }
    - { model: miscgear-pence, system: { quantity: 136 } }
...
Modifier to StartingEquipment of +100 (from 13) {SocialClass=Serf}
