...
sohl:
  ...
  items:
    ...
    - { shortcode: dnce, type: skill, system: { masteryLevelBase: 85 } }
    - { shortcode: dscr, type: skill }
    - { shortcode: draw, type: skill, system: { masteryLevelBase: 56 } }
    ...
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevelBase: 100 } }
    ...
    - { shortcode: LTunic, type: armorgear }
    - { shortcode: Kni, type: weapongear }
    - { shortcode: necklacebone, type: miscgear }
