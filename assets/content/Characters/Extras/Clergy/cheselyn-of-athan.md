...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-dnce, system: { masteryLevelBase: 85 } }
    - { model: sohl-sohl-skill-dscr }
    - { model: sohl-sohl-skill-draw, system: { masteryLevelBase: 56 } }
    ...
    - { model: sohl-sohl-skill-script, name: Script(Zerin), system: { masteryLevelBase: 100 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 551 } }
