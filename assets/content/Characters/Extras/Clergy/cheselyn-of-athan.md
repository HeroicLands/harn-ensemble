...
hm3:
  ...
  items:
    ...
    - { shortcode: dancing, type: skill, system: { masteryLevel: 85 } }
    ...
    - { shortcode: language, type: skill, name: Language(Jarinese), system: { masteryLevel: 44 } }
    - { shortcode: language, type: skill, name: Language(Karuia), system: { masteryLevel: 66 } }
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 61 } }
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 70 } }
    ...
    - { shortcode: script, type: skill, name: Script(Script(Runic)), system: { masteryLevel: 85 } }
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevel: 100 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: halea, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: taniaspleasure, type: invocation }
    ...
    - { shortcode: haleaendure, type: invocation }
    - { shortcode: thaliasluck, type: invocation }
    - { shortcode: haleatongues, type: invocation }
    - { shortcode: elomiastongue, type: invocation }
    - { shortcode: haleatruthsense, type: invocation }
    - { shortcode: haleadivination, type: invocation }
    - { shortcode: sadurasrash, type: invocation }
    - { shortcode: haleacurse, type: invocation }
    - { shortcode: halearevelation, type: invocation }
    - { shortcode: haleasummoning, type: invocation }
    - { shortcode: haleatruesight, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 551 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce, system: { masteryLevelBase: 85 } }
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 56 } }
    ...
    - { model: skill-script, name: Script(Zerin), system: { masteryLevelBase: 100 } }
