...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Jarinese), system: { masteryLevel: 78 } }
    ...
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevel: 98 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 568 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Zerin), system: { masteryLevelBase: 98 } }
...
111lbs weight resulted in -2 strength mod.
