...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1243 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 1243 } }
