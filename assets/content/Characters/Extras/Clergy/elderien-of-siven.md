...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 60 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: axe, type: skill, system: { masteryLevel: 102 } }
    ...
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 85 } }
...
Modifier to EyeColor of +15 (from 33) {Complexion=Swarthy, Species=Human}
