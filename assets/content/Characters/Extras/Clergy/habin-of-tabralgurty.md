...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 64 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 68 } }
    ...
    - { shortcode: naveh, type: skill, system: { masteryLevel: 85 } }
...
Modifier to HairColor of +25 (from 50) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 8) {Complexion=Fair, Species=Human}
