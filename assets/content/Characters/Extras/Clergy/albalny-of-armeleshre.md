...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Karuia), system: { masteryLevel: 65 } }
    ...
    - { shortcode: script, type: skill, name: Script(Script(Runic)), system: { masteryLevel: 90 } }
    - { shortcode: script, type: skill, name: Script(Zerin), system: { masteryLevel: 90 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 374 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Zerin), system: { masteryLevelBase: 90 } }
    ...
    - { model: miscgear-pence, system: { quantity: 374 } }
...
**Age**: 31
**Birthday**: 23 Agrazhar 689
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 2nd child of 11
**Siblings**: MFFmMMFfffF
**Parentage**: Offspring
