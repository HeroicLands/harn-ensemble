...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Karuia), system: { masteryLevel: 78 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: script, type: skill, name: Script(Script(Runic)), system: { masteryLevel: 106 } }
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 45 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1025 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Zerin), system: { masteryLevelBase: 94 } }
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 45 } }
    - { model: miscgear-pence, system: { quantity: 1025 } }
...
Modifier to HairColor of +25 (from 27) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 42) {Complexion=Fair, Species=Human}

170lbs weight resulted in +1 strength mod.

Modifier to StartingEquipment of +100 (from 15) {SocialClass=Serf}
