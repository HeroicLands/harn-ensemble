...
hm3:
  ...
  items:
    ...
    - { shortcode: astrology, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 65 } }
    ...
    - { shortcode: siem, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 368 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-astr, system: { masteryLevelBase: 90 } }
    ...
    - { model: miscgear-pence, system: { quantity: 368 } }
...
Modifier to StartingEquipment of +100 (from 39) {SocialClass=Serf}
