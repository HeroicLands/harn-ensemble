...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-musc, system: { masteryLevelBase: 18 } }
    - { model: sohl-sohl-skill-script, name: Script(Selenian), system: { masteryLevelBase: 83 } }
    - { model: sohl-sohl-mysticalability-astr, system: { masteryLevelBase: 90 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 368 } }
