...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: valaminssleep, type: invocation }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 858 } }
    - { shortcode: pursebuckram, type: containergear }
    - { shortcode: LLeg, type: armorgear }
    - { shortcode: CShoe, type: armorgear }
    - { shortcode: LTunic, type: armorgear }
    - { shortcode: Kni, type: weapongear }
    - name: Periapt of Essential Wizardry
      type: miscgear
      data:
...
216lbs weight resulted in +4 strength mod.
