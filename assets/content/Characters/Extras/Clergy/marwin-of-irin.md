...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Surikal), system: { masteryLevel: 42 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 595 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 595 } }
...
Modifier to EyeColor of -10 (from 57) {Complexion=Fair, Species=Human}
