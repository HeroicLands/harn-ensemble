...
hm3:
  ...
  items:
    ...
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 65 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 402 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 92
    - { model: skill-script, name: Script(Runic), system: { masteryLevelBase: 96 } }
    ...
    - { model: miscgear-pence, system: { quantity: 402 } }
