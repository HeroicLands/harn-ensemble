...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 98 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 719 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 719 } }
...
Modifier to EyeColor of -25 (from 38) {Complexion=Pale, Species=Human}
