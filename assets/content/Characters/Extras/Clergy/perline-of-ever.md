...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Sickle (Axe), system: { masteryLevel: 77 } }
...
Modifier to HairColor of -25 (from 95) {Complexion=Dark, Species=Human}
...
Modifier to StartingEquipment of +200 (from 93) {SocialClass=Unguilded}
