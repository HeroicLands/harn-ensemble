...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Sindarin), system: { masteryLevel: 60 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 445 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 22 } }
    ...
    - { model: skill-musc, system: { masteryLevelBase: 24 } }
    ...
    - { model: miscgear-pence, system: { quantity: 445 } }
...
Modifier to EyeColor of +15 (from 87) {Complexion=Swarthy, Species=Human}
