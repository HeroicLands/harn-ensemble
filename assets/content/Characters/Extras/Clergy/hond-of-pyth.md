...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 92 } }
    - { shortcode: mentalconflict, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: musician, type: skill, system: { masteryLevel: 32 } }
    ...
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 45 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 817 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 92 } }
    - { model: skill-musc, system: { masteryLevelBase: 32 } }
    ...
    - { model: miscgear-pence, system: { quantity: 817 } }
...
300lbs weight resulted in +6 strength mod.
