...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 21 } }
    ...
    - { shortcode: folklore, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 573 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-musc, system: { masteryLevelBase: 21 } }
    ...
    - { model: miscgear-pence, system: { quantity: 573 } }
...
Modifier to EyeColor of +25 (from 4) {Complexion=Dark, Species=Human}
