...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 76 } }
    - { shortcode: climbing, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: condition, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: jumping, type: skill, system: { masteryLevel: 114 } }
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: stealth, type: skill, system: { masteryLevel: 84 } }
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 65 } }
    ...
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: naveh, type: skill, system: { masteryLevel: 78 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jump, system: { masteryLevelBase: 114 } }
    ...
    - { model: skill-acro, system: { masteryLevelBase: 76 } }
    - { model: skill-lgdm, system: { masteryLevelBase: 24 } }
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 89 } }
    - { model: skill-script, name: Script(Neramic), system: { masteryLevelBase: 96 } }
    ...
    - { model: skill-lock, system: { masteryLevelBase: 39 } }
    - { model: miscgear-pence, system: { quantity: 770 } }
...
**Age**: 40
**Birthday**: 22 Agrazhar 680
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 3rd child of 11
**Siblings**: FFFfMmfMMMF
**Parentage**: Offspring
...
Modifier to EyeColor of -25 (from 93) {Complexion=Pale, Species=Human}
