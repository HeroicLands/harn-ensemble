...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 114 } }
    ...
    - { model: sohl-sohl-skill-acro, system: { masteryLevelBase: 76 } }
    - { model: sohl-sohl-skill-lgdm, system: { masteryLevelBase: 24 } }
    ...
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 39 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 770 } }
