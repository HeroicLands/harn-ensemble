...
hm3:
  ...
  items:
    ...
    - { shortcode: stealth, type: skill, system: { masteryLevel: 28 } }
    ...
    - { shortcode: language, type: skill, name: Language(Emela), system: { masteryLevel: 52 } }
    - shortcode: language
      type: skill
      name: Language, Serf
      system:
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 75 } }
    - { model: skill-ridg }
...
Modifier to EyeColor of -25 (from 63) {Complexion=Pale, Species=Human}

Birthmarks mod to Comeliness: -2

180lbs weight resulted in +2 strength mod.

Modifier to StartingEquipment of +100 (from 86) {SocialClass=Serf}
