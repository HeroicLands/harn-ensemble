...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 77 } }
    ...
    - { shortcode: language, type: skill, name: Language(Sindarin), system: { masteryLevel: 42 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: embalming, type: skill, system: { masteryLevel: 21 } }
    ...
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 68 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 51 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 641 } }
...
sohl:
  ...
  items:
    ...
    - { shortcode: per, type: attribute, system: { scoreBase: 4 } }
    ...
    - { shortcode: clmb, type: skill, system: { masteryLevelBase: 77 } }
    ...
    - { shortcode: script, type: skill, name: Script(Selenian), system: { masteryLevelBase: 81 } }
    - { shortcode: astr, type: mysticalability, system: { masteryLevelBase: 56 } }
    - { shortcode: embl, type: skill, system: { masteryLevelBase: 21 } }
    - { shortcode: hrld, type: skill, system: { masteryLevelBase: 36 } }
    - { shortcode: herb, type: skill, system: { masteryLevelBase: 20 } }
    - { shortcode: law, type: skill, system: { masteryLevelBase: 30 } }
    - { shortcode: runecft, type: mysticalability, system: { masteryLevelBase: 68 } }
    - { shortcode: tarot, type: mysticalability, system: { masteryLevelBase: 51 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 641 } }
    ...
    - { shortcode: SgTunic, type: armorgear }
    - { shortcode: Kni, type: weapongear }
    - { shortcode: holysymbrass, type: miscgear }
...
Modifier to EyeColor of +15 (from 40) {Complexion=Swarthy, Species=Human}

116lbs weight resulted in -2 strength mod.

Scant frame resulted in +2 agility mod.

Modifier to StartingEquipment of +200 (from 87) {SocialClass=Unguilded}
