...
sohl:
  ...
  items:
    ...
    - { model: attribute-per, system: { scoreBase: 4 } }
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 77 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce }
    - { model: skill-dscr }
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 36 } }
    ...
    - { model: mysticalability-runecft, system: { masteryLevelBase: 68 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 51 } }
    - { model: miscgear-pence, system: { quantity: 641 } }
