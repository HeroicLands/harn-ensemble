...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-attribute-per, system: { scoreBase: 4 } }
    ...
    - { model: sohl-sohl-skill-clmb, system: { masteryLevelBase: 77 } }
    ...
    - { model: sohl-sohl-skill-embl, system: { masteryLevelBase: 21 } }
    - { model: sohl-sohl-skill-hrld, system: { masteryLevelBase: 36 } }
    - { model: sohl-sohl-skill-herb, system: { masteryLevelBase: 20 } }
    - { model: sohl-sohl-skill-law, system: { masteryLevelBase: 30 } }
    - { model: sohl-sohl-mysticalability-runecft, system: { masteryLevelBase: 68 } }
    - { model: sohl-sohl-mysticalability-tarot, system: { masteryLevelBase: 51 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 641 } }
