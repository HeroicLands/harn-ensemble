...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Khruni), system: { masteryLevel: 109 } }
    ...
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 892 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 83 } }
    - model: skill-anmcft
      name: Ivashu (Animalcraft)
      system:
        masteryLevelBase: 98
    ...
    - { model: miscgear-pence, system: { quantity: 892 } }
...
Modifier to HairColor of +25 (from 41) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 40) {Complexion=Fair, Species=Human}
