...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 98 } }
    ...
    - { shortcode: axe, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: embalming, type: skill, system: { masteryLevel: 48 } }
    ...
    - { shortcode: sarajin, type: skill, system: { masteryLevel: 60 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 396 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 98 } }
    - { model: skill-script, name: Script(Runic), system: { masteryLevelBase: 82 } }
    - { model: skill-embl, system: { masteryLevelBase: 48 } }
    ...
    - { model: miscgear-pence, system: { quantity: 396 } }
...
Modifier to HairColor of +25 (from 18) {Complexion=Fair, Species=Human}
