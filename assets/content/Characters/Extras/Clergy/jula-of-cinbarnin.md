...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 48 } }
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 28 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-acro, system: { masteryLevelBase: 48 } }
    - { model: skill-lgdm, system: { masteryLevelBase: 28 } }
