...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Khruni), system: { masteryLevel: 85 } }
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 42 } }
    ...
    - { shortcode: physician, type: skill, system: { masteryLevel: 85 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: peoni, type: skill, system: { masteryLevel: 96 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-agri, system: { masteryLevelBase: 65 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 42 } }
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 56 } }
...
Modifier to HairColor of +25 (from 49) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 96) {Complexion=Fair, Species=Human}
