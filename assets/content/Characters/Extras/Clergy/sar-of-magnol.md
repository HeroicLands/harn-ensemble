...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivashi), system: { masteryLevel: 44 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: physician, type: skill, system: { masteryLevel: 60 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 469 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 71 } }
    ...
    - { model: skill-law, system: { masteryLevelBase: 22 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 469 } }
...
Modifier to StartingEquipment of +300 (from 30) {SocialClass=Guilded}
