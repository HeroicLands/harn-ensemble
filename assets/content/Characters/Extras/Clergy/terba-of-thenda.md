...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 52 } }
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 16 } }
    ...
    - { shortcode: language, type: skill, name: Language(Besha), system: { masteryLevel: 70 } }
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 64 } }
    - { shortcode: mentalconflict, type: skill, system: { masteryLevel: 84 } }
    ...
    - { shortcode: script, type: skill, name: Script(Neramic), system: { masteryLevel: 79 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 81 } }
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 20 } }
    ...
    - { shortcode: navehsummoning, type: invocation }
    - { shortcode: gytevshaspassage, type: invocation }
    - { shortcode: houseinkamil, type: invocation }
    - { shortcode: pence, type: miscgear, system: { quantity: 904 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lgdm, system: { masteryLevelBase: 16 } }
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 64 } }
    - { model: skill-script, name: Script(Neramic), system: { masteryLevelBase: 79 } }
    ...
    - { model: skill-lock, system: { masteryLevelBase: 20 } }
    - { model: miscgear-pence, system: { quantity: 904 } }
...
Modifier to HairColor of +25 (from 24) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 52) {Complexion=Fair, Species=Human}
