...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Nuvesarl), system: { masteryLevel: 82 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Nuvesarl), system: { masteryLevelBase: 82 } }
