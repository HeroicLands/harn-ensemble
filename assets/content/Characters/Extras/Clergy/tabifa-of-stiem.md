...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Emela), system: { masteryLevel: 96 } }
    - shortcode: language
      type: skill
      name: Language, Serf
      system:
    ...
    - { shortcode: sword, type: skill, system: { masteryLevel: 55 } }
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: larani, type: skill, system: { masteryLevel: 90 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1103 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-law, system: { masteryLevelBase: 64 } }
    - { model: miscgear-pence, system: { quantity: 1103 } }
    ...
    - name: Knight's Peace
      ...
      system:
        ...
        assocAffiliationCode: larani
        levelBase: 3
    - name: Curse of the Reluctant Warrior
      type: mysticalability
      system:
        subType: divineincantation
        assocSkillCode: larani
...
Modifier to EyeColor of -10 (from 65) {Complexion=Fair, Species=Human}
