...
hm3:
  ...
  items:
    ...
    - { shortcode: awareness, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: language, type: skill, name: Language(Ivashi), system: { masteryLevel: 39 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: script, type: skill, name: Script(Khruni), system: { masteryLevel: 103 } }
    - shortcode: script
      type: skill
      name: Script(Lakaise)
      system:
    ...
    - shortcode: animalcraft
      ...
      system:
        masteryLevel: 72
    - { shortcode: drawing, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 44 } }
    ...
    - { shortcode: ilvir, type: skill, system: { masteryLevel: 84 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 366 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 40 } }
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 81 } }
    - model: skill-anmcft
      name: Ivashu (Animalcraft)
      system:
        masteryLevelBase: 72
    - { model: skill-embl, system: { masteryLevelBase: 44 } }
    ...
    - { model: miscgear-pence, system: { quantity: 366 } }
...
Modifier to EyeColor of -10 (from 53) {Complexion=Fair, Species=Human}

One Leg Missing/Deformed reduces Agilty by half: -5

123lbs weight resulted in -2 strength mod.

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +100 (from 97) {SocialClass=Serf}
