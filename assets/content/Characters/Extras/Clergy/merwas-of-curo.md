...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 66 } }
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 10 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 656 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery }
    - { model: skill-awar, system: { masteryLevelBase: 28 } }
    - { model: skill-chrm }
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 64
    - { model: skill-musc, system: { masteryLevelBase: 10 } }
    ...
    - { model: skill-herb, system: { masteryLevelBase: 44 } }
    ...
    - { model: miscgear-pence, system: { quantity: 656 } }
...
Modifier to HairColor of -25 (from 5) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 7) {Complexion=Dark, Species=Human}

Hirsutism mod to Comeliness: -2

282lbs weight resulted in +5 strength mod.

Massive frame resulted in -2 agility mod.

Modifier to StartingEquipment of +200 (from 65) {SocialClass=Unguilded}
