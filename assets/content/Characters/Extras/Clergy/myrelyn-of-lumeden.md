...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ormauk), system: { masteryLevel: 36 } }
    ...
    - { shortcode: script, type: skill, name: Script(Nuvesarl), system: { masteryLevel: 84 } }
    ...
    - { shortcode: woodcraft, type: skill, name: Masks (Woodcraft), system: { masteryLevel: 28 } }
    - { shortcode: morgath, type: skill, system: { masteryLevel: 52 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Nuvesarl), system: { masteryLevelBase: 84 } }
    ...
    - { model: miscgear-pence, system: { quantity: 135 } }
...
Modifier to AttributesAGL of -1 (from 5) {Frame=Heavy}

Modifier to AttributesAUR of +2 (from 11) {Sex=Female, Species=Human}

Modifier to HairColor of +25 (from 78) {Complexion=Fair, Species=Human}
...
Modifier to StartingEquipment of +300 (from 73) {SocialClass=Guilded}
