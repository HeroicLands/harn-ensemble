...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 84 } }
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 36 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 64 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 84 } }
    ...
    - { model: miscgear-pence, system: { quantity: 64 } }
...
Modifier to EyeColor of -10 (from 32) {Complexion=Fair, Species=Human}
