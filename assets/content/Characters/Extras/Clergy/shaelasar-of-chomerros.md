...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Emela), system: { masteryLevel: 91 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: peoni, type: skill, system: { masteryLevel: 90 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 331 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 331 } }
...
Modifier to EyeColor of -10 (from 16) {Complexion=Fair, Species=Human}
...
Modifier to StartingEquipment of +200 (from 58) {SocialClass=Unguilded}
