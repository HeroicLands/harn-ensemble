...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Sindarin), system: { masteryLevel: 65 } }
    ...
    - { shortcode: oratory, type: skill, system: { masteryLevel: 40 } }
    ...
    - { shortcode: astrology, type: skill, system: { masteryLevel: 70 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 426 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-musc, system: { masteryLevelBase: 36 } }
    - { model: skill-script, name: Script(Selenian), system: { masteryLevelBase: 94 } }
    - { model: mysticalability-astr, system: { masteryLevelBase: 70 } }
    ...
    - { model: miscgear-pence, system: { quantity: 426 } }
...
Modifier to EyeColor of +25 (from 64) {Complexion=Dark, Species=Human}
