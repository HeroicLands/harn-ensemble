...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 18 } }
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 50 } }
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 21 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 248 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-acro, system: { masteryLevelBase: 18 } }
    - { model: skill-lgdm, system: { masteryLevelBase: 50 } }
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 61 } }
    - { model: skill-lock, system: { masteryLevelBase: 21 } }
    - { model: miscgear-pence, system: { quantity: 248 } }
