...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-acro, system: { masteryLevelBase: 18 } }
    - { model: sohl-sohl-skill-lgdm, system: { masteryLevelBase: 50 } }
    - { model: sohl-sohl-skill-lang, name: "Language, Serf", system: { masteryLevelBase: 61 } }
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 21 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 248 } }
