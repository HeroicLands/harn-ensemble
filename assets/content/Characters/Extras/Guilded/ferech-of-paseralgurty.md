...
sohl:
  ...
  items:
    ...
    - { shortcode: acro, type: skill, system: { masteryLevelBase: 18 } }
    - { shortcode: lgdm, type: skill, system: { masteryLevelBase: 50 } }
    - { shortcode: lang, type: skill, name: "Language, Serf", system: { masteryLevelBase: 61 } }
    - { shortcode: lock, type: skill, system: { masteryLevelBase: 21 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 248 } }
