...
hm3:
  ...
  items:
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 60 } }
    ...
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 234 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-timb, system: { masteryLevelBase: 39 } }
    - { model: miscgear-pence, system: { quantity: 234 } }
