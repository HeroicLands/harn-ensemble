...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 16 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 33 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 24 } }
    - { model: skill-herb, system: { masteryLevelBase: 56 } }
    - { model: skill-math, system: { masteryLevelBase: 16 } }
    - { model: miscgear-pence, system: { quantity: 33 } }
