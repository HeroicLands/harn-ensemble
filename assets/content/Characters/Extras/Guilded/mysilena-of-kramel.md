...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, name: Morningstar (Club), system: { masteryLevel: 44 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: sword, type: skill, name: Broadsword (Sword), system: { masteryLevel: 39 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 3629 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 104 } }
    - { model: miscgear-pence, system: { quantity: 3629 } }
...
Modifier to StartingEquipment of +400 (from 27) {SocialClass=Noble}
