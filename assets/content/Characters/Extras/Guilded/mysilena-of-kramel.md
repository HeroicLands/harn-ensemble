...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-fltch, system: { masteryLevelBase: 48 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 78 } }
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 104 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 3629 } }
