...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-cmcs, system: { masteryLevelBase: 48 } }
    - { model: sohl-sohl-skill-glas, system: { masteryLevelBase: 90 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 831 } }
