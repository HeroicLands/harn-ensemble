...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 90 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 48 } }
    - { model: skill-glas, system: { masteryLevelBase: 90 } }
