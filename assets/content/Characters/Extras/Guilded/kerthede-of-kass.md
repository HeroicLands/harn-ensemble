...
hm3:
  ...
  items:
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1036 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 55 } }
    - { model: miscgear-pence, system: { quantity: 1036 } }
