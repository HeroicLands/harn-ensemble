...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1343 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 44 } }
    - { model: skill-herb, system: { masteryLevelBase: 112 } }
    - { model: miscgear-pence, system: { quantity: 1343 } }
    - { model: containergear-pouchbuckram }
    - { model: armorgear-WCBoot }
...
One Ear Missing/Deaf mod to Hearing: -1
