...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 44 } }
    - { model: sohl-sohl-skill-herb, system: { masteryLevelBase: 112 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1343 } }
