...
hm3:
  ...
  items:
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 88 } }
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1642 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lgdm, system: { masteryLevelBase: 88 } }
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 62 } }
    - { model: skill-lock, system: { masteryLevelBase: 72 } }
    - { model: miscgear-pence, system: { quantity: 1642 } }
