...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 112 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1768 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 112 } }
    - model: skill-anmcft
      name: Horsecraft (Animalcraft)
      system:
        masteryLevelBase: 48
    - { model: skill-hide, system: { masteryLevelBase: 36 } }
    - { model: miscgear-pence, system: { quantity: 1768 } }
...
Modifier to StartingEquipment of +300 (from 65) {SocialClass=Guilded}
