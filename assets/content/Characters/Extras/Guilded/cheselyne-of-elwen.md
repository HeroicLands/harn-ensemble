...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 78 } }
    ...
    - { model: sohl-sohl-skill-lang, name: "Language, Serf", system: { masteryLevelBase: 77 } }
    - { model: sohl-sohl-skill-script, name: Script(Lakaise), system: { masteryLevelBase: 81 } }
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 75 } }
    - { model: sohl-sohl-skill-embl, system: { masteryLevelBase: 96 } }
    - { model: sohl-sohl-skill-pfmy, system: { masteryLevelBase: 56 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 621 } }
