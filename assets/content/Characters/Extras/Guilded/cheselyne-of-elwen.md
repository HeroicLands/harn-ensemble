...
sohl:
  ...
  items:
    ...
    - { shortcode: lang, type: skill, name: "Language, Serf", system: { masteryLevelBase: 77 } }
    - { shortcode: script, type: skill, name: Script(Lakaise), system: { masteryLevelBase: 81 } }
    - { shortcode: alch, type: mysticalability, system: { masteryLevelBase: 75 } }
    - { shortcode: embl, type: skill, system: { masteryLevelBase: 96 } }
    - { shortcode: pfmy, type: skill, system: { masteryLevelBase: 56 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 621 } }
