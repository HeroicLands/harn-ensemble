...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 77 } }
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 24 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 77 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 81 } }
    - { model: mysticalability-alch, system: { masteryLevelBase: 75 } }
    - { model: skill-embl, system: { masteryLevelBase: 96 } }
    - { model: skill-pfmy, system: { masteryLevelBase: 56 } }
...
Modifier to EyeColor of +15 (from 52) {Complexion=Swarthy, Species=Human}
