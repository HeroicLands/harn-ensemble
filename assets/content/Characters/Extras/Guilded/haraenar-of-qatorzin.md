...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 0 } }
    - { shortcode: pursebuckram, type: containergear }
    - { shortcode: LtCBoot, type: armorgear }
    - { shortcode: SlsCloak, type: armorgear }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 91 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce }
    - { model: skill-dscr }
    ...
    - { model: skill-shpw, system: { masteryLevelBase: 96 } }
    - { model: skill-timb, system: { masteryLevelBase: 52 } }
    - { model: miscgear-pence, system: { quantity: 0 } }
    - { model: containergear-pouchbuckram }
    - { model: armorgear-LtCBoot }
    - { model: armorgear-SlsCloak }
...
Modifier to StartingEquipment of +200 (from 60) {SocialClass=Unguilded}
