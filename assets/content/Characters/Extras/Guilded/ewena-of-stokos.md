...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 692 } }
...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-cmcs, system: { masteryLevelBase: 104 } }
    - { model: sohl-sohl-skill-glas, system: { masteryLevelBase: 24 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 692 } }
