...
sohl:
  ...
  items:
    ...
    - { model: skill-masn, system: { masteryLevelBase: 44 } }
    - { model: skill-math, system: { masteryLevelBase: 22 } }
    - { model: miscgear-pence, system: { quantity: 1959 } }
