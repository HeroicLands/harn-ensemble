...
hm3:
  ...
  items:
    ...
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 51 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1054 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 51 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 102 } }
    - { model: miscgear-pence, system: { quantity: 1054 } }
...
Modifier to HairColor of -25 (from 32) {Complexion=Dark, Species=Human}
