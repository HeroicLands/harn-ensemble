...
hm3:
  ...
  items:
    ...
    - { shortcode: astrology, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1772 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-astr, system: { masteryLevelBase: 55 } }
    - { model: skill-math, system: { masteryLevelBase: 72 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 72 } }
    - { model: miscgear-pence, system: { quantity: 1772 } }
...
195lbs weight resulted in +3 strength mod.
