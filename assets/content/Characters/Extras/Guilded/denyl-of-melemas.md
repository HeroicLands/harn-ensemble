...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-astr, system: { masteryLevelBase: 55 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 72 } }
    - { model: sohl-sohl-mysticalability-tarot, system: { masteryLevelBase: 72 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1772 } }
