...
sohl:
  ...
  items:
    ...
    - { shortcode: astr, type: mysticalability, system: { masteryLevelBase: 55 } }
    - { shortcode: math, type: skill, system: { masteryLevelBase: 72 } }
    - { shortcode: tarot, type: mysticalability, system: { masteryLevelBase: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1772 } }
