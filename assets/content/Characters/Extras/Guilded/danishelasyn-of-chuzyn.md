...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, system: { masteryLevel: 24 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1566 } }
