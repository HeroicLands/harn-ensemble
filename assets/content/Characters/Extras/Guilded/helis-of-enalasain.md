...
hm3:
  ...
  items:
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1083 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-math, system: { masteryLevelBase: 84 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 72 } }
    - { model: miscgear-pence, system: { quantity: 1083 } }
...
Modifier to EyeColor of -10 (from 51) {Complexion=Fair, Species=Human}
