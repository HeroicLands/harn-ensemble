...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 84 } }
    - { model: sohl-sohl-skill-jewl, system: { masteryLevelBase: 39 } }
    - { model: sohl-sohl-skill-txtl, system: { masteryLevelBase: 84 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1093 } }
