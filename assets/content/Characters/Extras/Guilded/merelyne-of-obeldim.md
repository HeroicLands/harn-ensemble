...
hm3:
  ...
  items:
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1093 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 84 } }
    - { model: miscgear-pence, system: { quantity: 1093 } }
