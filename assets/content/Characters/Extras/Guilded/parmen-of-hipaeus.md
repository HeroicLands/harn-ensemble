...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 34 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 96 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 96 } }
    - { model: miscgear-pence, system: { quantity: 544 } }
