...
hm3:
  ...
  items:
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 88 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1100 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 88 } }
    - { model: skill-ridg }
    ...
    - { model: miscgear-pence, system: { quantity: 1100 } }
