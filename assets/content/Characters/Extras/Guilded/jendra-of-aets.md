...
hm3:
  ...
  items:
    ...
    - { shortcode: cookery, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: fishing, type: skill, system: { masteryLevel: 55 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 548 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 72
    - { model: skill-fish, system: { masteryLevelBase: 55 } }
    - { model: skill-herb, system: { masteryLevelBase: 20 } }
    - { model: miscgear-pence, system: { quantity: 548 } }
...
Modifier to Frame of -3 (from 18) {Sex=Female, Species=Human}
