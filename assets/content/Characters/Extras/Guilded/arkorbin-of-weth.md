...
hm3:
  ...
  items:
    ...
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 90 } }
    ...
    - name: "Debt to Money Lender: Frandy of Tobira for 190d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-shpw, system: { masteryLevelBase: 84 } }
    - { model: skill-timb, system: { masteryLevelBase: 72 } }
