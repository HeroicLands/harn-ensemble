...
hm3:
  ...
  items:
    ...
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 22 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-glas, system: { masteryLevelBase: 22 } }
...
Modifier to StartingEquipment of +300 (from 97) {SocialClass=Guilded}
