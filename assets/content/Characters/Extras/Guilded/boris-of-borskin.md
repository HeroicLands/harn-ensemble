...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, name: Flute (Musician), system: { masteryLevel: 72 } }
    - { shortcode: musician, type: skill, name: Lute (Musician), system: { masteryLevel: 72 } }
    - { shortcode: musician, type: skill, name: Recorder (Musician), system: { masteryLevel: 60 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 619 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-musc, name: Recorder (Musician), system: { masteryLevelBase: 60 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 106 } }
    - { model: miscgear-pence, system: { quantity: 619 } }
