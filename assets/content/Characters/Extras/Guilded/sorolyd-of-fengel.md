...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 8 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 32 } }
...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-init, system: { masteryLevelBase: 20 } }
    ...
    - model: sohl-sohl-skill-lang
      ...
      system:
        masteryLevelBase: 59
    - { model: sohl-sohl-skill-eng, system: { masteryLevelBase: 40 } }
    - { model: sohl-sohl-skill-jewl, system: { masteryLevelBase: 8 } }
