...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 98 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 98 } }
...
Modifier to EyeColor of -25 (from 100) {Complexion=Pale, Species=Human}
