...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, system: { masteryLevel: 27 } }
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2597 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 27 } }
    - { model: skill-dge }
    - { model: skill-pysn }
    - { model: skill-ridg }
    ...
    - { model: skill-math, system: { masteryLevelBase: 65 } }
    - { model: miscgear-pence, system: { quantity: 2597 } }
