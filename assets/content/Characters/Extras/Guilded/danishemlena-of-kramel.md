...
sohl:
  ...
  items:
    ...
    - { model: skill-timb, system: { masteryLevelBase: 88 } }
    - { model: miscgear-pence, system: { quantity: 2035 } }
...
Modifier to EyeColor of -10 (from 33) {Complexion=Fair, Species=Human}
