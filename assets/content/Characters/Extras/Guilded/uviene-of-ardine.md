...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 21 } }
    ...
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 44 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 21 } }
    ...
    - { model: skill-timb, system: { masteryLevelBase: 44 } }
