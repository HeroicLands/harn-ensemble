...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: engineering, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: milling, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1014 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mill, system: { masteryLevelBase: 96 } }
    - { model: miscgear-pence, system: { quantity: 1014 } }
