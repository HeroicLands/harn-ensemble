...
hm3:
  ...
  items:
    ...
    - { shortcode: sling, type: skill, system: { masteryLevel: 10 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-slng, system: { masteryLevelBase: 10 } }
...
Modifier to HairColor of +25 (from 14) {Complexion=Fair, Species=Human}
