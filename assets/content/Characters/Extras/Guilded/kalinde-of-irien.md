...
hm3:
  ...
  items:
    ...
    - { shortcode: cookery, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: fishing, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 498 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-fish, system: { masteryLevelBase: 75 } }
    - { model: skill-herb, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 498 } }
