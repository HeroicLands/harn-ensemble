...
hm3:
  ...
  items:
    ...
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 16 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 16 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 681 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 16 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 50 } }
    - { model: miscgear-pence, system: { quantity: 681 } }
