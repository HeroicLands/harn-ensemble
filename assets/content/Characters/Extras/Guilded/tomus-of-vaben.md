...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 66 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 32 } }
    - { model: skill-cmcs, system: { masteryLevelBase: 45 } }
