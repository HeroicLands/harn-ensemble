...
sohl:
  ...
  items:
    ...
    - { model: skill-lock, system: { masteryLevelBase: 90 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 33 } }
    - { model: miscgear-pence, system: { quantity: 1252 } }
...
Modifier to HairColor of +25 (from 29) {Complexion=Fair, Species=Human}
