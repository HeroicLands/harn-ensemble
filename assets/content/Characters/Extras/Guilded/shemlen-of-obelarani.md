...
sohl:
  ...
  items:
    ...
    - model: sohl-sohl-skill-lang
      ...
      system:
        masteryLevelBase: 74
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 28 } }
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 112 } }
    - { model: sohl-sohl-skill-txtl, system: { masteryLevelBase: 66 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2503 } }
    ...
    - { model: sohl-sohl-miscgear-hidecow }
    - { model: sohl-sohl-miscgear-tndrbx }
    - { model: sohl-sohl-armorgear-LtCap }
    - { model: sohl-sohl-miscgear-hdwkkit }
    - { model: sohl-sohl-miscgear-hidelambsk }
    - { model: sohl-sohl-miscgear-hidesheep }
