...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2503 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 74
    - { model: mysticalability-alch, system: { masteryLevelBase: 28 } }
    - { model: skill-hide, system: { masteryLevelBase: 112 } }
    - { model: skill-txtl, system: { masteryLevelBase: 66 } }
    - { model: miscgear-pence, system: { quantity: 2503 } }
