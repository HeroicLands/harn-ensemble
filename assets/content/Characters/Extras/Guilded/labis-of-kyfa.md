...
sohl:
  ...
  items:
    ...
    - { model: skill-masn, system: { masteryLevelBase: 84 } }
    - { model: skill-math, system: { masteryLevelBase: 22 } }
    - { model: miscgear-pence, system: { quantity: 3079 } }
