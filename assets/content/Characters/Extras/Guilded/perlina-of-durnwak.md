...
hm3:
  ...
  items:
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 27 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 348 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 348 } }
...
Modifier to EyeColor of -25 (from 8) {Complexion=Pale, Species=Human}
