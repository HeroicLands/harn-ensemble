...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 39 } }
    ...
    - name: "Debt to Money Lender: Tamil of Rabenara for 257d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 39 } }
