...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 34 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 70 } }
    ...
    - name: "Debt to Money Lender: Lobir of Hosathaen for 42d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 34 } }
    - { model: skill-glas, system: { masteryLevelBase: 70 } }
...
Modifier to EyeColor of -25 (from 34) {Complexion=Pale, Species=Human}
