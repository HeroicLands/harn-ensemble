...
hm3:
  ...
  items:
    ...
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1360 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-tarot, system: { masteryLevelBase: 78 } }
    - { model: miscgear-pence, system: { quantity: 1360 } }
