...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 66 } }
    - { model: skill-herb, system: { masteryLevelBase: 60 } }
    - { model: skill-math, system: { masteryLevelBase: 52 } }
    - { model: miscgear-pence, system: { quantity: 645 } }
...
**Age**: 29
**Birthday**: 18 Larane 691
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 3rd child of 11
**Siblings**: ffFfMfFmmFF
**Parentage**: Orphan
...
Modifier to EyeColor of -10 (from 48) {Complexion=Fair, Species=Human}
