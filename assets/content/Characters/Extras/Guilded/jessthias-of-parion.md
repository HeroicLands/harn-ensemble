...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1262 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 96 } }
    - { model: skill-herb, system: { masteryLevelBase: 72 } }
    - { model: skill-math, system: { masteryLevelBase: 33 } }
    - { model: miscgear-pence, system: { quantity: 1262 } }
...
Modifier to EyeColor of +15 (from 100) {Complexion=Swarthy, Species=Human}
