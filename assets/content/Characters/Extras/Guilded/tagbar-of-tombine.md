...
hm3:
  ...
  items:
    ...
    - { shortcode: fletching, type: skill, system: { masteryLevel: 40 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1115 } }
