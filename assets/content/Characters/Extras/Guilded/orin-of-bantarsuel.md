...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 77 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 66 } }
    - { model: skill-glas, system: { masteryLevelBase: 77 } }
