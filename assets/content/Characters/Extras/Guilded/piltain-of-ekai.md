...
hm3:
  ...
  items:
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: stealth, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: club, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2007 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-stlth, system: { masteryLevelBase: 105 } }
    - { model: skill-srvl }
    - { model: skill-spirit }
    - { model: skill-swim }
    - { model: skill-thtcs }
    ...
    - { model: skill-lgdm, system: { masteryLevelBase: 102 } }
    - model: skill-lang
      name: Language, Unguilded
      system:
        masteryLevelBase: 70
    - { model: skill-lock, system: { masteryLevelBase: 84 } }
    - { model: miscgear-pence, system: { quantity: 2007 } }
...
Modifier to HairColor of -25 (from 55) {Complexion=Dark, Species=Human}
