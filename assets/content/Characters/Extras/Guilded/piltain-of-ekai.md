...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-stlth, system: { masteryLevelBase: 105 } }
    ...
    - { model: sohl-sohl-skill-lgdm, system: { masteryLevelBase: 102 } }
    - model: sohl-sohl-skill-lang
      name: Language, Unguilded
      system:
        masteryLevelBase: 70
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 84 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2007 } }
