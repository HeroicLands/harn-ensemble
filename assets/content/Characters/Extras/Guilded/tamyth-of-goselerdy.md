...
sohl:
  ...
  items:
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 84 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 77 } }
    - { model: miscgear-pence, system: { quantity: 438 } }
