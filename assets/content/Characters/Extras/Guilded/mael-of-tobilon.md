...
hm3:
  ...
  items:
    ...
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 9 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 494 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 9 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 20 } }
    - { model: miscgear-pence, system: { quantity: 494 } }
