...
hm3:
  ...
  items:
    ...
    - shortcode: language
      ...
      system:
        masteryLevel: 74
    - { shortcode: musician, type: skill, name: Flute (Musician), system: { masteryLevel: 77 } }
    - { shortcode: musician, type: skill, name: Harp (Musician), system: { masteryLevel: 44 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 285 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 74
    - { model: skill-musc, name: Lute (Musician), system: { masteryLevelBase: 66 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 94 } }
    - { model: miscgear-pence, system: { quantity: 285 } }
