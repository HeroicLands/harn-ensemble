...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 104 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 52 } }
    - { model: miscgear-pence, system: { quantity: 927 } }
...
Modifier to EyeColor of +25 (from 60) {Complexion=Dark, Species=Human}
