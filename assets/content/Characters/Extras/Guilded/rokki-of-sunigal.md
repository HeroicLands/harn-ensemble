...
hm3:
  ...
  items:
    ...
    - { shortcode: inkcraft, type: skill, system: { masteryLevel: 88 } }
    ...
    - shortcode: hidework
      ...
      system:
        masteryLevel: 60
    - { shortcode: pence, type: miscgear, system: { quantity: 960 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-hide
      ...
      system:
        masteryLevelBase: 60
    - { model: miscgear-pence, system: { quantity: 960 } }
