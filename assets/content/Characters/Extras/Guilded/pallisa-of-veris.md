...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-jewl, system: { masteryLevelBase: 42 } }
    - { model: sohl-sohl-skill-txtl, system: { masteryLevelBase: 99 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1022 } }
