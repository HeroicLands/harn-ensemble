...
hm3:
  ...
  items:
    ...
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 99 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1022 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 42 } }
    - { model: skill-txtl, system: { masteryLevelBase: 99 } }
    - { model: miscgear-pence, system: { quantity: 1022 } }
