...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 55 } }
    - { model: skill-jewl, system: { masteryLevelBase: 22 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 72 } }
    - { model: miscgear-pence, system: { quantity: 1990 } }
