...
hm3:
  ...
  items:
    ...
    - { shortcode: condition, type: skill, system: { masteryLevel: 35 } }
    ...
    - { shortcode: musician, type: skill, name: Lute (Musician), system: { masteryLevel: 66 } }
    - { shortcode: musician, type: skill, name: Lyre (Musician), system: { masteryLevel: 44 } }
    - { shortcode: musician, type: skill, name: Recorder (Musician), system: { masteryLevel: 55 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 6 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-musc, name: Recorder (Musician), system: { masteryLevelBase: 55 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 82 } }
    - { model: miscgear-pence, system: { quantity: 6 } }
...
Modifier to EyeColor of -25 (from 71) {Complexion=Pale, Species=Human}
