...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-musc, name: Recorder (Musician), system: { masteryLevelBase: 55 } }
    - { model: sohl-sohl-skill-script, name: Script(Lakaise), system: { masteryLevelBase: 82 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 6 } }
    ...
    - { model: sohl-sohl-miscgear-lute }
    - { model: sohl-sohl-miscgear-lyre }
