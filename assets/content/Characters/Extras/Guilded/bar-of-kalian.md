...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-eng, system: { masteryLevelBase: 78 } }
    - { model: sohl-sohl-skill-mill, system: { masteryLevelBase: 112 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1788 } }
