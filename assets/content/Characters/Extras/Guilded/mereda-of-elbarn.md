...
sohl:
  ...
  items:
    ...
    - { model: skill-smsh, system: { masteryLevelBase: 98 } }
    - { model: skill-shpw, system: { masteryLevelBase: 26 } }
    - { model: miscgear-pence, system: { quantity: 1105 } }
