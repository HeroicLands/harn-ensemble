...
sohl:
  ...
  items:
    ...
    - { model: skill-lock, system: { masteryLevelBase: 99 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 66 } }
    - { model: miscgear-pence, system: { quantity: 1741 } }
