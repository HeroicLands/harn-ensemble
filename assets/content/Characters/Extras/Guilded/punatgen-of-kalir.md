...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 80 } }
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1416 } }
    - { shortcode: pursebuckram, type: containergear }
    - { shortcode: RGlv, type: armorgear }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 80 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 98 } }
    - { model: skill-hide, system: { masteryLevelBase: 96 } }
    - { model: skill-jewl, system: { masteryLevelBase: 36 } }
    - { model: skill-txtl, system: { masteryLevelBase: 78 } }
    - { model: miscgear-pence, system: { quantity: 1416 } }
    - { model: containergear-pouchbuckram }
    - { model: armorgear-RGlv }
...
Modifier to HairColor of +25 (from 42) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 17) {Complexion=Fair, Species=Human}
