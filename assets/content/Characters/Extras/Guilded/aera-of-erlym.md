...
hm3:
  ...
  items:
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: piloting, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2070 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-math, system: { masteryLevelBase: 75 } }
    - { model: skill-pilt, system: { masteryLevelBase: 72 } }
    - { model: skill-smsh, system: { masteryLevelBase: 72 } }
    - { model: skill-shpw, system: { masteryLevelBase: 33 } }
    - { model: miscgear-pence, system: { quantity: 2070 } }
...
Modifier to HairColor of -25 (from 72) {Complexion=Dark, Species=Human}
