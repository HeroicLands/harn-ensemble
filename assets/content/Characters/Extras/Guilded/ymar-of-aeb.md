...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 40 } }
    - { model: skill-herb, system: { masteryLevelBase: 72 } }
    - { model: miscgear-pence, system: { quantity: 834 } }
