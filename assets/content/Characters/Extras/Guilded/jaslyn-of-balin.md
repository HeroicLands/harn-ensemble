...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: masonry, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 860 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 84 } }
    - { model: skill-masn, system: { masteryLevelBase: 96 } }
    - { model: skill-math, system: { masteryLevelBase: 45 } }
    - { model: miscgear-pence, system: { quantity: 860 } }
...
Modifier to AttributesAGL of +1 (from 17) {Frame=Light}

Modifier to AttributesAUR of +2 (from 9) {Sex=Female, Species=Human}

Modifier to EyeColor of +15 (from 80) {Complexion=Swarthy, Species=Human}
