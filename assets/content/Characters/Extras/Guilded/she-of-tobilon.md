...
hm3:
  ...
  items:
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 28 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lock, system: { masteryLevelBase: 96 } }
