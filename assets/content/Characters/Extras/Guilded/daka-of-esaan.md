...
hm3:
  ...
  items:
    ...
    - { shortcode: physician, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1060 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 96 } }
    - { model: skill-ridg }
    ...
    - { model: miscgear-pence, system: { quantity: 1060 } }
