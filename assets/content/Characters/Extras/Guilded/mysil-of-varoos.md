...
hm3:
  ...
  items:
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 774 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 70 } }
    - { model: miscgear-pence, system: { quantity: 774 } }
