...
hm3:
  ...
  items:
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 66 } }
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 50 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lgdm, system: { masteryLevelBase: 66 } }
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 63 } }
    - { model: skill-lock, system: { masteryLevelBase: 50 } }
