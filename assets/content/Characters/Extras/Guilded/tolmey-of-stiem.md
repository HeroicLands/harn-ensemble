...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-eng, system: { masteryLevelBase: 66 } }
    - { model: sohl-sohl-skill-jewl, system: { masteryLevelBase: 13 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 78 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2571 } }
