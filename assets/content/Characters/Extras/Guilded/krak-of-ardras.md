...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 51 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: fletching, type: skill, system: { masteryLevel: 68 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2537 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-fltch, system: { masteryLevelBase: 68 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 96 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 84 } }
    - { model: miscgear-pence, system: { quantity: 2537 } }
...
Modifier to HairColor of +25 (from 67) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 66) {Complexion=Fair, Species=Human}

One Leg Missing/Deformed reduces Agilty by half: -4

Modifier to StartingEquipment of +100 (from 89) {SocialClass=Serf}
