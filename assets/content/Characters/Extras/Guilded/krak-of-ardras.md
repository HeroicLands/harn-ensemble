...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-fltch, system: { masteryLevelBase: 68 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 96 } }
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 84 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2537 } }
