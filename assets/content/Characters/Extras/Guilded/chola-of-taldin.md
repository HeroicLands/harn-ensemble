...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, name: Lyre (Musician), system: { masteryLevel: 84 } }
    ...
    - name: "Debt to Money Lender: Karpan of Pord for 87d"
      type: miscgear
      data:
