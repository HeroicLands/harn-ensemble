...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-astr, system: { masteryLevelBase: 72 } }
    - { model: skill-math, system: { masteryLevelBase: 72 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 44 } }
