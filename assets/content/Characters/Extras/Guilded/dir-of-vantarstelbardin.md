...
sohl:
  ...
  items:
    ...
    - { model: skill-masn, system: { masteryLevelBase: 60 } }
    - { model: skill-math, system: { masteryLevelBase: 39 } }
    - { model: miscgear-pence, system: { quantity: 1241 } }
