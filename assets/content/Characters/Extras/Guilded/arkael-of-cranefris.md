...
hm3:
  ...
  items:
    ...
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 16 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 15 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 35 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 16 } }
    - { model: skill-timb, system: { masteryLevelBase: 35 } }
