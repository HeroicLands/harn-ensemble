...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: milling, type: skill, system: { masteryLevel: 108 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 45 } }
    - { model: skill-mill, system: { masteryLevelBase: 108 } }
