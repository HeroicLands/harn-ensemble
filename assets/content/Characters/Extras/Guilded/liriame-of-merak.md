...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-thro, system: { masteryLevelBase: 105 } }
    ...
    - { model: sohl-sohl-skill-script, name: Script(Lakaise), system: { masteryLevelBase: 102 } }
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 72 } }
    - { model: sohl-sohl-skill-jewl, system: { masteryLevelBase: 45 } }
    - { model: sohl-sohl-skill-txtl, system: { masteryLevelBase: 112 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1190 } }
