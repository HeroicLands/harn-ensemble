...
hm3:
  ...
  items:
    ...
    - { shortcode: throwing, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: script, type: skill, name: Script(Lakaise), system: { masteryLevel: 102 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1190 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 105 } }
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 102 } }
    - { model: skill-hide, system: { masteryLevelBase: 72 } }
    - { model: skill-jewl, system: { masteryLevelBase: 45 } }
    - { model: skill-txtl, system: { masteryLevelBase: 112 } }
    - { model: miscgear-pence, system: { quantity: 1190 } }
...
Modifier to EyeColor of -25 (from 7) {Complexion=Pale, Species=Human}
