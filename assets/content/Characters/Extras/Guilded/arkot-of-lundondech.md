...
hm3:
  ...
  items:
    ...
    - { shortcode: axe, type: skill, name: Handaxe (Axe), system: { masteryLevel: 75 } }
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2500 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pilt, system: { masteryLevelBase: 98 } }
    - { model: skill-smsh, system: { masteryLevelBase: 84 } }
    - { model: skill-shpw, system: { masteryLevelBase: 39 } }
    - { model: miscgear-pence, system: { quantity: 2500 } }
