...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-stlth, system: { masteryLevelBase: 91 } }
    ...
    - { model: sohl-sohl-skill-lgdm, system: { masteryLevelBase: 96 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1498 } }
