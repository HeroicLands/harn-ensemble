...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 26 } }
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1498 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-acro, system: { masteryLevelBase: 26 } }
    - { model: skill-lgdm, system: { masteryLevelBase: 96 } }
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 78 } }
    - { model: skill-lock, system: { masteryLevelBase: 60 } }
    - { model: miscgear-pence, system: { quantity: 1498 } }
...
Modifier to EyeColor of -25 (from 13) {Complexion=Pale, Species=Human}
