...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 44 } }
    ...
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 14 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 44 } }
