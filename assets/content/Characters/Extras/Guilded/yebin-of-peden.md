...
hm3:
  ...
  items:
    ...
    - { shortcode: brewing, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 105 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-brew, system: { masteryLevelBase: 45 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 90 } }
    - { model: skill-timb, system: { masteryLevelBase: 105 } }
