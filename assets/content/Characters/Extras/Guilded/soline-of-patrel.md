...
hm3:
  ...
  items:
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1098 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 74
    - { model: skill-lock, system: { masteryLevelBase: 54 } }
    - { model: miscgear-pence, system: { quantity: 1098 } }
