...
hm3:
  ...
  items:
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 91 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 112 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 112 } }
    - { model: skill-ridg }
