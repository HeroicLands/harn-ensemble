...
hm3:
  ...
  items:
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1890 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-law, system: { masteryLevelBase: 96 } }
    - { model: miscgear-pence, system: { quantity: 1890 } }
...
Modifier to HairColor of -25 (from 81) {Complexion=Dark, Species=Human}
