...
hm3:
  ...
  items:
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1669 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-fltch, system: { masteryLevelBase: 56 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 72 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 96 } }
    - { model: miscgear-pence, system: { quantity: 1669 } }
