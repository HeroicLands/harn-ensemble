...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 12 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 363 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 65 } }
    - { model: skill-jewl, system: { masteryLevelBase: 12 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 33 } }
    - { model: miscgear-pence, system: { quantity: 363 } }
