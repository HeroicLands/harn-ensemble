...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 96 } }
    - { model: sohl-sohl-skill-embl, system: { masteryLevelBase: 52 } }
    - { model: sohl-sohl-skill-herb, system: { masteryLevelBase: 39 } }
    - { model: sohl-sohl-skill-pfmy, system: { masteryLevelBase: 90 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1444 } }
