...
hm3:
  ...
  items:
    ...
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1075 } }
