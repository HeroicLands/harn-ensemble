...
hm3:
  ...
  items:
    ...
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 28 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1176 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1176 } }
