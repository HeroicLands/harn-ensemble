...
hm3:
  ...
  items:
    ...
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 27 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 414 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 414 } }
...
Modifier to StartingEquipment of +300 (from 87) {SocialClass=Guilded}
