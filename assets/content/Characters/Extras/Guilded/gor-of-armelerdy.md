...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 831 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 78 } }
    - { model: skill-embl, system: { masteryLevelBase: 84 } }
    - { model: skill-pfmy, system: { masteryLevelBase: 33 } }
    - { model: miscgear-pence, system: { quantity: 831 } }
