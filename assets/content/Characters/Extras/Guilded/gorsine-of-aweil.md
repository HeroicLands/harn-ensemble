...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 108 } }
    ...
    - { shortcode: club, type: skill, system: { masteryLevel: 60 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 108 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce }
    - { model: skill-dscr }
    ...
    - { model: skill-shpw, system: { masteryLevelBase: 44 } }
    - { model: miscgear-pence, system: { quantity: 1704 } }
...
Modifier to EyeColor of -10 (from 81) {Complexion=Fair, Species=Human}

One Ear Missing/Deaf mod to Hearing: -3

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +200 (from 67) {SocialClass=Unguilded}
