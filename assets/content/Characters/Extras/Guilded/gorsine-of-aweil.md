...
sohl:
  ...
  items:
    ...
    - { shortcode: clmb, type: skill, system: { masteryLevelBase: 108 } }
    ...
    - { shortcode: smsh, type: skill, system: { masteryLevelBase: 84 } }
    - { shortcode: shpw, type: skill, system: { masteryLevelBase: 44 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1704 } }
    ...
    - { shortcode: WxCvTunic, type: armorgear }
    - { shortcode: Kni, type: weapongear }
    - { shortcode: ankletgold, type: miscgear }
    - { shortcode: tndrbx, type: miscgear }
    - { shortcode: LtCap, type: armorgear }
