...
hm3:
  ...
  items:
    ...
    - { shortcode: mining, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2858 } }
...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 98 } }
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 84 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2858 } }
