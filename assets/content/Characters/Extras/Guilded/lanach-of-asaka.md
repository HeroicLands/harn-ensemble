...
hm3:
  ...
  items:
    ...
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 77 } }
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1661 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-law, system: { masteryLevelBase: 55 } }
    - { model: miscgear-pence, system: { quantity: 1661 } }
...
Modifier to EyeColor of +25 (from 19) {Complexion=Dark, Species=Human}
