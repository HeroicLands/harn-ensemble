...
hm3:
  ...
  items:
    ...
    - { shortcode: mining, type: skill, system: { masteryLevel: 85 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 954 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 954 } }
