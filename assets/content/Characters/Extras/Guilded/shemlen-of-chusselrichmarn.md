...
hm3:
  ...
  items:
    ...
    - { shortcode: initiative, type: skill, system: { masteryLevel: 85 } }
    ...
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2107 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2107 } }
...
Modifier to EyeColor of -25 (from 5) {Complexion=Pale, Species=Human}
