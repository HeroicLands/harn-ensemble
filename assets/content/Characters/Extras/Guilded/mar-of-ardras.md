...
hm3:
  ...
  items:
    ...
    - { shortcode: law, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 889 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-law, system: { masteryLevelBase: 72 } }
    - { model: miscgear-pence, system: { quantity: 889 } }
...
Modifier to EyeColor of -10 (from 23) {Complexion=Fair, Species=Human}
