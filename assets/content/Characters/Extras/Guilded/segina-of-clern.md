...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-eng, system: { masteryLevelBase: 72 } }
    - { model: sohl-sohl-skill-masn, system: { masteryLevelBase: 72 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 24 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2561 } }
