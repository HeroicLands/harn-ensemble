...
hm3:
  ...
  items:
    ...
    - { shortcode: masonry, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 85 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2561 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-masn, system: { masteryLevelBase: 72 } }
    - { model: skill-math, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 2561 } }
