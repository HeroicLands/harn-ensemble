...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1507 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1507 } }
...
Modifier to EyeColor of +15 (from 37) {Complexion=Swarthy, Species=Human}

Monochromasia mod to Eyesight: -1

157lbs weight resulted in +1 strength mod.

Modifier to StartingEquipment of +300 (from 69) {SocialClass=Guilded}
