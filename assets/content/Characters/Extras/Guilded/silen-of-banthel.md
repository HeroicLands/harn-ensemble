...
hm3:
  ...
  items:
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 78 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lock, system: { masteryLevelBase: 78 } }
...
Modifier to EyeColor of -25 (from 70) {Complexion=Pale, Species=Human}
