...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-attribute-elo, system: { scoreBase: 4 } }
    ...
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 105 } }
    ...
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 65 } }
    - { model: sohl-sohl-skill-embl, system: { masteryLevelBase: 112 } }
    - { model: sohl-sohl-skill-pfmy, system: { masteryLevelBase: 70 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 260 } }
