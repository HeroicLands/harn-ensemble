...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: milling, type: skill, system: { masteryLevel: 91 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 52 } }
    - { model: skill-mill, system: { masteryLevelBase: 91 } }
