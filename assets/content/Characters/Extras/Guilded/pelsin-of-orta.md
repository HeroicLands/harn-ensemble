...
sohl:
  ...
  items:
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 91 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 84 } }
    - { model: miscgear-pence, system: { quantity: 443 } }
...
One Leg Missing/Deformed reduces Agilty by half: -8
