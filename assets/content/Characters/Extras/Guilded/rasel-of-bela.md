...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 26 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 875 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 90 } }
    - { model: skill-jewl, system: { masteryLevelBase: 26 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 65 } }
    - { model: miscgear-pence, system: { quantity: 875 } }
