...
hm3:
  ...
  items:
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2206 } }
...
Modifier to StartingEquipment of +300 (from 31) {SocialClass=Guilded}
