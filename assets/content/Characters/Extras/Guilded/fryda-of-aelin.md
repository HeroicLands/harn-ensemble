...
hm3:
  ...
  items:
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 34 } }
    ...
    - name: "Debt to Money Lender: Pamjul of Lumede for 283d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 64 } }
