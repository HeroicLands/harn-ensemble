...
hm3:
  ...
  items:
    ...
    - shortcode: animalcraft
      ...
      system:
        masteryLevel: 96
    - { shortcode: hidework, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1813 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1813 } }
