...
hm3:
  ...
  items:
    ...
    - { shortcode: inkcraft, type: skill, system: { masteryLevel: 112 } }
    ...
    - shortcode: hidework
      ...
      system:
        masteryLevel: 84
    - { shortcode: pence, type: miscgear, system: { quantity: 1601 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-hide
      ...
      system:
        masteryLevelBase: 84
    - { model: miscgear-pence, system: { quantity: 1601 } }
