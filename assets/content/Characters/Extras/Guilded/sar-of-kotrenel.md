...
hm3:
  ...
  items:
    ...
    - { shortcode: cookery, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: fishing, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 10 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 45 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-herb, system: { masteryLevelBase: 10 } }
