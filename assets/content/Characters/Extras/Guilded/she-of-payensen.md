...
hm3:
  ...
  items:
    ...
    - { shortcode: lovecraft, type: skill, system: { masteryLevel: 108 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2057 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pysn }
    - { model: skill-ridg }
    - { model: skill-sing, system: { masteryLevelBase: 96 } }
    ...
    - { model: miscgear-pence, system: { quantity: 2057 } }
    ...
    - { model: miscgear-groomkit }
    - { model: miscgear-groomkitnob }
...
Modifier to StartingEquipment of +300 (from 92) {SocialClass=Guilded}
