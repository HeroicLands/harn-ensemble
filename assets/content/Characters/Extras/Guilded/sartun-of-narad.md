...
hm3:
  ...
  items:
    ...
    - { shortcode: acting, type: skill, system: { masteryLevel: 72 } }
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 55 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-musc, system: { masteryLevelBase: 55 } }
