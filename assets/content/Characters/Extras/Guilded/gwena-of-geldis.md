...
hm3:
  ...
  items:
    ...
    - { shortcode: acting, type: skill, system: { masteryLevel: 60 } }
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 56 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-musc, system: { masteryLevelBase: 56 } }
