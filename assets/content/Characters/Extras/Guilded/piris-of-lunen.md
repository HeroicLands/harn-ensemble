...
hm3:
  ...
  items:
    ...
    - { shortcode: inkcraft, type: skill, system: { masteryLevel: 91 } }
    ...
    - shortcode: hidework
      ...
      system:
        masteryLevel: 91
    - { shortcode: pence, type: miscgear, system: { quantity: 679 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-hide
      ...
      system:
        masteryLevelBase: 91
    - { model: miscgear-pence, system: { quantity: 679 } }
