...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-fish, system: { masteryLevelBase: 84 } }
    - { model: sohl-sohl-skill-pilt, system: { masteryLevelBase: 26 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 90 } }
    - { model: sohl-sohl-skill-shpw, system: { masteryLevelBase: 26 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 790 } }
