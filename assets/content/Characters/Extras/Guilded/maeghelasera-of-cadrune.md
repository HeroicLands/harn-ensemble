...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 790 } }
    ...
    - { shortcode: WxCvTunic, type: armorgear }
...
sohl:
  ...
  items:
    ...
    - { model: skill-smsh, system: { masteryLevelBase: 90 } }
    - { model: skill-shpw, system: { masteryLevelBase: 26 } }
    - { model: miscgear-pence, system: { quantity: 790 } }
...
Modifier to EyeColor of -10 (from 94) {Complexion=Fair, Species=Human}
