...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 72 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 352 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 72 } }
    - { model: skill-herb, system: { masteryLevelBase: 33 } }
    - { model: skill-math, system: { masteryLevelBase: 39 } }
    - { model: miscgear-pence, system: { quantity: 352 } }
...
**Age**: 26
**Birthday**: 22 Nolus 694
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 2nd child of 11
**Siblings**: MMmfMmFFmfm
**Parentage**: Offspring
...
Modifier to StartingEquipment of +100 (from 49) {SocialClass=Serf}
