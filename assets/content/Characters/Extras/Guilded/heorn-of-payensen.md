...
hm3:
  ...
  items:
    ...
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1225 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-shpw, system: { masteryLevelBase: 20 } }
    - { model: miscgear-pence, system: { quantity: 1225 } }
