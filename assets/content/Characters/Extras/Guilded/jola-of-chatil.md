...
hm3:
  ...
  items:
    ...
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 49 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 628 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 628 } }
...
Modifier to HairColor of +25 (from 20) {Complexion=Fair, Species=Human}
