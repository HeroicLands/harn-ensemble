...
hm3:
  ...
  items:
    ...
    - { shortcode: fletching, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 3355 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-fltch, system: { masteryLevelBase: 84 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 102 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 102 } }
    - { model: miscgear-pence, system: { quantity: 3355 } }
...
Modifier to EyeColor of +15 (from 6) {Complexion=Swarthy, Species=Human}
