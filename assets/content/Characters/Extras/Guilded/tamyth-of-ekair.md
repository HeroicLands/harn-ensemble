...
hm3:
  ...
  items:
    ...
    - { shortcode: embalming, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1274 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-embl, system: { masteryLevelBase: 104 } }
    - { model: skill-pfmy, system: { masteryLevelBase: 72 } }
    - { model: miscgear-pence, system: { quantity: 1274 } }
