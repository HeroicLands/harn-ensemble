...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Heartbow (Bow), system: { masteryLevel: 24 } }
    - { shortcode: dagger, type: skill, system: { masteryLevel: 33 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 871 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Heartbow (Bow), system: { masteryLevelBase: 24 } }
    ...
    - { model: miscgear-pence, system: { quantity: 871 } }
...
Modifier to StartingEquipment of +300 (from 72) {SocialClass=Guilded}
