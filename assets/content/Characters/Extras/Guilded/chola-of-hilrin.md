...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, name: Flute (Musician), system: { masteryLevel: 42 } }
    - { shortcode: musician, type: skill, name: Lute (Musician), system: { masteryLevel: 56 } }
    - { shortcode: musician, type: skill, name: Recorder (Musician), system: { masteryLevel: 42 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-musc, name: Recorder (Musician), system: { masteryLevelBase: 42 } }
