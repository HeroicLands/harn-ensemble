  ...
  items:
    ...
    - shortcode: language
      ...
      system:
        ...
        masteryLevel: 76
    - { shortcode: oratory, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 962 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 962 } }
...
Modifier to EyeColor of +15 (from 76) {Complexion=Swarthy, Species=Human}
