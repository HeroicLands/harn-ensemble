...
hm3:
  ...
  items:
    ...
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 575 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 44 } }
    - { model: miscgear-pence, system: { quantity: 575 } }
