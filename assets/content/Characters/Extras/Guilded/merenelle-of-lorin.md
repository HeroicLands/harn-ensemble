...
sohl:
  ...
  items:
    ...
    - { shortcode: mtlc, type: skill, system: { masteryLevelBase: 18 } }
    - { shortcode: smsh, type: skill, system: { masteryLevelBase: 20 } }
    - { shortcode: shpw, type: skill, system: { masteryLevelBase: 77 } }
    - { shortcode: timb, type: skill, system: { masteryLevelBase: 91 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 0 } }
