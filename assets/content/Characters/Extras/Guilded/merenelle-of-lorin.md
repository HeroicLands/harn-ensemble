...
hm3:
  ...
  items:
    ...
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 91 } }
    ...
    - name: "Debt to Money Lender: Barithan of Mykanthes for 317d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-shpw, system: { masteryLevelBase: 77 } }
    - { model: skill-timb, system: { masteryLevelBase: 91 } }
...
Modifier to EyeColor of +15 (from 98) {Complexion=Swarthy, Species=Human}
