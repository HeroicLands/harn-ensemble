...
hm3:
  ...
  items:
    ...
    - { shortcode: brewing, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: cookery, type: skill, system: { masteryLevel: 52 } }
    ...
    - name: "Debt to Money Lender: Tersil of Renel for 151d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-brew, system: { masteryLevelBase: 52 } }
