...
sohl:
  ...
  items:
    ...
    - { shortcode: cmcs, type: skill, system: { masteryLevelBase: 72 } }
    - { shortcode: glas, type: skill, system: { masteryLevelBase: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 700 } }
    ...
    - { shortcode: tndrbx, type: miscgear }
    - { shortcode: LtCap, type: armorgear }
    - { shortcode: beakergllg, type: containergear }
    - { shortcode: spoonpewte, type: miscgear }
    - { shortcode: tankardpew, type: miscgear }
    - { shortcode: vialglassm, type: containergear }
---
