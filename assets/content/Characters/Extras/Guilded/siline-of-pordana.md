...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 700 } }
...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-cmcs, system: { masteryLevelBase: 72 } }
    - { model: sohl-sohl-skill-glas, system: { masteryLevelBase: 72 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 700 } }
    ...
    - { model: sohl-sohl-containergear-vialglassm }
  system:
    body:
      structure:
        zones:
