...
sohl:
  ...
  items:
    ...
    - { model: skill-masn, system: { masteryLevelBase: 80 } }
    - { model: skill-math, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 3326 } }
