...
hm3:
  ...
  items:
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 91 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 623 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lock, system: { masteryLevelBase: 91 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 84 } }
    - { model: miscgear-pence, system: { quantity: 623 } }
