...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-thro, system: { masteryLevelBase: 96 } }
    ...
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 91 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 84 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 623 } }
