...
sohl:
  ...
  items:
    ...
    - { shortcode: thro, type: skill, system: { masteryLevelBase: 96 } }
    ...
    - { shortcode: lock, type: skill, system: { masteryLevelBase: 91 } }
    - { shortcode: mtlc, type: skill, system: { masteryLevelBase: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 623 } }
