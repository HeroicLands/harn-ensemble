...
hm3:
  ...
  items:
    ...
    - { shortcode: milling, type: skill, system: { masteryLevel: 48 } }
    ...
    - name: "Debt to Money Lender: Makan of Ewesarlin for 72d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-mill, system: { masteryLevelBase: 48 } }
...
**Age**: 21
**Birthday**: 27 Nolus 699
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 2nd child of 11
**Siblings**: MMMMffMFFFF
**Parentage**: Offspring
