...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 80 } }
...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-cmcs, system: { masteryLevelBase: 80 } }
    - { model: sohl-sohl-skill-glas, system: { masteryLevelBase: 33 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 304 } }
