...
hm3:
  ...
  items:
    ...
    - { shortcode: cookery, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: fishing, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 11 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 88 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1184 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook, system: { masteryLevelBase: 84 } }
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    ...
    - { model: skill-fish, system: { masteryLevelBase: 32 } }
    - { model: skill-herb, system: { masteryLevelBase: 11 } }
    - { model: miscgear-pence, system: { quantity: 1184 } }
...
Modifier to StartingEquipment of +300 (from 44) {SocialClass=Guilded}
