...
sohl:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Lakaise), system: { masteryLevelBase: 78 } }
    - { shortcode: alch, type: mysticalability, system: { masteryLevelBase: 60 } }
    - { shortcode: brew, type: skill, system: { masteryLevelBase: 60 } }
    - { shortcode: cmcs, type: skill, system: { masteryLevelBase: 24 } }
    - { shortcode: hide, type: skill, system: { masteryLevelBase: 24 } }
    - { shortcode: mtlc, type: skill, system: { masteryLevelBase: 55 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 671 } }
