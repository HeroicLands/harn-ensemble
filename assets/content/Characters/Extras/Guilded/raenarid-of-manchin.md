...
hm3:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Lakaise), system: { masteryLevel: 78 } }
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 671 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 78 } }
    - { model: mysticalability-alch, system: { masteryLevelBase: 60 } }
    - { model: skill-brew, system: { masteryLevelBase: 60 } }
    - { model: skill-cmcs, system: { masteryLevelBase: 24 } }
    - { model: skill-hide, system: { masteryLevelBase: 24 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 55 } }
    - { model: miscgear-pence, system: { quantity: 671 } }
...
Modifier to EyeColor of -25 (from 23) {Complexion=Pale, Species=Human}
