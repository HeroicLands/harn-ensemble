...
hm3:
  ...
  items:
    ...
    - { shortcode: astrology, type: skill, system: { masteryLevel: 91 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 27 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1629 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-astr, system: { masteryLevelBase: 91 } }
    - { model: skill-math, system: { masteryLevelBase: 96 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 96 } }
    - { model: miscgear-pence, system: { quantity: 1629 } }
...
Modifier to HairColor of -25 (from 94) {Complexion=Dark, Species=Human}
