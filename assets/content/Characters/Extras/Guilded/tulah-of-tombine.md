...
sohl:
  ...
  items:
    ...
    - { shortcode: astr, type: mysticalability, system: { masteryLevelBase: 91 } }
    - { shortcode: math, type: skill, system: { masteryLevelBase: 96 } }
    - { shortcode: tarot, type: mysticalability, system: { masteryLevelBase: 96 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1629 } }
