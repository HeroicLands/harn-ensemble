...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-astr, system: { masteryLevelBase: 91 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 96 } }
    - { model: sohl-sohl-mysticalability-tarot, system: { masteryLevelBase: 96 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1629 } }
