...
hm3:
  ...
  items:
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 167 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 90 } }
    - { model: miscgear-pence, system: { quantity: 167 } }
...
Modifier to EyeColor of -10 (from 15) {Complexion=Fair, Species=Human}
