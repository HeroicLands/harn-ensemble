...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Longbow (Bow), system: { masteryLevel: 22 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: spear, type: skill, system: { masteryLevel: 36 } }
    ...
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 77 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Longbow (Bow), system: { masteryLevelBase: 22 } }
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 77 } }
...
Modifier to StartingEquipment of +200 (from 39) {SocialClass=Unguilded}
