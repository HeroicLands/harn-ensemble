...
hm3:
  ...
  items:
    ...
    - { shortcode: physician, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1141 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 77 } }
    - { model: skill-ridg }
    ...
    - { model: miscgear-pence, system: { quantity: 1141 } }
