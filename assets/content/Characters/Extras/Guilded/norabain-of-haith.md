...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 49 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1051 } }
    ...
    - { shortcode: hidecow, type: miscgear }
    - { shortcode: tndrbx, type: miscgear }
    - { shortcode: LtCap, type: armorgear }
    - { shortcode: hideworkingkitportable, type: miscgear }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1051 } }
    ...
    - { model: miscgear-hidecow }
    - { model: miscgear-tndrbx }
    - { model: armorgear-LtCap }
    - { model: miscgear-hdwkkit }
    - { model: miscgear-hidelambsk }
