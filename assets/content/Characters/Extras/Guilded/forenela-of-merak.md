...
hm3:
  ...
  items:
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1722 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pilt, system: { masteryLevelBase: 70 } }
    - { model: skill-smsh, system: { masteryLevelBase: 70 } }
    - { model: skill-shpw, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 1722 } }
...
Modifier to EyeColor of -25 (from 1) {Complexion=Pale, Species=Human}

117lbs weight resulted in -2 strength mod.

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +200 (from 29) {SocialClass=Unguilded}
