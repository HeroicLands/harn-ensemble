...
hm3:
  ...
  items:
    ...
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 748 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-glas, system: { masteryLevelBase: 56 } }
    - { model: miscgear-pence, system: { quantity: 748 } }
