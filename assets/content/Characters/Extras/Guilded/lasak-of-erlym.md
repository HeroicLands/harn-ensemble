...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: masonry, type: skill, system: { masteryLevel: 63 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-masn, system: { masteryLevelBase: 63 } }
