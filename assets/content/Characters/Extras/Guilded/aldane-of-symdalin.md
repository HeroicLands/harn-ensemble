...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 93 } }
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 35 } }
    - { shortcode: milling, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 979 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 93 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 79 } }
    - { model: skill-agri, system: { masteryLevelBase: 45 } }
    - { model: skill-eng, system: { masteryLevelBase: 35 } }
    - { model: skill-mill, system: { masteryLevelBase: 104 } }
    - { model: miscgear-pence, system: { quantity: 979 } }
