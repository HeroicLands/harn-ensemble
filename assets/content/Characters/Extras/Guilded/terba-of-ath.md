...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: milling, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1698 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 33 } }
    - { model: skill-mill, system: { masteryLevelBase: 80 } }
    - { model: miscgear-pence, system: { quantity: 1698 } }
