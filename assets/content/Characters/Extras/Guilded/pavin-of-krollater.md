...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 91 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 91 } }
...
Modifier to EyeColor of +15 (from 85) {Complexion=Swarthy, Species=Human}
