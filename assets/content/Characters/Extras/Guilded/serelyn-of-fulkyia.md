...
hm3:
  ...
  items:
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 190 } }
