...
hm3:
  ...
  items:
    ...
    - { shortcode: inkcraft, type: skill, system: { masteryLevel: 99 } }
    ...
    - shortcode: hidework
      ...
      system:
        masteryLevel: 65
    - { shortcode: pence, type: miscgear, system: { quantity: 1561 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-hide
      ...
      system:
        masteryLevelBase: 65
    - { model: miscgear-pence, system: { quantity: 1561 } }
