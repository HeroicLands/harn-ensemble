...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 105 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 70 } }
    - { model: skill-glas, system: { masteryLevelBase: 105 } }
    ...
    - { model: containergear-beakergllg }
