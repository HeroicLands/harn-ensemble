...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 20 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 84 } }
    - { model: skill-glas, system: { masteryLevelBase: 20 } }
