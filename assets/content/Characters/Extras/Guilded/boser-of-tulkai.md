...
Modifier to HairColor of +25 (from 48) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 70) {Complexion=Fair, Species=Human}
...
Modifier to StartingEquipment of +300 (from 23) {SocialClass=Guilded}
