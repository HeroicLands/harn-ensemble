...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 25 } }
    ...
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 25 } }
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1346 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 84 } }
    - { model: miscgear-pence, system: { quantity: 1346 } }
...
Modifier to EyeColor of -25 (from 90) {Complexion=Pale, Species=Human}
