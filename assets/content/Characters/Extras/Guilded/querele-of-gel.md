...
hm3:
  ...
  items:
    ...
    - { shortcode: inkcraft, type: skill, system: { masteryLevel: 96 } }
    ...
    - shortcode: hidework
      ...
      system:
        masteryLevel: 78
    - { shortcode: pence, type: miscgear, system: { quantity: 873 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-hide
      ...
      system:
        masteryLevelBase: 78
    - { model: miscgear-pence, system: { quantity: 873 } }
