...
hm3:
  ...
  items:
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 68 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 857 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-tarot, system: { masteryLevelBase: 52 } }
    - { model: miscgear-pence, system: { quantity: 857 } }
