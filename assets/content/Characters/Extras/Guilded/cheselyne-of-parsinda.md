...
hm3:
  ...
  items:
    ...
    - { shortcode: milling, type: skill, system: { masteryLevel: 99 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1735 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mill, system: { masteryLevelBase: 99 } }
    - { model: miscgear-pence, system: { quantity: 1735 } }
