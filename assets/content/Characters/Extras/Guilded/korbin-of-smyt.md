...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 371 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 65 } }
    - { model: skill-glas, system: { masteryLevelBase: 52 } }
    - { model: miscgear-pence, system: { quantity: 371 } }
