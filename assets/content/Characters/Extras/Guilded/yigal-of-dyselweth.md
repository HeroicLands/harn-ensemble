...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 63 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 257 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 66 } }
    - { model: miscgear-pence, system: { quantity: 257 } }
