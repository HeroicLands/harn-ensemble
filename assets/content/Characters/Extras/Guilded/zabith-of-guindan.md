...
hm3:
  ...
  items:
    ...
    - { shortcode: inkcraft, type: skill, system: { masteryLevel: 65 } }
    ...
    - name: "Debt to Money Lender: Sar of Tobira for 10d"
      type: miscgear
      data:
...
Modifier to EyeColor of +15 (from 36) {Complexion=Swarthy, Species=Human}
