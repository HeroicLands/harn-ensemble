...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 94 } }
    - { model: skill-timb, system: { masteryLevelBase: 112 } }
    - { model: miscgear-pence, system: { quantity: 3137 } }
