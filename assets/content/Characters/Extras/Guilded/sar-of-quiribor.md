...
sohl:
  ...
  items:
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 98 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 48 } }
    - { model: miscgear-pence, system: { quantity: 319 } }
