...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, system: { masteryLevel: 84 } }
    ...
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 96 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-smsh, system: { masteryLevelBase: 96 } }
