...
hm3:
  ...
  items:
    ...
    - { shortcode: acrobatics, type: skill, system: { masteryLevel: 32 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-acro, system: { masteryLevelBase: 32 } }
...
Modifier to StartingEquipment of +200 (from 44) {SocialClass=Unguilded}
