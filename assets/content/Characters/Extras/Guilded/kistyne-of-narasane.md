...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-acro, system: { masteryLevelBase: 48 } }
    - { model: sohl-sohl-skill-lgdm, system: { masteryLevelBase: 112 } }
    - { model: sohl-sohl-skill-lang, name: "Language, Serf", system: { masteryLevelBase: 59 } }
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 40 } }
