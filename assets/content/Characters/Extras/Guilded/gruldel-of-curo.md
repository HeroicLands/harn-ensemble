...
sohl:
  ...
  items:
    ...
    - { model: skill-masn, system: { masteryLevelBase: 66 } }
    - { model: skill-math, system: { masteryLevelBase: 32 } }
    - { model: miscgear-pence, system: { quantity: 3757 } }
