...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: masonry, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 68 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 735 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 60 } }
    - { model: skill-masn, system: { masteryLevelBase: 90 } }
    - { model: skill-math, system: { masteryLevelBase: 26 } }
    - { model: miscgear-pence, system: { quantity: 735 } }
...
Modifier to HairColor of -25 (from 86) {Complexion=Dark, Species=Human}
