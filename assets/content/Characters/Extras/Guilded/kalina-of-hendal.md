...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-eng, system: { masteryLevelBase: 60 } }
    - { model: sohl-sohl-skill-masn, system: { masteryLevelBase: 90 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 26 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 735 } }
