...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 549 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-fish, system: { masteryLevelBase: 42 } }
    ...
    - { model: miscgear-pence, system: { quantity: 549 } }
...
Modifier to EyeColor of +25 (from 16) {Complexion=Dark, Species=Human}
