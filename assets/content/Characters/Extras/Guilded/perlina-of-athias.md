...
sohl:
  ...
  items:
    ...
    - model: sohl-sohl-skill-lang
      ...
      system:
        masteryLevelBase: 74
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 32 } }
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 108 } }
    - { model: sohl-sohl-skill-txtl, system: { masteryLevelBase: 39 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1038 } }
