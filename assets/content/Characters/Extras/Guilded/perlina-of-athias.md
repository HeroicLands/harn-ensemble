...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1038 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-hide, system: { masteryLevelBase: 108 } }
    - { model: skill-txtl, system: { masteryLevelBase: 39 } }
    - { model: miscgear-pence, system: { quantity: 1038 } }
