...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 80 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-hide, system: { masteryLevelBase: 60 } }
    - { model: skill-txtl, system: { masteryLevelBase: 80 } }
