...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-lgdm, system: { masteryLevelBase: 54 } }
    - { model: sohl-sohl-skill-lang, name: "Language, Serf", system: { masteryLevelBase: 61 } }
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 66 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 826 } }
