...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 27 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1011 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 72 } }
    - { model: miscgear-pence, system: { quantity: 1011 } }
