...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-pilt, system: { masteryLevelBase: 105 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 84 } }
    - { model: sohl-sohl-skill-shpw, system: { masteryLevelBase: 42 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1625 } }
