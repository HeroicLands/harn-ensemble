...
hm3:
  ...
  items:
    ...
    - { shortcode: sword, type: skill, name: Shortsword (Sword), system: { masteryLevel: 30 } }
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1625 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee, system: { masteryLevelBase: 30 } }
    - { model: skill-dge }
    - { model: skill-pysn }
    - { model: skill-ridg }
    ...
    - { model: skill-pilt, system: { masteryLevelBase: 105 } }
    - { model: skill-smsh, system: { masteryLevelBase: 84 } }
    - { model: skill-shpw, system: { masteryLevelBase: 42 } }
    - { model: miscgear-pence, system: { quantity: 1625 } }
...
Modifier to EyeColor of -25 (from 2) {Complexion=Pale, Species=Human}
