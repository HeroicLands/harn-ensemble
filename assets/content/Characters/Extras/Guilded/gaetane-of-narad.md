...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 72 } }
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1593 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1593 } }
