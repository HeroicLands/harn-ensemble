...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 893 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 54 } }
    - { model: skill-hide, system: { masteryLevelBase: 45 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 66 } }
    - { model: skill-timb, system: { masteryLevelBase: 66 } }
    - { model: miscgear-pence, system: { quantity: 893 } }
...
Modifier to EyeColor of +25 (from 87) {Complexion=Dark, Species=Human}
