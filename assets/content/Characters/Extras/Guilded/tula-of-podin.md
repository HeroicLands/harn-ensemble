...
hm3:
  ...
  items:
    ...
    - name: "Debt to Money Lender: Harlen of Trollater for 21d"
      type: miscgear
      data:
    ...
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 0 } }
    - { shortcode: pursebuckram, type: containergear }
    - { shortcode: CvCloak, type: armorgear }
    ...
    - { shortcode: Kni, type: weapongear }
    - { shortcode: backbagsmcanvas, type: containergear }
    - name: "Debt to Money Lender: Moskil of Pthesta for 428d"
      type: miscgear
      data:
        icon: sohl-none-icon-miscgear
      system:
...
sohl:
  ...
  items:
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 78 } }
...
**Age**: 22
**Birthday**: 11 Peonu 698
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 2nd child of 11
**Siblings**: MFFMFFmMFmF
...
Modifier to HairColor of -25 (from 34) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 49) {Complexion=Dark, Species=Human}
