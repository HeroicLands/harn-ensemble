...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 228 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 98 } }
    - { model: skill-herb, system: { masteryLevelBase: 48 } }
    - { model: skill-math, system: { masteryLevelBase: 55 } }
    - { model: miscgear-pence, system: { quantity: 228 } }
...
Modifier to EyeColor of +15 (from 67) {Complexion=Swarthy, Species=Human}
