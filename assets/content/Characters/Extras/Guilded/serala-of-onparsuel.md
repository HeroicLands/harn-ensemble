...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 75 } }
    ...
    - name: "Debt to Money Lender: Arbin of Amafa for 93d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 62
    - { model: skill-hide, system: { masteryLevelBase: 78 } }
    - { model: skill-txtl, system: { masteryLevelBase: 75 } }
