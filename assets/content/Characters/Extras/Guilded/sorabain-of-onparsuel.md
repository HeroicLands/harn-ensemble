...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 112 } }
    - { model: sohl-sohl-skill-embl, system: { masteryLevelBase: 52 } }
    - { model: sohl-sohl-skill-herb, system: { masteryLevelBase: 36 } }
    - { model: sohl-sohl-skill-pfmy, system: { masteryLevelBase: 104 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1745 } }
