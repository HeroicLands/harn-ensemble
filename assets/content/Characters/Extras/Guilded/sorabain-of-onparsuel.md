...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1745 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 112 } }
    - { model: skill-embl, system: { masteryLevelBase: 52 } }
    - { model: skill-herb, system: { masteryLevelBase: 36 } }
    - { model: skill-pfmy, system: { masteryLevelBase: 104 } }
    - { model: miscgear-pence, system: { quantity: 1745 } }
