...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-jewl, system: { masteryLevelBase: 78 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 75 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 101 } }
