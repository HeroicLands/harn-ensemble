...
hm3:
  ...
  items:
    ...
    - { shortcode: mining, type: skill, system: { masteryLevel: 34 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 101 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 75 } }
    - { model: miscgear-pence, system: { quantity: 101 } }
...
294lbs weight resulted in +6 strength mod.
