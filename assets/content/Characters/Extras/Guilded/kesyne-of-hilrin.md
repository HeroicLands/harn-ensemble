...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1997 } }
