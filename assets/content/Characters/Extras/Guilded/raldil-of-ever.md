...
sohl:
  ...
  items:
    ...
    - { shortcode: anmcft, type: skill, system: { masteryLevelBase: 72 } }
    - { shortcode: brew, type: skill, system: { masteryLevelBase: 44 } }
    - { shortcode: mtlc, type: skill, system: { masteryLevelBase: 27 } }
