...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-anmcft, system: { masteryLevelBase: 72 } }
    - { model: sohl-sohl-skill-brew, system: { masteryLevelBase: 44 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 27 } }
    - { model: sohl-sohl-skill-txtl, system: { masteryLevelBase: 28 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 483 } }
