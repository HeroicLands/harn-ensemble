...
hm3:
  ...
  items:
    ...
    - { shortcode: throwing, type: skill, system: { masteryLevel: 30 } }
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: brewing, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 27 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 483 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 30 } }
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 48 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 72 } }
    - { model: skill-brew, system: { masteryLevelBase: 44 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 27 } }
    - { model: skill-txtl, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 483 } }
...
Modifier to AttributesAGL of +2 (from 16) {Frame=Scant}

Modifier to HairColor of +25 (from 86) {Complexion=Fair, Species=Human}
