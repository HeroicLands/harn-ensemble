...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1790 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-hide, system: { masteryLevelBase: 77 } }
    - { model: skill-txtl, system: { masteryLevelBase: 60 } }
    - { model: miscgear-pence, system: { quantity: 1790 } }
...
Modifier to StartingEquipment of +300 (from 82) {SocialClass=Guilded}
