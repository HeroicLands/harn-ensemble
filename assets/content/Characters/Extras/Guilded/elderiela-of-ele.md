...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1125 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-hide, system: { masteryLevelBase: 80 } }
    - { model: skill-txtl, system: { masteryLevelBase: 65 } }
    - { model: miscgear-pence, system: { quantity: 1125 } }
...
Modifier to EyeColor of +15 (from 53) {Complexion=Swarthy, Species=Human}
