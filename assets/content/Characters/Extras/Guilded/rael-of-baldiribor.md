...
hm3:
  ...
  items:
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 3704 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-math, system: { masteryLevelBase: 105 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 56 } }
    - { model: miscgear-pence, system: { quantity: 3704 } }
...
Modifier to StartingEquipment of +400 (from 89) {SocialClass=Noble}
