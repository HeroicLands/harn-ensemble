...
hm3:
  ...
  items:
    ...
    - { shortcode: acting, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 15 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-musc, system: { masteryLevelBase: 15 } }
