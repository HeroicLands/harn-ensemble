...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 55 } }
    - { model: skill-embl, system: { masteryLevelBase: 28 } }
    - { model: skill-herb, system: { masteryLevelBase: 36 } }
    - { model: skill-pfmy, system: { masteryLevelBase: 66 } }
