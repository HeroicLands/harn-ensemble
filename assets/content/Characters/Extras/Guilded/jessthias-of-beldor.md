...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 77 } }
    - { model: skill-herb, system: { masteryLevelBase: 77 } }
    - { model: skill-math, system: { masteryLevelBase: 33 } }
    - { model: miscgear-pence, system: { quantity: 1296 } }
...
Modifier to HairColor of -25 (from 78) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 63) {Complexion=Dark, Species=Human}

Parastites cause special penalty to Rhetoric and Lovecraft until cured.

166lbs weight resulted in +1 strength mod.

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +300 (from 56) {SocialClass=Guilded}
