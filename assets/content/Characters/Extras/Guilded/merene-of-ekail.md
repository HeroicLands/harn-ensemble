...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Noble", system: { masteryLevel: 84 } }
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1376 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 84 } }
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 52 } }
    - { model: miscgear-pence, system: { quantity: 1376 } }
...
Modifier to HairColor of +25 (from 5) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 92) {Complexion=Fair, Species=Human}

122lbs weight resulted in -2 strength mod.

Scant frame resulted in +2 agility mod.

Modifier to StartingEquipment of +400 (from 15) {SocialClass=Noble}
