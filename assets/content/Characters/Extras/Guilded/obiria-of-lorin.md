...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 470 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-herb, system: { masteryLevelBase: 72 } }
    - { model: skill-pfmy, system: { masteryLevelBase: 105 } }
    - { model: miscgear-pence, system: { quantity: 470 } }
