...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 65 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 20 } }
    - { model: skill-hide, system: { masteryLevelBase: 50 } }
    - { model: skill-txtl, system: { masteryLevelBase: 65 } }
    - { model: miscgear-pence, system: { quantity: 389 } }
