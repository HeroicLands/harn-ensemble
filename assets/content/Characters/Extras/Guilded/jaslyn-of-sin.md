...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 10 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2681 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 78
    - { model: skill-eng, system: { masteryLevelBase: 56 } }
    - { model: skill-jewl, system: { masteryLevelBase: 10 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 60 } }
    - { model: miscgear-pence, system: { quantity: 2681 } }
...
Modifier to HairColor of -25 (from 8) {Complexion=Dark, Species=Human}
