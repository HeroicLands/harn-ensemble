...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 48 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2511 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2511 } }
