...
Modifier to EyeColor of -10 (from 50) {Complexion=Fair, Species=Human}

Monochromasia mod to Eyesight: -3

108lbs weight resulted in -3 strength mod.

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +200 (from 57) {SocialClass=Unguilded}
