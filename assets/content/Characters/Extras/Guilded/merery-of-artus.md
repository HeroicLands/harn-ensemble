...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-acro, system: { masteryLevelBase: 27 } }
    ...
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 77 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 840 } }
