...
hm3:
  ...
  items:
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 840 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lock, system: { masteryLevelBase: 77 } }
    - { model: miscgear-pence, system: { quantity: 840 } }
...
Modifier to EyeColor of +25 (from 80) {Complexion=Dark, Species=Human}
