...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-sing, system: { masteryLevelBase: 88 } }
    ...
    - { model: sohl-sohl-skill-musc, name: Pipes (Musician), system: { masteryLevelBase: 27 } }
    - { model: sohl-sohl-skill-script, name: Script(Lakaise), system: { masteryLevelBase: 81 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 856 } }
