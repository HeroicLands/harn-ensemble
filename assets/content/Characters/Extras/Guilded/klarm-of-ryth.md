...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-pilt, system: { masteryLevelBase: 88 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 105 } }
    - { model: sohl-sohl-skill-shpw, system: { masteryLevelBase: 33 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2663 } }
    - { model: sohl-sohl-containergear-pouchbuckram }
    - { model: sohl-sohl-armorgear-LtCBoot }
    - { model: sohl-sohl-armorgear-CvCloak }
    - { model: sohl-sohl-armorgear-SlsCloak }
