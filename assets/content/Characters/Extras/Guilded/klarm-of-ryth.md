...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 65 } }
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 88 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2663 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pilt, system: { masteryLevelBase: 88 } }
    - { model: skill-smsh, system: { masteryLevelBase: 105 } }
    - { model: skill-shpw, system: { masteryLevelBase: 33 } }
    - { model: miscgear-pence, system: { quantity: 2663 } }
