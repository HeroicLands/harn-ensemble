...
hm3:
  ...
  items:
    ...
    - { shortcode: singing, type: skill, system: { masteryLevel: 15 } }
    ...
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 744 } }
    ...
    - { shortcode: SlsTunic, type: armorgear }
...
sohl:
  ...
  items:
    ...
    - { model: attribute-elo, system: { scoreBase: 4 } }
    ...
    - { model: skill-pysn }
    - { model: skill-ridg }
    - { model: skill-sing, system: { masteryLevelBase: 15 } }
    ...
    - { model: skill-shpw, system: { masteryLevelBase: 98 } }
    - { model: skill-timb, system: { masteryLevelBase: 77 } }
    - { model: miscgear-pence, system: { quantity: 744 } }
