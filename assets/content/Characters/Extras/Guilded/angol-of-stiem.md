...
hm3:
  ...
  items:
    ...
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 716 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-tarot, system: { masteryLevelBase: 66 } }
    - { model: miscgear-pence, system: { quantity: 716 } }
