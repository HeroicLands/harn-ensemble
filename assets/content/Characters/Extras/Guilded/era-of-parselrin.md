...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 33 } }
    ...
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 66 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 77 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 66 } }
