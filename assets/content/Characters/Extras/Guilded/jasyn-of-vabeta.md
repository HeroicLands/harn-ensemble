...
hm3:
  ...
  items:
    ...
    - { shortcode: club, type: skill, system: { masteryLevel: 112 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1849 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1849 } }
...
Modifier to HairColor of -25 (from 96) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 83) {Complexion=Dark, Species=Human}
