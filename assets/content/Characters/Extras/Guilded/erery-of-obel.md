...
sohl:
  ...
  items:
    ...
    - { model: skill-embl, system: { masteryLevelBase: 98 } }
    - { model: skill-pfmy, system: { masteryLevelBase: 78 } }
    - { model: miscgear-pence, system: { quantity: 947 } }
