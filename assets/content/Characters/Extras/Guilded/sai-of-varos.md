...
sohl:
  ...
  items:
    ...
    - { shortcode: pilt, type: skill, system: { masteryLevelBase: 96 } }
    - { shortcode: smsh, type: skill, system: { masteryLevelBase: 50 } }
    - { shortcode: shpw, type: skill, system: { masteryLevelBase: 24 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1600 } }
