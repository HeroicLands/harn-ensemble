...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-pilt, system: { masteryLevelBase: 96 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 50 } }
    - { model: sohl-sohl-skill-shpw, system: { masteryLevelBase: 24 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1600 } }
