...
hm3:
  ...
  items:
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1600 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pilt, system: { masteryLevelBase: 96 } }
    - { model: skill-smsh, system: { masteryLevelBase: 50 } }
    - { model: skill-shpw, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 1600 } }
