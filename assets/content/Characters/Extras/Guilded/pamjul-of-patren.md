...
hm3:
  ...
  items:
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 63 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1030 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 63 } }
    - { model: miscgear-pence, system: { quantity: 1030 } }
