...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, name: Gittern (Musician), system: { masteryLevel: 39 } }
    - { shortcode: musician, type: skill, name: Harp (Musician), system: { masteryLevel: 65 } }
    - { shortcode: musician, type: skill, name: Pipes (Musician), system: { masteryLevel: 39 } }
    - { shortcode: oratory, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: singing, type: skill, system: { masteryLevel: 78 } }
    ...
    - name: "Debt to Money Lender: Ashain of Gwen for 132d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-pysn }
    - { model: skill-ridg }
    - { model: skill-sing, system: { masteryLevelBase: 78 } }
    ...
    - { model: skill-musc, name: Pipes (Musician), system: { masteryLevelBase: 39 } }
...
**Age**: 29
**Birthday**: 17 Nolus 691
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 3rd child of 11
**Siblings**: mmFMMMFfFFF
**Parentage**: Offspring
...
Modifier to HairColor of -25 (from 3) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 79) {Complexion=Dark, Species=Human}
