...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1111 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 52 } }
    - { model: skill-glas, system: { masteryLevelBase: 104 } }
    - { model: miscgear-pence, system: { quantity: 1111 } }
