...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-cmcs, system: { masteryLevelBase: 52 } }
    - { model: sohl-sohl-skill-glas, system: { masteryLevelBase: 104 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1111 } }
