...
hm3:
  ...
  items:
    ...
    - { shortcode: cookery, type: skill, system: { masteryLevel: 88 } }
    - { shortcode: fishing, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 13 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 895 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook, system: { masteryLevelBase: 88 } }
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    ...
    - { model: skill-fish, system: { masteryLevelBase: 56 } }
    - { model: skill-herb, system: { masteryLevelBase: 13 } }
    - { model: miscgear-pence, system: { quantity: 895 } }
