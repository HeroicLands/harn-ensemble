...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 772 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-herb, system: { masteryLevelBase: 66 } }
    - { model: miscgear-pence, system: { quantity: 772 } }
...
Modifier to HairColor of +25 (from 8) {Complexion=Fair, Species=Human}
