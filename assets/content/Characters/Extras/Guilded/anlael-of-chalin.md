...
sohl:
  ...
  items:
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 72 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 66 } }
    - { model: miscgear-pence, system: { quantity: 57 } }
...
Modifier to StartingEquipment of +200 (from 96) {SocialClass=Unguilded}
