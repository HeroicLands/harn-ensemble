...
hm3:
  ...
  items:
    ...
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 347 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1685 } }
    - { shortcode: pursebuckram, type: containergear }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 40 } }
    - { model: skill-txtl, system: { masteryLevelBase: 60 } }
    - { model: miscgear-pence, system: { quantity: 1685 } }
...
Modifier to HairColor of +25 (from 32) {Complexion=Fair, Species=Human}
