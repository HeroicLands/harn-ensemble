...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: engineering, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: milling, type: skill, system: { masteryLevel: 70 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mill, system: { masteryLevelBase: 70 } }
