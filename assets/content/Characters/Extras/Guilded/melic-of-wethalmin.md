...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-pysn, system: { masteryLevelBase: 104 } }
    ...
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 45 } }
    - { model: sohl-sohl-skill-herb, system: { masteryLevelBase: 72 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1449 } }
