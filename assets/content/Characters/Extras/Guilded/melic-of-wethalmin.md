...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1449 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn, system: { masteryLevelBase: 104 } }
    - { model: skill-ridg }
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 45 } }
    - { model: skill-herb, system: { masteryLevelBase: 72 } }
    - { model: miscgear-pence, system: { quantity: 1449 } }
