...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-cmcs, system: { masteryLevelBase: 55 } }
    - { model: sohl-sohl-skill-glas, system: { masteryLevelBase: 88 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1242 } }
