...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 88 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1242 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 55 } }
    - { model: skill-glas, system: { masteryLevelBase: 88 } }
    - { model: miscgear-pence, system: { quantity: 1242 } }
    ...
    - { model: containergear-vialglassm }
  system:
    body:
      structure:
        zones:
