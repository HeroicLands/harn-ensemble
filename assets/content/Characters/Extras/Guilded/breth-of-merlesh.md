...
hm3:
  ...
  items:
    ...
    - { shortcode: brewing, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1001 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-brew, system: { masteryLevelBase: 108 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 70 } }
    - { model: skill-txtl, system: { masteryLevelBase: 98 } }
    - { model: miscgear-pence, system: { quantity: 1001 } }
...
Modifier to EyeColor of +25 (from 32) {Complexion=Dark, Species=Human}
