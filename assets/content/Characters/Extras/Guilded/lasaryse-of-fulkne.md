...
hm3:
  ...
  items:
    ...
    - { shortcode: piloting, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1310 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pilt, system: { masteryLevelBase: 75 } }
    - { model: skill-smsh, system: { masteryLevelBase: 72 } }
    - { model: skill-shpw, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 1310 } }
