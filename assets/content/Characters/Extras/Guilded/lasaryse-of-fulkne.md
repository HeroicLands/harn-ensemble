...
sohl:
  ...
  items:
    ...
    - { shortcode: pilt, type: skill, system: { masteryLevelBase: 75 } }
    - { shortcode: smsh, type: skill, system: { masteryLevelBase: 72 } }
    - { shortcode: shpw, type: skill, system: { masteryLevelBase: 28 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1310 } }
