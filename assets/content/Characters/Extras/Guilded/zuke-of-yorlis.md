...
hm3:
  ...
  items:
    ...
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 193 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-shpw, system: { masteryLevelBase: 65 } }
    - { model: skill-timb, system: { masteryLevelBase: 40 } }
    - { model: miscgear-pence, system: { quantity: 193 } }
