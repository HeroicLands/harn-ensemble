...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-shpw, system: { masteryLevelBase: 65 } }
    - { model: sohl-sohl-skill-timb, system: { masteryLevelBase: 40 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 193 } }
