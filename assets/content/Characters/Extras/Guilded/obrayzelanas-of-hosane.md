...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Jarinese), system: { masteryLevel: 72 } }
    - shortcode: language
      type: skill
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1129 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1129 } }
