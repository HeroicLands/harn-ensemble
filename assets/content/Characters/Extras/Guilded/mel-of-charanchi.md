...
hm3:
  ...
  items:
    ...
    - { shortcode: astrology, type: skill, system: { masteryLevel: 88 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 717 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-astr, system: { masteryLevelBase: 88 } }
    - { model: skill-math, system: { masteryLevelBase: 54 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 50 } }
    - { model: miscgear-pence, system: { quantity: 717 } }
