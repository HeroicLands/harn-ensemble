...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-astr, system: { masteryLevelBase: 88 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 54 } }
    - { model: sohl-sohl-mysticalability-tarot, system: { masteryLevelBase: 50 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 717 } }
