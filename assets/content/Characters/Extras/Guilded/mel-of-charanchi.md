...
sohl:
  ...
  items:
    ...
    - { shortcode: astr, type: mysticalability, system: { masteryLevelBase: 88 } }
    - { shortcode: math, type: skill, system: { masteryLevelBase: 54 } }
    - { shortcode: tarot, type: mysticalability, system: { masteryLevelBase: 50 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 717 } }
