...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-cmcs, system: { masteryLevelBase: 112 } }
    - { model: sohl-sohl-skill-glas, system: { masteryLevelBase: 42 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1688 } }
