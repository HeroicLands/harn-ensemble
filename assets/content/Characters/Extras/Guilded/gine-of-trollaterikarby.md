...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1688 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 112 } }
    - { model: skill-glas, system: { masteryLevelBase: 42 } }
    - { model: miscgear-pence, system: { quantity: 1688 } }
