...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 39 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 855 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 855 } }
