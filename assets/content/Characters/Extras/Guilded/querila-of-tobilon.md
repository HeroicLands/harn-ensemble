...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 95 } }
    ...
    - { model: sohl-sohl-skill-mill, system: { masteryLevelBase: 81 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 897 } }
