...
hm3:
  ...
  items:
    ...
    - { shortcode: milling, type: skill, system: { masteryLevel: 81 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 897 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mill, system: { masteryLevelBase: 81 } }
    - { model: miscgear-pence, system: { quantity: 897 } }
