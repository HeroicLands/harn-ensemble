...
hm3:
  ...
  items:
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: dagger, type: skill, system: { masteryLevel: 68 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1359 } }
...
sohl:
  ...
  items:
    ...
    - { shortcode: acro, type: skill, system: { masteryLevelBase: 48 } }
    - { shortcode: lgdm, type: skill, system: { masteryLevelBase: 98 } }
...
Modifier to EyeColor of -25 (from 25) {Complexion=Pale, Species=Human}
