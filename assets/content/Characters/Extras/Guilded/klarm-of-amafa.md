...
hm3:
  ...
  items:
    ...
    - { shortcode: singing, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 295 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pysn }
    - { model: skill-ridg }
    - { model: skill-sing, system: { masteryLevelBase: 98 } }
    ...
    - { model: miscgear-pence, system: { quantity: 295 } }
