...
sohl:
  ...
  items:
    ...
    - { shortcode: cmcs, type: skill, system: { masteryLevelBase: 33 } }
    - { shortcode: mtlc, type: skill, system: { masteryLevelBase: 40 } }
    - { shortcode: timb, type: skill, system: { masteryLevelBase: 27 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 177 } }
