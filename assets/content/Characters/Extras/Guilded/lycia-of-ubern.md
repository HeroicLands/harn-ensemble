...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 27 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 177 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 33 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 40 } }
    - { model: skill-timb, system: { masteryLevelBase: 27 } }
    - { model: miscgear-pence, system: { quantity: 177 } }
...
Modifier to HairColor of +25 (from 95) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 41) {Complexion=Fair, Species=Human}
