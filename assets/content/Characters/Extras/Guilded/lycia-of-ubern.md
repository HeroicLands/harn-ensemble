...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-cmcs, system: { masteryLevelBase: 33 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 40 } }
    - { model: sohl-sohl-skill-timb, system: { masteryLevelBase: 27 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 177 } }
