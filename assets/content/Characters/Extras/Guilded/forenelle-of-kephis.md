...
hm3:
  ...
  items:
    ...
    - { shortcode: brewing, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 85 } }
