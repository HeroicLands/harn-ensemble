...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 22 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 59
    - { model: mysticalability-alch, system: { masteryLevelBase: 22 } }
...
Modifier to AttributesAGL of +1 (from 3) {Frame=Light}
...
Modifier to StartingEquipment of +200 (from 36) {SocialClass=Unguilded}
