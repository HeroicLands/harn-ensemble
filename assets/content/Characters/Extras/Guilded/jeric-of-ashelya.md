...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 36 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: sling, type: skill, system: { masteryLevel: 24 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 923 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-slng, system: { masteryLevelBase: 24 } }
    ...
    - { model: miscgear-pence, system: { quantity: 923 } }
