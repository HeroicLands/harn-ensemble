...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1250 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 54 } }
    - { model: skill-embl, system: { masteryLevelBase: 80 } }
    - { model: skill-pfmy, system: { masteryLevelBase: 45 } }
    - { model: miscgear-pence, system: { quantity: 1250 } }
...
Modifier to EyeColor of -25 (from 41) {Complexion=Pale, Species=Human}
