...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 54 } }
    - { model: sohl-sohl-skill-embl, system: { masteryLevelBase: 80 } }
    - { model: sohl-sohl-skill-pfmy, system: { masteryLevelBase: 45 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1250 } }
