...
hm3:
  ...
  items:
    ...
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1400 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 112 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 65 } }
    - { model: miscgear-pence, system: { quantity: 1400 } }
