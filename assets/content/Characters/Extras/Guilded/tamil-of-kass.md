...
hm3:
  ...
  items:
    ...
    - { shortcode: inkcraft, type: skill, system: { masteryLevel: 56 } }
    ...
    - shortcode: hidework
      ...
      system:
        masteryLevel: 88
    - { shortcode: pence, type: miscgear, system: { quantity: 1227 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-hide
      ...
      system:
        masteryLevelBase: 88
    - { model: miscgear-pence, system: { quantity: 1227 } }
...
Modifier to HairColor of +25 (from 59) {Complexion=Fair, Species=Human}
