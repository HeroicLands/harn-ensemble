...
hm3:
  ...
  items:
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 104 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 32 } }
    - { model: miscgear-pence, system: { quantity: 104 } }
