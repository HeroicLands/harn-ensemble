...
hm3:
  ...
  items:
    ...
    - { shortcode: inkcraft, type: skill, system: { masteryLevel: 75 } }
    ...
    - shortcode: hidework
      ...
      system:
        masteryLevel: 88
    - { shortcode: pence, type: miscgear, system: { quantity: 1074 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-hide
      ...
      system:
        masteryLevelBase: 88
    - { model: miscgear-pence, system: { quantity: 1074 } }
