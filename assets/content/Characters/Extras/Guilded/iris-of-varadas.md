...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-eng, system: { masteryLevelBase: 21 } }
    - { model: sohl-sohl-skill-mill, system: { masteryLevelBase: 105 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 345 } }
