...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 21 } }
    - { shortcode: milling, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 345 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 21 } }
    - { model: skill-mill, system: { masteryLevelBase: 105 } }
    - { model: miscgear-pence, system: { quantity: 345 } }
