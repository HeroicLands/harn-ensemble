...
hm3:
  ...
  items:
    ...
    - { shortcode: singing, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 218 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pysn }
    - { model: skill-ridg }
    - { model: skill-sing, system: { masteryLevelBase: 91 } }
    ...
    - { model: miscgear-pence, system: { quantity: 218 } }
...
270lbs weight resulted in +5 strength mod.
