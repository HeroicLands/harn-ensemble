...
hm3:
  ...
  items:
    ...
    - { shortcode: bow, type: skill, name: Longbow (Bow), system: { masteryLevel: 39 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1725 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Longbow (Bow), system: { masteryLevelBase: 39 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1725 } }
...
Modifier to StartingEquipment of +200 (from 11) {SocialClass=Unguilded}
