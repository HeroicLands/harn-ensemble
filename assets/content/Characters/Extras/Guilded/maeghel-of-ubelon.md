...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 24 } }
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 49 } }
    - { model: sohl-sohl-skill-txtl, system: { masteryLevelBase: 54 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 899 } }
