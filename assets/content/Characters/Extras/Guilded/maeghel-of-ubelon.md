...
hm3:
  ...
  items:
    ...
    - { shortcode: condition, type: skill, system: { masteryLevel: 36 } }
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 899 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 54 } }
    - { model: miscgear-pence, system: { quantity: 899 } }
...
Modifier to HairColor of +25 (from 26) {Complexion=Fair, Species=Human}
