...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 88 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 72 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1225 } }
