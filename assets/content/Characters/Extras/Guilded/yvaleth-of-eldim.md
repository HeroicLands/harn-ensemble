...
hm3:
  ...
  items:
    ...
    - { shortcode: hidework, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 96 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-hide, system: { masteryLevelBase: 84 } }
    - { model: skill-jewl, system: { masteryLevelBase: 36 } }
    - { model: skill-txtl, system: { masteryLevelBase: 96 } }
