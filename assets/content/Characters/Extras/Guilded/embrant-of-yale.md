...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1729 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1729 } }
...
209lbs weight resulted in +3 strength mod.

Heavy frame resulted in -1 agility mod.

Modifier to StartingEquipment of +300 (from 61) {SocialClass=Guilded}
