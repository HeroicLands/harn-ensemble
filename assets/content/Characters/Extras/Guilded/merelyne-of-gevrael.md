...
hm3:
  ...
  items:
    ...
    - { shortcode: singing, type: skill, system: { masteryLevel: 108 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1705 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pysn }
    - { model: skill-ridg }
    - { model: skill-sing, system: { masteryLevelBase: 108 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1705 } }
