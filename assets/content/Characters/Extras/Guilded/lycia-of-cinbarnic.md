...
hm3:
  ...
  items:
    ...
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 80 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-timb, system: { masteryLevelBase: 80 } }
