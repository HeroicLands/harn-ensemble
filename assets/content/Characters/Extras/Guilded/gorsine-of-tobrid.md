...
hm3:
  ...
  items:
    ...
    - { shortcode: dagger, type: skill, name: Knife (Dagger), system: { masteryLevel: 30 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 330 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 330 } }
