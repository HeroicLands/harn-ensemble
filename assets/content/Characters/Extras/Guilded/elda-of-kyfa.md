...
hm3:
  ...
  items:
    ...
    - shortcode: animalcraft
      ...
      system:
        masteryLevel: 56
    - { shortcode: hidework, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2467 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 2467 } }
...
Modifier to EyeColor of +15 (from 26) {Complexion=Swarthy, Species=Human}

157lbs weight resulted in +1 strength mod.

Modifier to StartingEquipment of +400 (from 36) {SocialClass=Noble}
