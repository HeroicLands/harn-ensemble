...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 13 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1993 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-chrm }
    - { model: skill-clmb, system: { masteryLevelBase: 112 } }
    - { model: skill-cmd }
    - { model: skill-cook }
    - { model: skill-dnce }
    - { model: skill-dscr }
    ...
    - { model: skill-jump, system: { masteryLevelBase: 95 } }
    - { model: skill-melee }
    - { model: skill-dge }
    - { model: skill-pysn }
    - { model: skill-ridg }
    ...
    - { model: skill-eng, system: { masteryLevelBase: 77 } }
    - { model: skill-jewl, system: { masteryLevelBase: 13 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 52 } }
    - { model: miscgear-pence, system: { quantity: 1993 } }
...
Modifier to HairColor of +25 (from 61) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 2) {Complexion=Fair, Species=Human}
