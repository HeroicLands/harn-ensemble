...
hm3:
  ...
  items:
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 91 } }
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1255 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lgdm, system: { masteryLevelBase: 91 } }
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 63 } }
    - { model: skill-lock, system: { masteryLevelBase: 55 } }
    - { model: miscgear-pence, system: { quantity: 1255 } }
