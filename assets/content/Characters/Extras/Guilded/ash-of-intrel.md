...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-lgdm, system: { masteryLevelBase: 91 } }
    - { model: sohl-sohl-skill-lang, name: "Language, Serf", system: { masteryLevelBase: 63 } }
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 55 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1255 } }
