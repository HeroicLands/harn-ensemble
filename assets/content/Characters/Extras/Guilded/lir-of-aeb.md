...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-eng, system: { masteryLevelBase: 105 } }
    - { model: sohl-sohl-skill-masn, system: { masteryLevelBase: 105 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 48 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2198 } }
