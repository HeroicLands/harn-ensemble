...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: masonry, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2198 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 105 } }
    - { model: skill-masn, system: { masteryLevelBase: 105 } }
    - { model: skill-math, system: { masteryLevelBase: 48 } }
    - { model: miscgear-pence, system: { quantity: 2198 } }
