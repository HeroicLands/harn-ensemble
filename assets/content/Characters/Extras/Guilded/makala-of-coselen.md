...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Noble", system: { masteryLevel: 96 } }
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: hidework, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 18 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1518 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 96 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 83 } }
    - { model: mysticalability-alch, system: { masteryLevelBase: 52 } }
    - { model: skill-cmcs, system: { masteryLevelBase: 36 } }
    - { model: skill-hide, system: { masteryLevelBase: 54 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 18 } }
    - { model: skill-timb, system: { masteryLevelBase: 36 } }
    - { model: miscgear-pence, system: { quantity: 1518 } }
...
Modifier to StartingEquipment of +400 (from 52) {SocialClass=Noble}
