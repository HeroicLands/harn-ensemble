...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-lang, name: "Language, Noble", system: { masteryLevelBase: 96 } }
    ...
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 54 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 18 } }
    - { model: sohl-sohl-skill-timb, system: { masteryLevelBase: 36 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1518 } }
