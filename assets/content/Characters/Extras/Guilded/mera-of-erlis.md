...
sohl:
  ...
  items:
    ...
    - { model: skill-embl, system: { masteryLevelBase: 84 } }
    - { model: skill-pfmy, system: { masteryLevelBase: 84 } }
    - { model: miscgear-pence, system: { quantity: 1162 } }
