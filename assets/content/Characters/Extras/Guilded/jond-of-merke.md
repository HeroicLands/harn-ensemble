...
hm3:
  ...
  items:
    ...
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2372 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 48 } }
    - { model: miscgear-pence, system: { quantity: 2372 } }
