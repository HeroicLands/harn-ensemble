...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 18 } }
    - { model: sohl-sohl-skill-hide, system: { masteryLevelBase: 66 } }
    - { model: sohl-sohl-skill-txtl, system: { masteryLevelBase: 30 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 197 } }
