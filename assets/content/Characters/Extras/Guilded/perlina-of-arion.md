...
hm3:
  ...
  items:
    ...
    - { shortcode: acting, type: skill, system: { masteryLevel: 80 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 354 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 354 } }
...
Modifier to EyeColor of +25 (from 89) {Complexion=Dark, Species=Human}
