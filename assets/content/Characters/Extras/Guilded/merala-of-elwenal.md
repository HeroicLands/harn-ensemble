...
hm3:
  ...
  items:
    ...
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 78 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-shpw, system: { masteryLevelBase: 60 } }
...
Modifier to EyeColor of -25 (from 57) {Complexion=Pale, Species=Human}
