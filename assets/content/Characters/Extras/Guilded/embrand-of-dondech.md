...
hm3:
  ...
  items:
    ...
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 768 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 768 } }
