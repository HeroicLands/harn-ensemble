...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 91 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1330 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 91 } }
    - { model: skill-embl, system: { masteryLevelBase: 30 } }
    - { model: skill-herb, system: { masteryLevelBase: 39 } }
    - { model: skill-pfmy, system: { masteryLevelBase: 105 } }
    - { model: miscgear-pence, system: { quantity: 1330 } }
...
Modifier to EyeColor of -25 (from 85) {Complexion=Pale, Species=Human}
