...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, system: { masteryLevel: 35 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pysn }
    - { model: skill-ridg }
    - { model: skill-sing, system: { masteryLevelBase: 77 } }
    ...
    - { model: skill-musc, system: { masteryLevelBase: 35 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 78 } }
    - { model: miscgear-pence, system: { quantity: 1597 } }
...
Modifier to EyeColor of -25 (from 61) {Complexion=Pale, Species=Human}
