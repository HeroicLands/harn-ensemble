...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-sing, system: { masteryLevelBase: 77 } }
    ...
    - { model: sohl-sohl-skill-musc, system: { masteryLevelBase: 35 } }
    - { model: sohl-sohl-skill-script, name: Script(Lakaise), system: { masteryLevelBase: 78 } }
