...
hm3:
  ...
  items:
    ...
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 50 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-shpw, system: { masteryLevelBase: 52 } }
    - { model: skill-timb, system: { masteryLevelBase: 50 } }
