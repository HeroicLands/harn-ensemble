...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Guilded", system: { masteryLevel: 96 } }
    ...
    - { shortcode: mining, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1218 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Guilded", system: { masteryLevelBase: 96 } }
    - { model: skill-fish, system: { masteryLevelBase: 27 } }
    - { model: skill-herb, system: { masteryLevelBase: 36 } }
    - { model: miscgear-pence, system: { quantity: 1218 } }
...
Modifier to EyeColor of +15 (from 50) {Complexion=Swarthy, Species=Human}
