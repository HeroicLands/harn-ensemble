...
hm3:
  ...
  items:
    ...
    - { shortcode: inkcraft, type: skill, system: { masteryLevel: 80 } }
    ...
    - shortcode: hidework
      ...
      system:
        masteryLevel: 84
    - { shortcode: pence, type: miscgear, system: { quantity: 913 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-hide
      ...
      system:
        masteryLevelBase: 84
    - { model: miscgear-pence, system: { quantity: 913 } }
...
Modifier to EyeColor of -25 (from 87) {Complexion=Pale, Species=Human}
