...
hm3:
  ...
  items:
    ...
    - { shortcode: embalming, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 60 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-embl, system: { masteryLevelBase: 78 } }
    - { model: skill-pfmy, system: { masteryLevelBase: 60 } }
...
Modifier to AttributesAGL of -2 (from 16) {Frame=Massive}
