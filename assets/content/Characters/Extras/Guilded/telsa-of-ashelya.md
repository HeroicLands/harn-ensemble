...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-masn, system: { masteryLevelBase: 55 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 36 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 789 } }
