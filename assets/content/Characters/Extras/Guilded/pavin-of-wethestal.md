...
hm3:
  ...
  items:
    ...
    - { shortcode: initiative, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: cookery, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: fishing, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 14 } }
    - { shortcode: mining, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1465 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook, system: { masteryLevelBase: 108 } }
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr }
    ...
    - { model: skill-herb, system: { masteryLevelBase: 14 } }
    - { model: miscgear-pence, system: { quantity: 1465 } }
...
Modifier to StartingEquipment of +400 (from 19) {SocialClass=Noble}
