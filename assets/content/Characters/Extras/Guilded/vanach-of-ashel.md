...
hm3:
  ...
  items:
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 36 } }
    ...
    - name: "Debt to Money Lender: Adain of Lundondik for 114d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 36 } }
