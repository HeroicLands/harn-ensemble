...
hm3:
  ...
  items:
    ...
    - { shortcode: fishing, type: skill, system: { masteryLevel: 48 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 655 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 655 } }
...
Modifier to EyeColor of -25 (from 37) {Complexion=Pale, Species=Human}
