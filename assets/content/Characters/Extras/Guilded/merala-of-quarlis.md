...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: embalming, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: herblore, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2039 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 112 } }
    - { model: miscgear-pence, system: { quantity: 2039 } }
