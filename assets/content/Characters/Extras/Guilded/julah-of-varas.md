...
hm3:
  ...
  items:
    ...
    - { shortcode: milling, type: skill, system: { masteryLevel: 88 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mill, system: { masteryLevelBase: 88 } }
    - { model: miscgear-pence, system: { quantity: 530 } }
