...
hm3:
  ...
  items:
    ...
    - { shortcode: climbing, type: skill, system: { masteryLevel: 63 } }
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 27 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 96 } }
    - { model: skill-glas, system: { masteryLevelBase: 27 } }
