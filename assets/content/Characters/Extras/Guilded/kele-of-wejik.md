...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 49 } }
    ...
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 104 } }
    ...
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 3213 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 104 } }
    ...
    - { model: miscgear-pence, system: { quantity: 3213 } }
...
Modifier to HairColor of +25 (from 39) {Complexion=Fair, Species=Human}
