...
hm3:
  ...
  items:
    ...
    - { shortcode: ceramics, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 749 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmcs, system: { masteryLevelBase: 78 } }
    - { model: skill-glas, system: { masteryLevelBase: 72 } }
    - { model: miscgear-pence, system: { quantity: 749 } }
