...
hm3:
  ...
  items:
    ...
    - { shortcode: perfumery, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 753 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pfmy, system: { masteryLevelBase: 54 } }
    - { model: miscgear-pence, system: { quantity: 753 } }
