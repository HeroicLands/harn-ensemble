...
hm3:
  ...
  items:
    ...
    - shortcode: language
      ...
      system:
        masteryLevel: 62
    - { shortcode: musician, type: skill, name: Harp (Musician), system: { masteryLevel: 40 } }
    - { shortcode: musician, type: skill, name: Pipes (Musician), system: { masteryLevel: 40 } }
    - { shortcode: musician, type: skill, name: Recorder (Musician), system: { masteryLevel: 50 } }
    ...
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 318 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 62
    - { model: skill-musc, name: Recorder (Musician), system: { masteryLevelBase: 50 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 88 } }
    - { model: miscgear-pence, system: { quantity: 318 } }
