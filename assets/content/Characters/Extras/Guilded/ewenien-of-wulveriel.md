...
hm3:
  ...
  items:
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 63 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1257 } }
...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 80 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 63 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1257 } }
