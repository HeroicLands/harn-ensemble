...
hm3:
  ...
  items:
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 987 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-math, system: { masteryLevelBase: 66 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 55 } }
    - { model: miscgear-pence, system: { quantity: 987 } }
...
Modifier to EyeColor of +15 (from 66) {Complexion=Swarthy, Species=Human}
