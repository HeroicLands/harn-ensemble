...
hm3:
  ...
  items:
    ...
    - { shortcode: musician, type: skill, name: Pipes (Musician), system: { masteryLevel: 72 } }
    - { shortcode: musician, type: skill, name: Recorder (Musician), system: { masteryLevel: 48 } }
    ...
    - { shortcode: folklore, type: skill, system: { masteryLevel: 32 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr, system: { masteryLevelBase: 32 } }
    - { model: skill-guil }
    ...
    - { model: skill-musc, name: Recorder (Musician), system: { masteryLevelBase: 48 } }
