...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: Language(Ivinian), system: { masteryLevel: 33 } }
    - shortcode: language
      type: skill
      name: Language, Serf
      system:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 600 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 600 } }
