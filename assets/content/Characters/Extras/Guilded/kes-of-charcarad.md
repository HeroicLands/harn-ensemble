...
hm3:
  ...
  items:
    ...
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 104 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 2156 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 2156 } }
