...
hm3:
  ...
  items:
    ...
    - { shortcode: engineering, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 11 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-eng, system: { masteryLevelBase: 50 } }
    - { model: skill-jewl, system: { masteryLevelBase: 11 } }
