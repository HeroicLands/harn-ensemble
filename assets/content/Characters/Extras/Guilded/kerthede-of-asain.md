...
hm3:
  ...
  items:
    ...
    - { shortcode: shipwright, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 481 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-shpw, system: { masteryLevelBase: 66 } }
    - { model: skill-timb, system: { masteryLevelBase: 60 } }
    - { model: miscgear-pence, system: { quantity: 481 } }
...
Modifier to StartingEquipment of +300 (from 27) {SocialClass=Guilded}
