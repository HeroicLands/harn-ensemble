...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Noble", system: { masteryLevel: 90 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 90 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 106 } }
    - { model: mysticalability-astr, system: { masteryLevelBase: 96 } }
    - { model: skill-math, system: { masteryLevelBase: 72 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 65 } }
...
Modifier to StartingEquipment of +400 (from 39) {SocialClass=Noble}
