...
sohl:
  ...
  items:
    ...
    - { shortcode: lang, type: skill, name: "Language, Noble", system: { masteryLevelBase: 90 } }
    - { shortcode: script, type: skill, name: Script(Lakaise), system: { masteryLevelBase: 106 } }
    - { shortcode: astr, type: mysticalability, system: { masteryLevelBase: 96 } }
    - { shortcode: math, type: skill, system: { masteryLevelBase: 72 } }
    - { shortcode: tarot, type: mysticalability, system: { masteryLevelBase: 65 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1963 } }
