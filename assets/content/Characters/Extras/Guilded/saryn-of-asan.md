...
hm3:
  ...
  items:
    ...
    - { shortcode: condition, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: acting, type: skill, system: { masteryLevel: 98 } }
    ...
    - shortcode: language
      ...
      system:
        masteryLevel: 61
    - { shortcode: musician, type: skill, system: { masteryLevel: 65 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 61
    - { model: skill-musc, system: { masteryLevelBase: 65 } }
