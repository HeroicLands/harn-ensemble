...
hm3:
  ...
  items:
    ...
    - { shortcode: timbercraft, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: woodcraft, type: skill, system: { masteryLevel: 77 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 812 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-smsh, system: { masteryLevelBase: 44 } }
    - { model: skill-shpw, system: { masteryLevelBase: 66 } }
    - { model: skill-timb, system: { masteryLevelBase: 84 } }
    - { model: miscgear-pence, system: { quantity: 812 } }
