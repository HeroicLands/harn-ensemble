...
hm3:
  ...
  items:
    ...
    - { shortcode: inkcraft, type: skill, system: { masteryLevel: 66 } }
    ...
    - shortcode: hidework
      ...
      system:
        masteryLevel: 78
    - { shortcode: pence, type: miscgear, system: { quantity: 350 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-hide
      ...
      system:
        masteryLevelBase: 78
    - { model: miscgear-pence, system: { quantity: 350 } }
...
Modifier to EyeColor of -25 (from 27) {Complexion=Pale, Species=Human}
