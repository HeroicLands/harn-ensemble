...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 42 } }
    ...
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 85 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 51 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 14 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 42 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1776 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 56 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1776 } }
