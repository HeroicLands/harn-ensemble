...
hm3:
  ...
  items:
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 33 } }
    ...
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 13 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 13 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: healing, type: psionic, system: { masteryLevel: 46 } }
    - { shortcode: medium, type: psionic, system: { masteryLevel: 45 } }
    - { shortcode: prescience, type: psionic, system: { masteryLevel: 44 } }
    - { shortcode: transmutation, type: psionic, system: { masteryLevel: 44 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2082 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lock, system: { masteryLevelBase: 40 } }
    - { model: skill-math, system: { masteryLevelBase: 36 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 33 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 22 } }
    - { model: miscgear-pence, system: { quantity: 2082 } }
...
Modifier to EyeColor of -10 (from 26) {Complexion=Fair, Species=Human}

106lbs weight resulted in -3 strength mod.

Scant frame resulted in +2 agility mod.

Modifier to StartingEquipment of +100 (from 17) {SocialClass=Serf}
