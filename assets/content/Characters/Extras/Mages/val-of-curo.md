...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 33 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 30 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 45 } }
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 30 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1170 } }
