...
hm3:
  ...
  items:
    ...
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: mining, type: skill, name: Mineralogy (Mining), system: { masteryLevel: 45 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 12 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 14 } }
    - { shortcode: healing, type: psionic, system: { masteryLevel: 37 } }
    - { shortcode: mentalbolt, type: psionic, system: { masteryLevel: 70 } }
    - { shortcode: negation, type: psionic, system: { masteryLevel: 39 } }
    - { shortcode: pyrokinesis, type: psionic, system: { masteryLevel: 38 } }
    - { shortcode: sensitivity, type: psionic, system: { masteryLevel: 57 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1170 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 45 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 30 } }
    - { model: miscgear-pence, system: { quantity: 1170 } }
