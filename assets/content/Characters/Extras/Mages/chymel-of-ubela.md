...
hm3:
  ...
  items:
    ...
    - { shortcode: mining, type: skill, name: Mineralogy (Mining), system: { masteryLevel: 39 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 85 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: clairvoyance, type: psionic, system: { masteryLevel: 32 } }
    - { shortcode: healing, type: psionic, system: { masteryLevel: 33 } }
    - { shortcode: psychometry, type: psionic, system: { masteryLevel: 63 } }
    - { shortcode: pyrokinesis, type: psionic, system: { masteryLevel: 33 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 942 } }
...
sohl:
  ...
  items:
    ...
    - { model: attribute-end, system: { scoreBase: 4 } }
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 39 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 26 } }
    - { model: miscgear-pence, system: { quantity: 942 } }
...
Modifier to StartingEquipment of +200 (from 79) {SocialClass=Unguilded}
