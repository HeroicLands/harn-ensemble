...
hm3:
  ...
  items:
    ...
    - { shortcode: throwing, type: skill, system: { masteryLevel: 28 } }
    ...
    - { shortcode: mentalconflict, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: script, type: skill, name: Script(Lakaise), system: { masteryLevel: 88 } }
    - { shortcode: initiative, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 35 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 68 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 114 } }
    - { shortcode: clairvoyance, type: psionic, system: { masteryLevel: 64 } }
    - { shortcode: healing, type: psionic, system: { masteryLevel: 28 } }
    - { shortcode: medium, type: psionic, system: { masteryLevel: 48 } }
    - { shortcode: mentalbolt, type: psionic, system: { masteryLevel: 47 } }
    - { shortcode: negation, type: psionic, system: { masteryLevel: 26 } }
    - { shortcode: psychometry, type: psionic, system: { masteryLevel: 27 } }
    - { shortcode: sensitivity, type: psionic, system: { masteryLevel: 47 } }
    - { shortcode: telepathy, type: psionic, system: { masteryLevel: 30 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1119 } }
...
sohl:
  ...
  items:
    ...
    - { model: attribute-dex, system: { scoreBase: 4 } }
    ...
    - { model: skill-folklr, system: { masteryLevelBase: 55 } }
    - { model: skill-guil }
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 28 } }
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 88 } }
    - { model: skill-math, system: { masteryLevelBase: 42 } }
    - { model: mysticalability-runecft, system: { masteryLevelBase: 72 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 80 } }
    - { model: miscgear-pence, system: { quantity: 1119 } }
...
Modifier to AttributesAUR of +2 (from 17) {Sex=Female, Species=Human}

Modifier to EyeColor of +15 (from 44) {Complexion=Swarthy, Species=Human}

137lbs weight resulted in -1 strength mod.

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +100 (from 19) {SocialClass=Serf}
