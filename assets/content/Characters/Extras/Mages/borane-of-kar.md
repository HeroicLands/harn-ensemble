...
sohl:
  ...
  items:
    ...
    - { shortcode: dex, type: attribute, system: { scoreBase: 4 } }
    ...
    - { shortcode: folklr, type: skill, system: { masteryLevelBase: 55 } }
    ...
    - { shortcode: script, type: skill, name: Script(Lakaise), system: { masteryLevelBase: 88 } }
    - { shortcode: math, type: skill, system: { masteryLevelBase: 42 } }
    - { shortcode: runecft, type: mysticalability, system: { masteryLevelBase: 72 } }
    - { shortcode: tarot, type: mysticalability, system: { masteryLevelBase: 80 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1119 } }
