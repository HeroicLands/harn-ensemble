...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-attribute-dex, system: { scoreBase: 4 } }
    ...
    - { model: sohl-sohl-mysticalability-runecft, system: { masteryLevelBase: 72 } }
    - { model: sohl-sohl-mysticalability-tarot, system: { masteryLevelBase: 80 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1119 } }
