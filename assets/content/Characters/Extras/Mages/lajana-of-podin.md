...
hm3:
  ...
  items:
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: mining, type: skill, name: Mineralogy (Mining), system: { masteryLevel: 36 } }
    ...
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: sensitivity, type: psionic, system: { masteryLevel: 98 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1109 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lock, system: { masteryLevelBase: 52 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1109 } }
...
Modifier to EyeColor of +15 (from 11) {Complexion=Swarthy, Species=Human}
