...
hm3:
  ...
  items:
    ...
    - { shortcode: brewing, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: fishing, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: piloting, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 18 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 68 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-brew, system: { masteryLevelBase: 36 } }
    - { model: skill-fish, system: { masteryLevelBase: 36 } }
    - { model: skill-math, system: { masteryLevelBase: 26 } }
    - { model: skill-pilt, system: { masteryLevelBase: 30 } }
    - { model: skill-smsh, system: { masteryLevelBase: 18 } }
    - { model: miscgear-pence, system: { quantity: 311 } }
