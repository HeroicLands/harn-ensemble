...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-fish, system: { masteryLevelBase: 36 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 26 } }
    - { model: sohl-sohl-skill-pilt, system: { masteryLevelBase: 30 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 18 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 311 } }
