...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 606 } }
...
Modifier to AttributesAGL of -1 (from 16) {Frame=Heavy}
...
Modifier to StartingEquipment of +200 (from 98) {SocialClass=Unguilded}
