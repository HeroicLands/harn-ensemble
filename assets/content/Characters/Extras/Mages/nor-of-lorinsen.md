...
hm3:
  ...
  items:
    ...
    - { shortcode: folklore, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 78 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 15 } }
    - { shortcode: disembodiment, type: psionic, system: { masteryLevel: 34 } }
    - { shortcode: negation, type: psionic, system: { masteryLevel: 31 } }
    - { shortcode: telepathy, type: psionic, system: { masteryLevel: 33 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 995 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr, system: { masteryLevelBase: 40 } }
    - { model: skill-guil }
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 70
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 110 } }
    - { model: skill-glas, system: { masteryLevelBase: 30 } }
    - { model: skill-jewl, system: { masteryLevelBase: 30 } }
    - { model: skill-math, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 995 } }
...
Modifier to EyeColor of +15 (from 92) {Complexion=Swarthy, Species=Human}

Modifier to StartingEquipment of +200 (from 48) {SocialClass=Unguilded}
