...
hm3:
  ...
  items:
    ...
    - { shortcode: initiative, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 70 } }
    ...
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 95 } }
    - { shortcode: healing, type: psionic, system: { masteryLevel: 24 } }
    - { shortcode: medium, type: psionic, system: { masteryLevel: 50 } }
    - { shortcode: negation, type: psionic, system: { masteryLevel: 52 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 845 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 70 } }
    ...
    - { model: miscgear-pence, system: { quantity: 845 } }
...
Modifier to AttributesAGL of +1 (from 18) {Frame=Light}
