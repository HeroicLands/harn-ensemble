...
sohl:
  ...
  items:
    ...
    - { model: skill-srvl }
    - { model: skill-spirit }
    - { model: skill-swim, system: { masteryLevelBase: 78 } }
    - { model: skill-thtcs }
    ...
    - { model: skill-brew, system: { masteryLevelBase: 32 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1207 } }
...
Modifier to EyeColor of -25 (from 6) {Complexion=Pale, Species=Human}
