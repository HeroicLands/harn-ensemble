...
hm3:
  ...
  items:
    ...
    - { shortcode: neutral, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: mentalbolt, type: psionic, system: { masteryLevel: 28 } }
    - { shortcode: psychometry, type: psionic, system: { masteryLevel: 67 } }
    - { shortcode: pyrokinesis, type: psionic, system: { masteryLevel: 27 } }
    - { shortcode: sensitivity, type: psionic, system: { masteryLevel: 30 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 485 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 485 } }
