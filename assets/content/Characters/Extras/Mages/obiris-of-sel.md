...
hm3:
  ...
  items:
    ...
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 44 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-glas, system: { masteryLevelBase: 33 } }
    - { model: skill-jewl, system: { masteryLevelBase: 44 } }
    - { model: skill-math, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 534 } }
