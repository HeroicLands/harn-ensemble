...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-glas, system: { masteryLevelBase: 33 } }
    - { model: sohl-sohl-skill-jewl, system: { masteryLevelBase: 44 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 24 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 534 } }
