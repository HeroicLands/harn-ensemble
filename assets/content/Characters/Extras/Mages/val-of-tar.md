...
hm3:
  ...
  items:
    ...
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 84 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 732 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 732 } }
...
Modifier to EyeColor of +15 (from 57) {Complexion=Swarthy, Species=Human}
