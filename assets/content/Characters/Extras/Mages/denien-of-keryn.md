...
hm3:
  ...
  items:
    ...
    - { shortcode: lockcraft, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 52 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: mining, type: skill, name: Mineralogy (Mining), system: { masteryLevel: 22 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 16 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 16 } }
    - { shortcode: healing, type: psionic, system: { masteryLevel: 56 } }
    - { shortcode: mentalbolt, type: psionic, system: { masteryLevel: 60 } }
    - { shortcode: prescience, type: psionic, system: { masteryLevel: 57 } }
    - { shortcode: pyrokinesis, type: psionic, system: { masteryLevel: 40 } }
    - { shortcode: sensitivity, type: psionic, system: { masteryLevel: 55 } }
    - { shortcode: telekinesis, type: psionic, system: { masteryLevel: 38 } }
    - { shortcode: telepathy, type: psionic, system: { masteryLevel: 41 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3093 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lock, system: { masteryLevelBase: 56 } }
    ...
    - { model: miscgear-pence, system: { quantity: 3093 } }
    ...
    - { name: Amulet of Defeating Portals, type: miscgear, system: { value: 0, weight: 1 } }
    - { model: containergear-bgsmcvs }
    - { model: miscgear-tndrbx }
    - { model: miscgear-lkpickkit }
...
Modifier to EyeColor of -25 (from 83) {Complexion=Pale, Species=Human}
