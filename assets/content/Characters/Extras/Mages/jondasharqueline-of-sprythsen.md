...
hm3:
  ...
  items:
    ...
    - { shortcode: mentalconflict, type: skill, system: { masteryLevel: 80 } }
    ...
    - { shortcode: initiative, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: drawing, type: skill, system: { masteryLevel: 70 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 14 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 34 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 102 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1195 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 70 } }
    ...
    - { model: skill-math, system: { masteryLevelBase: 30 } }
    - { model: mysticalability-runecft, system: { masteryLevelBase: 80 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 80 } }
    - { model: miscgear-pence, system: { quantity: 1195 } }
...
Modifier to EyeColor of -25 (from 50) {Complexion=Pale, Species=Human}
