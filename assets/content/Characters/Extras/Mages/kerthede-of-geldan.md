...
hm3:
  ...
  items:
    ...
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: cookery, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 10 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 15 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 13 } }
    - { shortcode: clairvoyance, type: psionic, system: { masteryLevel: 54 } }
    - { shortcode: medium, type: psionic, system: { masteryLevel: 50 } }
    - { shortcode: transference, type: psionic, system: { masteryLevel: 53 } }
    - { shortcode: transmutation, type: psionic, system: { masteryLevel: 70 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2671 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 100 } }
    - { model: mysticalability-alch, system: { masteryLevelBase: 36 } }
    - { model: skill-math, system: { masteryLevelBase: 24 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 20 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 10 } }
    - { model: miscgear-pence, system: { quantity: 2671 } }
    ...
    - { name: Fork of Etosha, type: miscgear, system: { value: 0, weight: 1 } }
...
Modifier to EyeColor of +15 (from 16) {Complexion=Swarthy, Species=Human}

118lbs weight resulted in -2 strength mod.

Modifier to StartingEquipment of +100 (from 30) {SocialClass=Serf}
