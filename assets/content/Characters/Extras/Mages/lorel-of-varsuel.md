...
hm3:
  ...
  items:
    ...
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 13 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 26 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1324 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1324 } }
