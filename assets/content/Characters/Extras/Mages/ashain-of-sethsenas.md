...
hm3:
  ...
  items:
    ...
    - { shortcode: swimming, type: skill, system: { masteryLevel: 48 } }
    ...
    - { shortcode: brewing, type: skill, system: { masteryLevel: 30 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-srvl }
    - { model: skill-spirit }
    - { model: skill-swim, system: { masteryLevelBase: 48 } }
    - { model: skill-thtcs }
    ...
    - { model: skill-brew, system: { masteryLevelBase: 30 } }
    - { model: skill-fish, system: { masteryLevelBase: 33 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1437 } }
