...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-thro, system: { masteryLevelBase: 35 } }
    ...
    - { model: sohl-sohl-skill-script, name: Script(Lakaise), system: { masteryLevelBase: 97 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 34 } }
    - { model: sohl-sohl-mysticalability-runecft, system: { masteryLevelBase: 51 } }
