...
hm3:
  ...
  items:
    ...
    - { shortcode: throwing, type: skill, system: { masteryLevel: 35 } }
    ...
    - { shortcode: mentalconflict, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: oratory, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: singing, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 35 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 34 } }
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 51 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: mentalbolt, type: psionic, system: { masteryLevel: 25 } }
    - { shortcode: prescience, type: psionic, system: { masteryLevel: 25 } }
    - { shortcode: telekinesis, type: psionic, system: { masteryLevel: 55 } }
    - { shortcode: telepathy, type: psionic, system: { masteryLevel: 56 } }
    - { shortcode: transference, type: psionic, system: { masteryLevel: 26 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 695 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 35 } }
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 97 } }
    - { model: skill-math, system: { masteryLevelBase: 34 } }
    - { model: mysticalability-runecft, system: { masteryLevelBase: 51 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 64 } }
    - { model: miscgear-pence, system: { quantity: 695 } }
