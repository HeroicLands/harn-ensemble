...
hm3:
  ...
  items:
    ...
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 22 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 80 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1334 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-tarot, system: { masteryLevelBase: 45 } }
    - { model: miscgear-pence, system: { quantity: 1334 } }
...
Modifier to EyeColor of -10 (from 69) {Complexion=Fair, Species=Human}
