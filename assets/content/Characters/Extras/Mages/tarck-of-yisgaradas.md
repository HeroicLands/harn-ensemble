...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 45 } }
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 60 } }
    ...
    - { shortcode: tracking, type: skill, system: { masteryLevel: 34 } }
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 84 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: disembodiment, type: psionic, system: { masteryLevel: 67 } }
    - { shortcode: hex, type: psionic, system: { masteryLevel: 39 } }
    - { shortcode: medium, type: psionic, system: { masteryLevel: 42 } }
    - { shortcode: prescience, type: psionic, system: { masteryLevel: 67 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 680 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-trak, system: { masteryLevelBase: 34 } }
    - { model: miscgear-pence, system: { quantity: 680 } }
