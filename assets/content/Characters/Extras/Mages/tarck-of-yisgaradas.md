...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-anmcft, system: { masteryLevelBase: 30 } }
    ...
    - { model: sohl-sohl-skill-trak, system: { masteryLevelBase: 34 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 680 } }
