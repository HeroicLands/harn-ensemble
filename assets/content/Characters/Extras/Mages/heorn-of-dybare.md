...
hm3:
  ...
  items:
    ...
    - { shortcode: cookery, type: skill, system: { masteryLevel: 30 } }
    ...
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 68 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 195 } }
