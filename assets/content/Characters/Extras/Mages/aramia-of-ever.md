...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 60 } }
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 39 } }
    ...
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 17 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 14 } }
    - { shortcode: disembodiment, type: psionic, system: { masteryLevel: 31 } }
    - { shortcode: healing, type: psionic, system: { masteryLevel: 32 } }
    - { shortcode: mentalbolt, type: psionic, system: { masteryLevel: 38 } }
    - { shortcode: negation, type: psionic, system: { masteryLevel: 33 } }
    - { shortcode: pyrokinesis, type: psionic, system: { masteryLevel: 32 } }
    - { shortcode: telekinesis, type: psionic, system: { masteryLevel: 37 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1989 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1989 } }
    ...
    - { name: Artifactr of Anasiron, type: miscgear, system: { value: 0, weight: 1 } }
    - { name: Bag/Box of Indethan, type: miscgear, system: { value: 0, weight: 1 } }
...
Modifier to StartingEquipment of +200 (from 5) {SocialClass=Unguilded}
