...
hm3:
  ...
  items:
    ...
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: healing, type: psionic, system: { masteryLevel: 57 } }
    - { shortcode: medium, type: psionic, system: { masteryLevel: 27 } }
    - { shortcode: mentalbolt, type: psionic, system: { masteryLevel: 27 } }
    - { shortcode: psychometry, type: psionic, system: { masteryLevel: 58 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1056 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 60 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1056 } }
...
Modifier to EyeColor of -25 (from 64) {Complexion=Pale, Species=Human}
