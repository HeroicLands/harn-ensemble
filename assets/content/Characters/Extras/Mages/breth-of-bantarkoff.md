...
hm3:
  ...
  items:
    ...
    - { shortcode: swimming, type: skill, system: { masteryLevel: 75 } }
    ...
    - { shortcode: language, type: skill, name: "Language, Noble", system: { masteryLevel: 98 } }
    ...
    - { shortcode: brewing, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: fishing, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: piloting, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: clairvoyance, type: psionic, system: { masteryLevel: 78 } }
    - { shortcode: healing, type: psionic, system: { masteryLevel: 44 } }
    - { shortcode: hex, type: psionic, system: { masteryLevel: 41 } }
    - { shortcode: negation, type: psionic, system: { masteryLevel: 44 } }
    - { shortcode: prescience, type: psionic, system: { masteryLevel: 43 } }
    - { shortcode: transference, type: psionic, system: { masteryLevel: 43 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 3879 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dscr }
    - { model: skill-draw }
    - { model: skill-folklr, system: { masteryLevelBase: 60 } }
    - { model: skill-guil }
    ...
    - { model: skill-srvl }
    - { model: skill-spirit }
    - { model: skill-swim, system: { masteryLevelBase: 75 } }
    - { model: skill-thtcs }
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 98 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 106 } }
    - { model: skill-brew, system: { masteryLevelBase: 24 } }
    - { model: skill-fish, system: { masteryLevelBase: 39 } }
    - { model: skill-math, system: { masteryLevelBase: 64 } }
    - { model: skill-pilt, system: { masteryLevelBase: 26 } }
    - { model: skill-smsh, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 3879 } }
    ...
    - { model: miscgear-scribekit }
    - { model: miscgear-spoonpewte }
    - { model: containergear-wtrskin }
...
Modifier to EyeColor of -10 (from 4) {Complexion=Fair, Species=Human}

Modifier to StartingEquipment of +400 (from 30) {SocialClass=Noble}
