...
hm3:
  ...
  items:
    ...
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 17 } }
    ...
    - { shortcode: healing, type: psionic, system: { masteryLevel: 29 } }
    - { shortcode: hex, type: psionic, system: { masteryLevel: 74 } }
    - { shortcode: medium, type: psionic, system: { masteryLevel: 33 } }
    - { shortcode: mentalbolt, type: psionic, system: { masteryLevel: 29 } }
    - { shortcode: negation, type: psionic, system: { masteryLevel: 30 } }
    - { shortcode: prescience, type: psionic, system: { masteryLevel: 38 } }
    - { shortcode: pyrokinesis, type: psionic, system: { masteryLevel: 29 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1596 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-runecft, system: { masteryLevelBase: 108 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 64 } }
    - { model: miscgear-pence, system: { quantity: 1596 } }
    ...
    - { name: Jeweled Rod of Awe, type: miscgear, system: { value: 0, weight: 1 } }
...
Modifier to StartingEquipment of +100 (from 70) {SocialClass=Serf}
