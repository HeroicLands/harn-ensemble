...
hm3:
  ...
  items:
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: stealth, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: throwing, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: awareness, type: skill, system: { masteryLevel: 90 } }
    ...
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 30 } }
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 11 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 14 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 51 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2921 } }
...
Modifier to StartingEquipment of +200 (from 28) {SocialClass=Unguilded}
