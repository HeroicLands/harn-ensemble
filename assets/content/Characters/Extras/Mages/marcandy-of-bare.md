...
sohl:
  ...
  items:
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 13 } }
    - { model: miscgear-pence, system: { quantity: 2414 } }
...
Modifier to HairColor of -25 (from 28) {Complexion=Dark, Species=Human}
