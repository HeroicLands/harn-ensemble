...
hm3:
  ...
  items:
    ...
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: prescience, type: psionic, system: { masteryLevel: 35 } }
    - { shortcode: pyrokinesis, type: psionic, system: { masteryLevel: 37 } }
    - { shortcode: telekinesis, type: psionic, system: { masteryLevel: 42 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 891 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 891 } }
...
Modifier to EyeColor of -25 (from 46) {Complexion=Pale, Species=Human}

Light frame resulted in +1 agility mod.

Modifier to StartingEquipment of +100 (from 53) {SocialClass=Serf}
