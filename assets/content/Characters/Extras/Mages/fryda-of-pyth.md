...
hm3:
  ...
  items:
    ...
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 52 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2926 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 52 } }
    - { model: skill-math, system: { masteryLevelBase: 42 } }
    - { model: miscgear-pence, system: { quantity: 2926 } }
...
Modifier to StartingEquipment of +200 (from 26) {SocialClass=Unguilded}
