...
hm3:
  ...
  items:
    ...
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 105 } }
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 34 } }
    - { shortcode: runecraft, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: tarotry, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 80 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 24 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2770 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw, system: { masteryLevelBase: 44 } }
    - { model: skill-folklr, system: { masteryLevelBase: 80 } }
    - { model: skill-guil }
    - { model: skill-init, system: { masteryLevelBase: 70 } }
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 105 } }
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 109 } }
    - { model: skill-math, system: { masteryLevelBase: 34 } }
    - { model: mysticalability-runecft, system: { masteryLevelBase: 72 } }
    - { model: mysticalability-tarot, system: { masteryLevelBase: 64 } }
    - { model: miscgear-pence, system: { quantity: 2770 } }
...
Modifier to EyeColor of +15 (from 12) {Complexion=Swarthy, Species=Human}
