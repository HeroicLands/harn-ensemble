...
sohl:
  ...
  items:
    ...
    - { shortcode: script, type: skill, name: Script(Lakaise), system: { masteryLevelBase: 109 } }
    - { shortcode: math, type: skill, system: { masteryLevelBase: 34 } }
