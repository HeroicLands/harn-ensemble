...
hm3:
  ...
  items:
    ...
    - { shortcode: cookery, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 66 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 12 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 24 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 12 } }
...
Modifier to EyeColor of -25 (from 39) {Complexion=Pale, Species=Human}

264lbs weight resulted in +5 strength mod.
