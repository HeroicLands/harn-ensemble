...
hm3:
  ...
  items:
    ...
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 48 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1660 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 94 } }
    ...
    - { model: skill-trak, system: { masteryLevelBase: 44 } }
    - { model: miscgear-pence, system: { quantity: 1660 } }
...
Modifier to EyeColor of -25 (from 75) {Complexion=Pale, Species=Human}
