...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 44 } }
    ...
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 68 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 44 } }
