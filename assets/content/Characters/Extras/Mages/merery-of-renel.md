...
hm3:
  ...
  items:
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 48 } }
    ...
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 34 } }
    - { shortcode: clairvoyance, type: psionic, system: { masteryLevel: 38 } }
    - { shortcode: medium, type: psionic, system: { masteryLevel: 64 } }
    - { shortcode: mentalbolt, type: psionic, system: { masteryLevel: 40 } }
    - { shortcode: prescience, type: psionic, system: { masteryLevel: 38 } }
    - { shortcode: sensitivity, type: psionic, system: { masteryLevel: 38 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1687 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lgdm, system: { masteryLevelBase: 48 } }
    ...
    - { model: skill-jewl, system: { masteryLevelBase: 65 } }
    - { model: skill-math, system: { masteryLevelBase: 42 } }
    - { model: miscgear-pence, system: { quantity: 1687 } }
