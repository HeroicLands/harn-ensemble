...
hm3:
  ...
  items:
    ...
    - { shortcode: legerdemain, type: skill, system: { masteryLevel: 33 } }
    ...
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 44 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 26 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 14 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 13 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 941 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lgdm, system: { masteryLevelBase: 33 } }
    ...
    - { model: skill-glas, system: { masteryLevelBase: 44 } }
    - { model: skill-jewl, system: { masteryLevelBase: 33 } }
    - { model: skill-math, system: { masteryLevelBase: 26 } }
    - { model: miscgear-pence, system: { quantity: 941 } }
