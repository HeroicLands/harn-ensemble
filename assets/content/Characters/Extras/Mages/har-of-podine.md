...
sohl:
  ...
  items:
    ...
    - { shortcode: thro, type: skill, system: { masteryLevelBase: 77 } }
    ...
    - { shortcode: lgdm, type: skill, system: { masteryLevelBase: 39 } }
    ...
    - { shortcode: glas, type: skill, system: { masteryLevelBase: 36 } }
