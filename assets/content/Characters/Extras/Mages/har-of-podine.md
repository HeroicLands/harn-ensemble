...
hm3:
  ...
  items:
    ...
    - { shortcode: throwing, type: skill, system: { masteryLevel: 77 } }
    ...
    - { shortcode: glassworking, type: skill, system: { masteryLevel: 36 } }
    - { shortcode: jewelcraft, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 45 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 60 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-swim }
    - { model: skill-thtcs }
    - { model: skill-thro, system: { masteryLevelBase: 77 } }
    ...
    - { model: skill-lgdm, system: { masteryLevelBase: 39 } }
    ...
    - { model: skill-glas, system: { masteryLevelBase: 36 } }
...
192lbs weight resulted in +3 strength mod.
