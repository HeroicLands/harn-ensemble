...
hm3:
  ...
  items:
    ...
    - { shortcode: stealth, type: skill, system: { masteryLevel: 98 } }
    ...
    - { shortcode: tracking, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 90 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 13 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 755 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-stlth, system: { masteryLevelBase: 98 } }
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 52 } }
    ...
    - { model: skill-trak, system: { masteryLevelBase: 28 } }
    - { model: miscgear-pence, system: { quantity: 755 } }
...
Modifier to HairColor of +25 (from 34) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 13) {Complexion=Fair, Species=Human}
