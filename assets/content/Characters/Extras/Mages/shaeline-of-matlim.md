...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 9 } }
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 9 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 137 } }
