...
hm3:
  ...
  items:
    ...
    - { shortcode: cookery, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 9 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 9 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 64 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 72 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 137 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 9 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 9 } }
    - { model: miscgear-pence, system: { quantity: 137 } }
...
Modifier to StartingEquipment of +100 (from 55) {SocialClass=Serf}
