...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 30 } }
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 65 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 48 } }
    ...
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 112 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 32 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 98 } }
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 16 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 12 } }
    - { shortcode: savorya, type: skill, system: { masteryLevel: 14 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1899 } }
...
sohl:
  ...
  items:
    ...
    - { model: attribute-per, system: { scoreBase: 6 } }
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 61 } }
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 94 } }
    - { model: skill-agri, system: { masteryLevelBase: 39 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 30 } }
    - { model: skill-embl, system: { masteryLevelBase: 44 } }
    - { model: skill-herb, system: { masteryLevelBase: 65 } }
    - { model: skill-math, system: { masteryLevelBase: 48 } }
    - { model: skill-trak, system: { masteryLevelBase: 24 } }
    - { model: miscgear-pence, system: { quantity: 1899 } }
...
Modifier to HairColor of +25 (from 62) {Complexion=Fair, Species=Human}

Modifier to EyeColor of -10 (from 35) {Complexion=Fair, Species=Human}

157lbs weight resulted in +1 strength mod.

Modifier to StartingEquipment of +100 (from 71) {SocialClass=Serf}
