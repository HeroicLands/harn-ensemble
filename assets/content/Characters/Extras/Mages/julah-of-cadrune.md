...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-runecft, system: { masteryLevelBase: 90 } }
    - { model: sohl-sohl-mysticalability-tarot, system: { masteryLevelBase: 68 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 870 } }
