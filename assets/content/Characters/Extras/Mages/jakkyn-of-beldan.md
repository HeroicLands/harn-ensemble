...
hm3:
  ...
  items:
    ...
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 12 } }
    ...
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 30 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 52 } }
    - { model: skill-math, system: { masteryLevelBase: 45 } }
    - { model: skill-mtlc, system: { masteryLevelBase: 12 } }
...
Modifier to StartingEquipment of +200 (from 52) {SocialClass=Unguilded}
