...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-mysticalability-alch, system: { masteryLevelBase: 64 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 32 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 33 } }
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 22 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1187 } }
