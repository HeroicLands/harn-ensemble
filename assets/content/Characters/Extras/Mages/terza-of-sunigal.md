...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 64 } }
    ...
    - { shortcode: neutral, type: skill, system: { masteryLevel: 102 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 108 } }
    - { shortcode: charm, type: psionic, system: { masteryLevel: 32 } }
    - { shortcode: healing, type: psionic, system: { masteryLevel: 24 } }
    - { shortcode: hex, type: psionic, system: { masteryLevel: 73 } }
    - { shortcode: medium, type: psionic, system: { masteryLevel: 26 } }
    - { shortcode: negation, type: psionic, system: { masteryLevel: 26 } }
    - { shortcode: prescience, type: psionic, system: { masteryLevel: 25 } }
    - { shortcode: psychometry, type: psionic, system: { masteryLevel: 24 } }
    - { shortcode: pyrokinesis, type: psionic, system: { masteryLevel: 25 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1187 } }
...
sohl:
  ...
  items:
    ...
    - { model: mysticalability-alch, system: { masteryLevelBase: 64 } }
    ...
    - { model: miscgear-pence, system: { quantity: 1187 } }
