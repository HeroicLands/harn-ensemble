...
hm3:
  ...
  items:
    ...
    - { shortcode: swimming, type: skill, system: { masteryLevel: 56 } }
    ...
    - { shortcode: brewing, type: skill, system: { masteryLevel: 33 } }
    - { shortcode: fishing, type: skill, system: { masteryLevel: 65 } }
    ...
    - { shortcode: seamanship, type: skill, system: { masteryLevel: 22 } }
    ...
    - { shortcode: savorya, type: skill, system: { masteryLevel: 16 } }
    - { shortcode: charm, type: psionic, system: { masteryLevel: 28 } }
    - { shortcode: medium, type: psionic, system: { masteryLevel: 28 } }
    - { shortcode: mentalbolt, type: psionic, system: { masteryLevel: 31 } }
    - { shortcode: negation, type: psionic, system: { masteryLevel: 79 } }
    - { shortcode: psychometry, type: psionic, system: { masteryLevel: 31 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1432 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-srvl }
    - { model: skill-spirit }
    - { model: skill-swim, system: { masteryLevelBase: 56 } }
    - { model: skill-thtcs }
    ...
    - { model: skill-brew, system: { masteryLevelBase: 33 } }
    - { model: skill-fish, system: { masteryLevelBase: 65 } }
    - { model: skill-math, system: { masteryLevelBase: 28 } }
    - { model: skill-pilt, system: { masteryLevelBase: 36 } }
    - { model: skill-smsh, system: { masteryLevelBase: 22 } }
    - { model: miscgear-pence, system: { quantity: 1432 } }
...
139lbs weight resulted in -1 strength mod.
