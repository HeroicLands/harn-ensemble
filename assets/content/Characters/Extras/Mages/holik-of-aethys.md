...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-swim, system: { masteryLevelBase: 56 } }
    ...
    - { model: sohl-sohl-skill-brew, system: { masteryLevelBase: 33 } }
    - { model: sohl-sohl-skill-fish, system: { masteryLevelBase: 65 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 28 } }
    - { model: sohl-sohl-skill-pilt, system: { masteryLevelBase: 36 } }
    - { model: sohl-sohl-skill-smsh, system: { masteryLevelBase: 22 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1432 } }
