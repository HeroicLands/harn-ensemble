...
sohl:
  ...
  items:
    ...
    - { shortcode: swim, type: skill, system: { masteryLevelBase: 56 } }
    ...
    - { shortcode: brew, type: skill, system: { masteryLevelBase: 33 } }
    - { shortcode: fish, type: skill, system: { masteryLevelBase: 65 } }
    - { shortcode: math, type: skill, system: { masteryLevelBase: 28 } }
    - { shortcode: pilt, type: skill, system: { masteryLevelBase: 36 } }
    - { shortcode: smsh, type: skill, system: { masteryLevelBase: 22 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 1432 } }
