...
hm3:
  ...
  items:
    ...
    - { shortcode: swimming, type: skill, system: { masteryLevel: 55 } }
    ...
    - { shortcode: brewing, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: fishing, type: skill, system: { masteryLevel: 40 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 437 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-brew, system: { masteryLevelBase: 60 } }
    ...
    - { model: miscgear-pence, system: { quantity: 437 } }
...
Modifier to HairColor of +25 (from 1) {Complexion=Fair, Species=Human}
