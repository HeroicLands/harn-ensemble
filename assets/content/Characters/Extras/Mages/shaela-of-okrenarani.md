...
hm3:
  ...
  items:
    ...
    - { shortcode: alchemy, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: cookery, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 39 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 10 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 20 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: lyahvi, type: skill, system: { masteryLevel: 68 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: clairvoyance, type: psionic, system: { masteryLevel: 44 } }
    - { shortcode: negation, type: psionic, system: { masteryLevel: 94 } }
    - { shortcode: telekinesis, type: psionic, system: { masteryLevel: 47 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 455 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-pysn }
    - { model: skill-ridg }
    - { model: skill-sing, system: { masteryLevelBase: 21 } }
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 10 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 20 } }
    - { model: miscgear-pence, system: { quantity: 455 } }
...
Modifier to EyeColor of -25 (from 73) {Complexion=Pale, Species=Human}
