...
hm3:
  ...
  items:
    ...
    - { shortcode: cookery, type: skill, system: { masteryLevel: 44 } }
    ...
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 15 } }
    ...
    - { shortcode: disembodiment, type: psionic, system: { masteryLevel: 91 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2187 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook, system: { masteryLevelBase: 44 } }
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw }
    ...
    - { model: miscgear-pence, system: { quantity: 2187 } }
...
Modifier to EyeColor of -25 (from 14) {Complexion=Pale, Species=Human}
