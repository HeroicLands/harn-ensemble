...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-folklr, system: { masteryLevelBase: 44 } }
    ...
    - { model: sohl-sohl-skill-script, name: Script(Lakaise), system: { masteryLevelBase: 103 } }
    ...
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 930 } }
