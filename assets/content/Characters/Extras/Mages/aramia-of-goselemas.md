...
hm3:
  ...
  items:
    ...
    - { shortcode: mentalconflict, type: skill, system: { masteryLevel: 78 } }
    ...
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 12 } }
    ...
    - { shortcode: savorya, type: skill, system: { masteryLevel: 112 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 930 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-script, name: Script(Lakaise), system: { masteryLevelBase: 103 } }
    ...
    - { model: miscgear-pence, system: { quantity: 930 } }
