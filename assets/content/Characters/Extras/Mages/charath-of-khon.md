...
hm3:
  ...
  items:
    ...
    - { shortcode: odivshe, type: skill, system: { masteryLevel: 15 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 725 } }
...
Modifier to AttributesAGL of +2 (from 7) {Frame=Scant}

102lbs weight resulted in -3 strength mod.

Heavy frame resulted in -1 agility mod.

Modifier to StartingEquipment of +300 (from 28) {SocialClass=Guilded}
