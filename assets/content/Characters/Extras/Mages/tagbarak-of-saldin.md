...
hm3:
  ...
  items:
    ...
    - { shortcode: cookery, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: folklore, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: mathematics, type: skill, system: { masteryLevel: 24 } }
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 14 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 14 } }
    ...
    - { shortcode: healing, type: psionic, system: { masteryLevel: 83 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 639 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-cmd }
    - { model: skill-cook, system: { masteryLevelBase: 40 } }
    - { model: skill-dnce }
    - { model: skill-dscr }
    - { model: skill-draw }
    ...
    - { model: skill-wpnc, system: { masteryLevelBase: 14 } }
    - { model: miscgear-pence, system: { quantity: 639 } }
