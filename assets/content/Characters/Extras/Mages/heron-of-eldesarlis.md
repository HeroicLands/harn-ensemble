...
hm3:
  ...
  items:
    ...
    - { shortcode: metalcraft, type: skill, system: { masteryLevel: 11 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 11 } }
    - { shortcode: neutral, type: skill, system: { masteryLevel: 48 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-mtlc, system: { masteryLevelBase: 11 } }
    - { model: skill-wpnc, system: { masteryLevelBase: 11 } }
