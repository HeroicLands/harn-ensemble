...
hm3:
  ...
  items:
    ...
    - { shortcode: drawing, type: skill, system: { masteryLevel: 52 } }
    ...
    - { shortcode: savorya, type: skill, system: { masteryLevel: 90 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1026 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1026 } }
...
Modifier to HairColor of -25 (from 42) {Complexion=Dark, Species=Human}

Modifier to EyeColor of +25 (from 66) {Complexion=Dark, Species=Human}
...
Modifier to StartingEquipment of +200 (from 100) {SocialClass=Unguilded}
