...
hm3:
  ...
  items:
    ...
    - { shortcode: mining, type: skill, name: Mineralogy (Mining), system: { masteryLevel: 24 } }
    - { shortcode: weaponcraft, type: skill, system: { masteryLevel: 42 } }
    - { shortcode: fyvria, type: skill, system: { masteryLevel: 75 } }
    - { shortcode: jmorvi, type: skill, system: { masteryLevel: 96 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1487 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1487 } }
...
**Age**: 30
**Birthday**: 1 Kelen 690
**Culture**: Feudal
**Social Class**: Serf
**Sibling Rank**: 3rd child of 11
**Siblings**: MFMmFMFFFFm
**Parentage**: Fostered
...
Modifier to EyeColor of +15 (from 96) {Complexion=Swarthy, Species=Human}
