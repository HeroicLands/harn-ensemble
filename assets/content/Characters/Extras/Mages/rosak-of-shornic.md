...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-lgdm, system: { masteryLevelBase: 42 } }
    ...
    - { model: sohl-sohl-skill-glas, system: { masteryLevelBase: 39 } }
    - { model: sohl-sohl-skill-jewl, system: { masteryLevelBase: 52 } }
    - { model: sohl-sohl-skill-math, system: { masteryLevelBase: 30 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 1353 } }
