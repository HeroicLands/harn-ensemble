...
hm3:
  ...
  items:
    ...
    - { shortcode: intrigue, type: skill, system: { masteryLevel: 68 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-shok }
    - { model: skill-intr, system: { masteryLevelBase: 68 } }
    ...
    - { model: miscgear-pence, system: { quantity: 776 } }
