...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-cook, system: { masteryLevelBase: 44 } }
    ...
    - { model: sohl-sohl-skill-wpnc, system: { masteryLevelBase: 14 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 210 } }
