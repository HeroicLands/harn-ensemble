...
hm3:
  ...
  items:
    ...
    - { shortcode: peleahn, type: skill, system: { masteryLevel: 51 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 210 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 210 } }
...
Modifier to EyeColor of +25 (from 14) {Complexion=Dark, Species=Human}
