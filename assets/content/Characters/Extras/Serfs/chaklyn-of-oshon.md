...
hm3:
  ...
  items:
    ...
    - { shortcode: agriculture, type: skill, system: { masteryLevel: 98 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-agri, system: { masteryLevelBase: 98 } }
...
Modifier to EyeColor of -25 (from 42) {Complexion=Pale, Species=Human}
