...
hm3:
  ...
  items:
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 60 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 608 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-herb, system: { masteryLevelBase: 54 } }
    - { model: skill-txtl, system: { masteryLevelBase: 60 } }
    - { model: miscgear-pence, system: { quantity: 608 } }
