...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-cook, system: { masteryLevelBase: 88 } }
    ...
    - { model: sohl-sohl-skill-herb, system: { masteryLevelBase: 54 } }
    - { model: sohl-sohl-skill-txtl, system: { masteryLevelBase: 60 } }
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 608 } }
