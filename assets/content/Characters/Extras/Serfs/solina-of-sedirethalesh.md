...
hm3:
  ...
  items:
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 105 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 50 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 636 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-herb, system: { masteryLevelBase: 105 } }
    - { model: skill-txtl, system: { masteryLevelBase: 50 } }
    - { model: miscgear-pence, system: { quantity: 636 } }
