...
hm3:
  ...
  items:
    ...
    - { shortcode: flail, type: skill, name: Grailflail (Flail), system: { masteryLevel: 80 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1926 } }
...
sohl:
  ...
  items:
    ...
    - { model: miscgear-pence, system: { quantity: 1926 } }
...
Modifier to HairColor of +25 (from 63) {Complexion=Fair, Species=Human}
