...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Serf", system: { masteryLevel: 105 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 694 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Serf", system: { masteryLevelBase: 105 } }
    - { model: skill-agri, system: { masteryLevelBase: 84 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 60 } }
    - { model: miscgear-pence, system: { quantity: 694 } }
