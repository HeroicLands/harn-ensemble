...
hm3:
  ...
  items:
    ...
    - { shortcode: spear, type: skill, name: Javelin (Spear), system: { masteryLevel: 108 } }
    - { shortcode: unarmed, type: skill, system: { masteryLevel: 96 } }
    - { shortcode: physician, type: skill, system: { masteryLevel: 28 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 980 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 80
    - { model: miscgear-pence, system: { quantity: 980 } }
