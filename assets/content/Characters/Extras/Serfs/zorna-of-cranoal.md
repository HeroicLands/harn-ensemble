...
hm3:
  ...
  items:
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 40 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 580 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 40 } }
    - { model: miscgear-pence, system: { quantity: 580 } }
