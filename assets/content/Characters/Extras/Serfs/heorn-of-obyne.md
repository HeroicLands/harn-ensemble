...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 70 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 76
    - { model: skill-anmcft, system: { masteryLevelBase: 70 } }
...
Modifier to EyeColor of +15 (from 79) {Complexion=Swarthy, Species=Human}
