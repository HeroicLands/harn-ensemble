...
hm3:
  ...
  items:
    ...
    - { shortcode: jumping, type: skill, system: { masteryLevel: 108 } }
    ...
    - { shortcode: bow, type: skill, name: Longbow (Bow), system: { masteryLevel: 91 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 2244 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-archery, name: Longbow (Bow), system: { masteryLevelBase: 91 } }
    ...
    - { model: skill-jump, system: { masteryLevelBase: 108 } }
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 74
    - { model: miscgear-pence, system: { quantity: 2244 } }
