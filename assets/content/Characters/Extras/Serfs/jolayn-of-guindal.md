...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-archery, name: Longbow (Bow), system: { masteryLevelBase: 91 } }
    ...
    - { model: sohl-sohl-skill-jump, system: { masteryLevelBase: 108 } }
    ...
    - model: sohl-sohl-skill-lang
      ...
      system:
        masteryLevelBase: 74
    - { model: sohl-sohl-miscgear-pence, system: { quantity: 2244 } }
