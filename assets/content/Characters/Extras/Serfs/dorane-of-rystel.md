...
hm3:
  ...
  items:
    ...
    - { shortcode: language, type: skill, name: "Language, Noble", system: { masteryLevel: 83 } }
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 90 } }
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 1362 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-lang, name: "Language, Noble", system: { masteryLevelBase: 83 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 90 } }
    - { model: skill-trak, system: { masteryLevelBase: 36 } }
    - { model: miscgear-pence, system: { quantity: 1362 } }
...
Modifier to StartingEquipment of +400 (from 64) {SocialClass=Noble}
