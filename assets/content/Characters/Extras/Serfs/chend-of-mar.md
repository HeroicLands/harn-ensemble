...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 77 } }
    ...
    - name: "Debt to Money Lender: Arabithasis of Then for 56d"
      type: miscgear
      data:
...
sohl:
  ...
  items:
    ...
    - { model: skill-anmcft, system: { masteryLevelBase: 77 } }
