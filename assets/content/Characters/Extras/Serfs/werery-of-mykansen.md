...
hm3:
  ...
  items:
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 18 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 461 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 18 } }
    - { model: miscgear-pence, system: { quantity: 461 } }
