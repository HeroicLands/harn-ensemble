...
hm3:
  ...
  items:
    ...
    - { shortcode: rhetoric, type: skill, system: { masteryLevel: 28 } }
    ...
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 44 } }
...
sohl:
  ...
  items:
    ...
    - { model: skill-txtl, system: { masteryLevelBase: 44 } }
