...
hm3:
  ...
  items:
    ...
    - { shortcode: herblore, type: skill, system: { masteryLevel: 55 } }
    - { shortcode: textilecraft, type: skill, system: { masteryLevel: 56 } }
    - { shortcode: pence, type: miscgear, system: { quantity: 872 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 59
    - { model: skill-herb, system: { masteryLevelBase: 55 } }
    - { model: skill-txtl, system: { masteryLevelBase: 56 } }
    - { model: miscgear-pence, system: { quantity: 872 } }
