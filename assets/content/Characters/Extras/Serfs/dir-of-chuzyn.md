...
hm3:
  ...
  items:
    ...
    - { shortcode: animalcraft, type: skill, system: { masteryLevel: 54 } }
    - { shortcode: survival, type: skill, system: { masteryLevel: 72 } }
    - { shortcode: tracking, type: skill, system: { masteryLevel: 48 } }
    - { shortcode: weatherlore, type: skill, system: { masteryLevel: 98 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 83
    - { model: skill-anmcft, system: { masteryLevelBase: 54 } }
    - { model: skill-trak, system: { masteryLevelBase: 48 } }
...
Modifier to StartingEquipment of +200 (from 43) {SocialClass=Unguilded}
