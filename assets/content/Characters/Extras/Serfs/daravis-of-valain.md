...
sohl:
  ...
  items:
    ...
    - { model: skill-agri, system: { masteryLevelBase: 70 } }
    - { model: skill-anmcft, system: { masteryLevelBase: 44 } }
    - { model: miscgear-pence, system: { quantity: 149 } }
