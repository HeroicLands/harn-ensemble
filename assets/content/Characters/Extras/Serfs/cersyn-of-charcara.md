...
hm3:
  ...
  items:
    ...
    - { shortcode: pence, type: miscgear, system: { quantity: 894 } }
...
sohl:
  ...
  items:
    ...
    - model: skill-lang
      ...
      system:
        masteryLevelBase: 68
    - { model: miscgear-pence, system: { quantity: 894 } }
...
Modifier to HairColor of +25 (from 73) {Complexion=Fair, Species=Human}
